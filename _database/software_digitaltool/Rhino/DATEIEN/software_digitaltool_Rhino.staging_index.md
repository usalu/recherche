...
- Canonical target: software_digitaltool/Rhino
...
### Legacy Source: software\Rhino.md

- Map action: move_as_core
- Target role in map: primary
- Raw mapped target: software_digitaltool/Rhino
- Original primary target: software_digitaltool/Rhino
...
### Legacy Source: werkzeug\Rhino.md
