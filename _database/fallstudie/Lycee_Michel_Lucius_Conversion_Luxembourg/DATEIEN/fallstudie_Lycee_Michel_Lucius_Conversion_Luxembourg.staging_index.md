---
id: "Lycee_Michel_Lucius_Conversion_Luxembourg"
entity: "fallstudie"
node_kind: "core"
migration_status: "migrated_phase4_case_graph"
title: "Lycée Michel Lucius Conversion, Luxembourg — Fallstudie Direct Reuse / zirkuläres Bauen"
bauobjekt:
  - "Lycee_Michel_Lucius_Conversion_Luxembourg"
legacy_paths:
  - "Gebäude\\Lycee_Michel_Lucius_Conversion_Luxembourg.md"
projekt:
  - "Lycee_Michel_Lucius_Conversion_Luxembourg"
reuse_chain_detected: "False"
---
# Lycée Michel Lucius Conversion, Luxembourg — Fallstudie Direct Reuse / zirkuläres Bauen

## Migration

- Fallstudie ID: Lycee_Michel_Lucius_Conversion_Luxembourg
- Legacy source count: 1
- Generated project: Lycee_Michel_Lucius_Conversion_Luxembourg
- Generated bauobjekt: Lycee_Michel_Lucius_Conversion_Luxembourg
- Extracted reuse_einsatz rows: 11
- Extracted datenpunkt rows: 16
- Extracted entity mapping rows: 24
- Reuse chain detected: False

## Legacy Content

### Legacy Source: Gebäude\Lycee_Michel_Lucius_Conversion_Luxembourg.md

- Map action: split_into_case_graph
- Primary target: fallstudie/Lycee_Michel_Lucius_Conversion_Luxembourg
- Secondary targets: projekt/Lycee_Michel_Lucius_Conversion_Luxembourg; bauobjekt/<from_content>; reuse_einsatz/<per_component>
