...
Generated: 2026-05-15T15:58:55.351225+00:00
...
| files_scanned | 78 |
| nodes_unique | 2146 |
| relationships_unique | 15836 |
| parse_errors | 0 |
| schema_errors | 427 |
| schema_errors_actor_registry | 427 |
| schema_errors_project_records | 0 |
| live_unknown_rel_types | 0 |
| live_unknown_labels | 0 |
| missing_endpoints | 0 |
| duplicate_node_conflicts | 103 |
| duplicate_node_conflict_ids | 43 |
...
| --- | --- |
| _neo4j\processed\projects\vocabulary\controlled_vocabulary.seed.kg.jsonl | 373 |
| _neo4j\processed\projects\vocabulary\controlled_terms.merged.kg.jsonl | 53 |
...
| File | Errors |
| --- | --- |
| _neo4j\processed\actor_registry\actor_registry.canonical.kg.jsonl | 427 |

## Contract Drift vs Live Graph

- Live rel types not in any contract: 0
- Live node labels not in any contract: 0
...
- Projekt without component/work links: 0
...
43 unique node ids have conflicting properties across processed payloads.
...
- Deterministic patch: `_neo4j\review\round_002_baseline\post_archive_audit\patches\global_technical.patch.jsonl`
- Deterministic patch operations: 43
- Round-001 needs_review filtered: `_neo4j\review\round_002_baseline\post_archive_audit\needs_review.patch.jsonl` (12 records).
