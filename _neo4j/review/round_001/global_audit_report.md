...
- Patch file: `_neo4j\review\round_001\patches\global_technical.patch.jsonl`
- Patch operations: 27
- Generated placeholders live under `_neo4j\review\round_001\placeholders` and are review outputs only.
