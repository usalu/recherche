# Graph-Ready Research Prompt — Belgian / Dutch Case-Study Buildings
...
- `BlueCity_Offices_Rotterdam.md` and `Maison_DnA_Asse.md` as further reference examples.
...
1. `Careno_Be_Circular_Brussels.md`
2. `Circl_Pavilion_Amsterdam.md` — **Note:** projects 2 and 3 almost certainly refer to the same building. If confirmed, produce one combined dossier here and leave project 3 as a short duplicate note only.
3. `Circl_ABN_AMRO_Urban_Mining.md` — see note above.
...
Research the following three building case studies.
...
If confirmed as the same building as project 2, produce `Circl_ABN_AMRO_Urban_Mining.md` as a short duplicate note (≈ 1 page) clearly stating the overlap and cross-referencing `Circl_Pavilion_Amsterdam.md`. Do not duplicate all tables. If research reveals it is a distinct project, produce a full dossier using the template above.
...
- [ ] Ambiguous project identification and any duplicate are clearly documented.
