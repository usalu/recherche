...
Generated: 2026-05-14T11:41:17.683358+00:00
...
| id | name |
| --- | --- |
| p_permanently_temporary_pavilion | Permanently Temporary Pavilion (Stub) |
| p_rotor_dc_brussels_model | Rotor DC Brussels Model (Stub) |

### Direct-reuse Bauteilgruppen without donor

| id | name |
| --- | --- |
| bg_altes_hobelwerk_laminatplatten | Kasten aus recycelten Laminatfurnierplatten (Cirkla) |
| bg_awm_kabelkanaele_upcycling | Kabelkanäle als Regalböden und Leuchten (Upcycling) |
| bg_be_ware_altholz_tragwerk | Altholz / Sekundärmaterialien als Tragwerk (mehrere Teilprojekte) |
| bg_bedzed_misc_reuse | Diverses Reuse-Material (Türen, Bordsteine, Steinplatten, Geländerrohre) |
...
| bg_brighton_betonbloecke | Wiederverwendete Betonblöcke |
| bg_brighton_holz_sperrholz | Holz und Sperrholz aus Reststücken |
...
| id | name |
| --- | --- |
| bg_lysbuechel_parkhaus_betonteile | Betonfertigteile: Stützen, Träger, Deckenplatten, Rampenplatten |

### Duplicate display-name candidates

| label | name_key | count | ids |
| --- | --- | --- | --- |
| Akteur | baubüro in situ | 2 | a_baubuero_in_situ, a_bauburo_in_situ |
| Akteur | cleveland steel & tubes | 2 | a_cleveland_steel_tubes, a_cleveland_steel |
...
| Stadt | brüssel | 2 | stadt_bruessel, stadt_brussel |
