...
**Created UTC:** 2026-06-01T07:11:05.907254+00:00
...
| node | `keep_minimum` | P0 | 129 | 54509 |
| node | `review_relationship_duplicate` | P0 | 39 | 43734 |
| relationship | `keep_minimum` | P0 | 69 | 69727 |
| node | `keep_minimum` | P1 | 30 | 31286 |
| node | `keep_or_model_fact` | P1 | 7 | 1602 |
| node | `move_to_provenance_model` | P1 | 316 | 168445 |
| relationship | `review_keep_or_provenance` | P1 | 77 | 27485 |
| relationship | `review_keep_or_source_edge` | P1 | 802 | 348440 |
...
| node | `review_domain_property` | P3 | 155 | 44354 |
| relationship | `review_domain_property` | P3 | 123 | 109442 |
...
| `move_to_provenance_model` | 316 |
| `review_domain_property` | 155 |
...
| `review_keep_or_source_edge` | 802 |
| `review_sparse` | 17 |
