...
- Beleg-URL (MUSS geoeffnet werden): https://genbyg.dk/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We are Denmark's largest reuse building materials marketplace. We have existed since 1998 and specialize in purchasing and reselling used building materials."

### DK:I02
- Name: Gladsaxe Kommune / Gladsaxe Municipality
- Land: DK
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://www.danskindustri.dk/synligbeton.dk/projekter/byggeri/bornehuset-svanen/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bygherre (Client): Gladsaxe Kommune"

### DK:S01
- Name: GreenDozer ApS
- Land: DK
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://greendozer.com/byggematerialer
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Hos GreenDozer har vi et stort udvalg af både genbrugte byggematerialer og overskudsvarer"

### DK:U11
- Name: GXN
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://urbannext.net/building-a-circular-future/
- Weitere URL: https://gxn.3xn.com/wp-content/uploads/sites/4/2019/02/CircleHouse_ENG_2018.pdf
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The circular economy represents an unprecedented opportunity for our industry ... said Kasper Guldager Jensen, Director of GXN and Senior Partner with 3XN."

### DK:U12
- Name: Hoffmann A/S
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.hoffmann.dk/projekter/thoravej-29-fokus-paa-baeredygtighed/
- Weitere URL: https://www.hoffmann.dk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Hoffmann har sammen med Pihlmann Architects og ABC Rådgivende Ingeniører vundet totalentreprisen på udviklingen af Bikubenfondens nyerhvervede bygning."

### DK:M12
- Name: Hverringe Centrum for Restaurering
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://realdania.dk/projekter/hverringe
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Støttebeløb 6,7 mio. kr."

### DK:U13
- Name: J. Jensen A/S
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://j-jensen.com/kompetencer/genbrugssalg/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "I vores 1000 m2 store genbrugshal i Lynge sorterer og sælger vi velegnede, brugte byggematerialer"

### DK:M13
- Name: Jakobsen Tegl ApS
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://tegllageret.dk/om-os/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "at købe og sælge brugte bygningsmaterialer især brugte tagsten og mursten"

### DK:M14
- Name: jk-genbrug
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://jk-genbrugscenter.dk/jk-genbrugscenter/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Hos JK-Genbrugscenter handler vi primært med nye og brugte døre og vinduer, men vi har også andre byggematerialer."

### DK:U14
- Name: KC Nedbrydning A/S
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.kc-nedbrydning.dk/vi-tilbyder/genbrugsmateriale/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Genbrugsmaterialer"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Client Kilden & Hindby [and] PFA Ejendomme"

### DK:U16
- Name: Kingo (Kingo Karlsen A/S)
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://kingo.biz/genbrug/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Kingo er født ud af tanken med genbrug og grundlagt i en tid, hvor alle byggematerialer i en bygning blev genbrugt som en selvfølge"

### DK:U17
- Name: Klassiske Vinduer
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://klassiske-vinduer.dk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Stort udvalg af gamle, originale og bevaringsværdige vinduer og døre."

### DK:N02
- Name: Lejerbo
- Land: DK
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.lejerbo.dk/om-dab-lejerbo/byggeri/om-circle-house
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Lejerbo i gang med at bygge 60 nye familieboliger... verdens første almene boliger, der er bygget efter cirkulære principper."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "large-scale architecture can combine reused materials, biogenic resources ... facades made from salvaged aluminium sheets"

### DK:S02
- Name: Milva
- Land: DK
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://www.milva.dk/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi hjælper dig med at optimere din ressourceudnyttelse og sikre genbrug."

### DK:U19
- Name: MOE
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.danskeark.com/content/upcycle-studios
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Engineer: MOE, Norrecco"

### DK:U20
- Name: MT Højgaard
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://mth.dk/ydelser/renovering/bevaringsvaerdige-og-fredede-bygninger
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi genbruger og genanvender så vidt muligt materialer, så vi lever op til Slots- og Kulturstyrelsens fredningsklasser"

### DK:U21
- Name: Nedrivningsselskabet Falster
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://nssf.dk/nedrivning/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Salg af genbrugsmaterialer"
...
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.danskindustri.dk/synligbeton.dk/projekter/byggeri/bornehuset-svanen/
- Weitere URL: https://www.niras.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Unbestimmt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "NIRAS har forestaaet raadgivning for nedrivningen af den gamle skole og for miljoekortlaegningen"
