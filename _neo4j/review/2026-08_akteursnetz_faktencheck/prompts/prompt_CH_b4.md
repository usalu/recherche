...
- Beleg-URL (MUSS geoeffnet werden): https://salza.ch/bauteil-plattform
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Die Salza Bauteil-Plattform macht Wiederverwendung einfach zugänglich und unkompliziert."

### CH:U36
- Name: Schmidiger + Rosasco AG
- Land: CH
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Elektroplanung (Electrical Planning): Schmidiger + Rosasco AG, Zürich"

### CH:I03
- Name: Stadt Zürich / Amt für Hochbauten / Immobilien Stadt Zürich
- Land: CH
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://www.stadt-zuerich.ch/de/planen-und-bauen/projekte-und-ausschreibungen/hochbauvorhaben/meilenschritte/04-intelligente-ressourcennutzung/kreislauforientiertes-bauen.html
- Weitere URL: https://www.stadt-zuerich.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Betrieb_Nutzung / Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "jedes städtische Um- oder Neubauprojekt auf sein Potential zur Wiederverwendung von Bauteilen hin zu prüfen"

### CH:O02
- Name: Stiftung Abendrot / Vorsorgestiftung Abendrot
- Land: CH
- Typ (Altdaten, unbestaetigt): Organisation
- Beleg-URL (MUSS geoeffnet werden): https://zirkular.net/en/project/building-k-118/
- Weitere URL: https://www.abendrot.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Client: Stiftung Abendrot"

### CH:M15
- Name: Stiftung Chance BauTeile Zürich / Glattbrugg
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.chance.ch/dienstleistungen/bauteile
- Weitere URL: https://www.chance.ch/dienstleistungen
- Weitere URL: https://www.chance.ch/produkte
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bauteile und Baumaterial im Kreislauf behalten – Ökologisch und wirtschaftlich vorteilhaft"
...
- Weitere URL: https://www.stiftung-habitat.ch/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Auch gut erhaltene gebrauchte Bauteile oder Einrichtungselemente wie Küchen erleben hier eine Wiedergeburt."

### CH:F08
- Name: Structural Xploration Lab / EPFL
- Land: CH
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.epfl.ch/labs/sxl/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "we are paving the way for the upcycling reuse of load-bearing components in buildings, hence contributing to the adoption of a circular economy by the construction industry"

### CH:U38
- Name: Studio Trachsler Hoffmann
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Nach dem Wettbewerbsgewinn wurde Zirkular mit in das Projektteam geholt."

### CH:U39
- Name: Syphon AG Bauteilbörse Biel-Brügg
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.syphon.ch/
- Weitere URL: https://syphon.ch/vente-de-materiaux/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Wir sind spezialisiert auf die Beurteilung, die Erfassung, den Ausbau, die Aufbereitung und den Verkauf von wiederverwendbaren Materialen und Bauteilen."

### CH:U40
- Name: Tschudin Rückbau und Demontagen GmbH
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://zirkular.net/de/projekt/grubenstrasse-29/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Material Suppliers (Wiederverwendete Bauteile): Tschudin Rückbau und Demontagen GmbH"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "In der NEST-Unit »UMAR« (Urban Mining & Recycling) wohnen und arbeiten seit Mai zwei Studenten, um sich regelmäßig mit den Wissenschaftlern der Empa über ihre Erfahrungen auszutauschen."
...
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.epfl.ch/labs/sxl/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The Structural Xploration Lab is also an integral member of the Smart Living Lab, a joint facility between EPFL, UniFr, and HEIA-FR, in Fribourg, Switzerland."

### CH:F10
- Name: Urban Bricolage
- Land: CH
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://urbanbricolage.ch
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The SNSF-PRIMA-funded project 'Urban Bricolage. Mining, Designing and Constructing with Reused Building Materials' investigates the emerging circular economy of building materials."

### CH:M16
- Name: useagain / Bauteilclick
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://library-of-reuse.ch/pioneers/useagain
- Weitere URL: https://www.useagain.ch/de/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "a Swiss exchange platform for used construction elements, materials and furniture ... promotes direct exchange between various organisations, such as Bauteilbörse Basel"
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Der Verein RE-WIN will einerseits eine Kultur der Wiederverwendung von Bauteilen sowohl in den Architektur- und Planungsbueros als auch in der Bauwirtschaft selber foerdern."

### CH:U42
- Name: Weber + Brönnimann AG
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.webroe.ch/de/hochbau/projekte/neubau-recyclinghof-juch-areal-zuerich-2023.php
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bei vorliegenden Projekt stammen die Bauteile grösstenteils aus der unmittelbaren Umgebung von Zürich."
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Steel Construction: Wetter AG"

### CH:M17
- Name: Wick ReUse / ROTO Baumarkt
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://wickreuse.ch/baumarkt/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "In unserem Baumarkt findest du, was du für deine Projekte oder deine Werkstatt benötigst: hochwertige gebrauchte Maschinen und Werkzeuge"

### CH:F11
- Name: ZHAW
- Land: CH
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.zhaw.ch/de/archbau/institute/ike/forschung
- Weitere URL: https://www.zhaw.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Seit 2017 widmet sich das IKE in Forschung und Lehre dem architektonischen und baukulturellen Potenzial, das die Wiederverwendung von Bauteilen freisetzt."

### CH:F12
- Name: ZHAW IKE
- Land: CH
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.zhaw.ch/de/archbau/institute/ike/forschung/klima-und-energiekultur
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Das Institut Konstruktives Entwerfen des Departements Architektur der ZHAW untersucht seit 2018 in Forschung und Lehre das architektonische und baukulturelle Potenzial"
