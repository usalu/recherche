...
### NL:S02
- Name: ReSource Marktplaats
- Land: NL
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://apps.apple.com/nl/app/resource-marktplaats/id6743317802
- Weitere URL: https://play.google.com/store/apps/details?id=com.pss.resource
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Marktplaats: Ruil, koop of verkoop materialen binnen je eigen organisatie of met andere deel"

### NL:I04
- Name: Rijksvastgoedbedrijf / Central Government Real Estate Agency
- Land: NL
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://www.rijksvastgoedbedrijf.nl/onderwerpen/circulair-bouwen
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Circulair betekent voor het Rijksvastgoedbedrijf (RVB) bouwen en beheren zonder de natuurlijke hulpbronnen uit te putten."

### NL:I05
- Name: Rijkswaterstaat
- Land: NL
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://www.burobas.nl/project/emergis-ithaka-circulariteit-duurzaamheid-healing-environment-ontwerp
- Weitere URL: https://www.rijkswaterstaat.nl/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Het kantoor van Rijkswaterstaat in Terneuzen...is afgebroken en zoveel mogelijk materialen zijn hergebruikt voor de nieuwbouw van deze kliniek."

### NL:U46
- Name: Rothuizen Architecten / Taco Tuinhof
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://rothuizen-architecten.nl/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Wij geloven dat architecten een cruciale bijdrage kunnen leveren aan het wereldwijde duurzaamheidsvraagstuk. Dit doen we door hergebruik van materialen"

### NL:M15
- Name: Sagro used product shop ('s-Heerenhoek)
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.soutlet.nl/over-ons
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "In onze webshop vindt u een divers aanbod aan tweedehands materialen en producten o.a. afkomst uit onze (sloop)projecten"

### NL:M16
- Name: Snellen (Rijsbergen)
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.tweedehandsmaterialen.nl/producten/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Al onze materialen komen rechtstreeks vanuit de sloopwerkzaamheden van Gebroeders Snellen BV."

### NL:M17
- Name: Soekijad
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.soekijad.nl/producten/oude-bouwmaterialen/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Neem een kijkje in ons ruime aanbod oude bouwmaterialen, van oude dakpannen tot oude metselstenen."

### NL:M18
- Name: Stadsmijn (Achterhoek)
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.stadsmijnachterhoek.nl/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Geoogste materialen worden bewerkt en verwerkt tot nieuwe producten voor de bouw."

### NL:N02
- Name: Staedion
- Land: NL
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.staedion.nl/over-staedion/persberichten/staedion-start-met-paspoort-voor-bouwmaterialen-van-madaster-0
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Na een uitgebreide proef gaat Staedion het paspoort gebruiken bij nieuwbouw en wooncomplexen waar zij gaat renoveren."

### NL:O07
- Name: Stichting Montessorischolen Monton
- Land: NL
- Typ (Altdaten, unbestaetigt): Organisation
- Beleg-URL (MUSS geoeffnet werden): https://www.kraaijvanger.nl/en/news/de-handtekeningen-zijn-gezet-montessorischool-maassluis
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Betrieb_Nutzung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Kraaijvanger Architects is collaborating on this project with the client Stichting Montessorischolen Monton"

### NL:U48
- Name: Stiho group
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.stiho.nl/duurzaamheid/circulair
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Oogstbedrijf New Horizon Urban Mining en Stiho zijn partners in circulair"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Projectmanagement: Stone 22"

### NL:U50
- Name: Strukton Worksphere
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.cepezed.com/projects/the-green-house/
- Weitere URL: https://www.strukton.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "building services: strukton worksphere"

### NL:P12
- Name: SUPERLOCAL
- Land: NL
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.superlocal.eu/superlocal/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "De wens is daarom om bij de bouw van nieuwe woningen de kwaliteiten te behouden en materiaal te gebruiken van de bestaande flats."

### NL:P13
- Name: SUPERLOCAL Expogebouw
- Land: NL
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.superlocal.eu/superlocal/expogebouw/
- Weitere URL: https://www.kerkrade.nl/superlocal-bleijerheide
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "De architect Maurer United is in zijn ontwerp gebonden aan deze herbruikbare elementen in plaats van nieuwe onderdelen."

### NL:U51
- Name: Superuse Studios / 2012Architecten
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Weitere URL: https://www.superuse-studios.com/publication/harvest-collect-re-use/
- Weitere URL: https://www.superuse-studios.com/publication/oogstkaart-nl-adopted-by-new-horizon/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Villa Welpeloo is a house and art studio designed and constructed in 2005 by Superuse Studios."

### NL:S03
- Name: Ter Velde & Den Besten
- Land: NL
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Voorafgaand aan de demontage maakt ingenieursbureau Ter Velde & Den Besten uit Hattemerbroek een 3D-scan."

### NL:P14
- Name: The Green House Utrecht
- Land: NL
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.cepezed.com/projects/the-green-house/
- Weitere URL: https://www.thegreenhouserestaurant.nl/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "primary client: rijksvastgoedbedrijf / contractual client: r creators (strukton, ballast nedam en facilicom) / interior design: coster design / stability: pieters bouwtechniek / building services: strukton worksphere / circular construction consultant: cepezedprojects / building physics & sustainability: dgmr / main contractor: ballast nedam / contractor building services: strukton worksphere / contractor steel construction: kampstaal / facades: de groot & visser"

### NL:U53
- Name: TRAJECT
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://traject.com/expertises/circulariteit/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "permanente betrokkenheid van leveranciers ten behoeve van terugname en langdurige upgrade van hun producten"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Transfarmers is meer dan gewoon een partner. We kunnen zeker zeggen dat Boschgaard er niet geweest was als Transfarmers niet bestaan had."
