...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Bauherr_Auftraggeber / Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Die uitdaging is opgepakt door de firma Lagemaat; die met vrijwel alle vrijkomende materialen er een circulair centrum van gaan realiseren in Heerde."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "LCP circulair is een samenwerking tussen cepezed projects en Lagemaat"

### NL:F01
- Name: Leiden University / Gorlaeus donor source
- Land: NL
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Betrieb_Nutzung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The metal was processed on our campus and then used as a 'donor skeleton' for BioPartner's fifth building."
...
- Weitere URL: https://www.alliander.com/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bij de bouw van het complex zijn grondstoffen en materialen hergebruikt en gedocumenteerd in een grondstoffenpaspoort."

### NL:S01
- Name: Madaster / Materialpass-Kontext
- Land: NL
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://madaster.com/material-passport/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "A material passport is a comprehensive digital record detailing the composition and reuse potential of materials within a building, essential for promoting circular construction practices."
...
### NL:P10
- Name: Montessori Maassluis
- Land: NL
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.kraaijvanger.nl/en/projects/montessori-maassluis
- Weitere URL: https://www.montessorischoolmaassluis.nl/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "A hybrid construction of wooden columns and reused hollow core slabs allows for large, flexible classrooms."

### NL:U38
- Name: New Horizon
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://newhorizon.nl/
- Weitere URL: https://www.superuse-studios.com/about-us
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Projektmanagement_Koordination / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Wij geloven dat hergebruik van bouwmaterialen het antwoord biedt op zowel economische als ecologische uitdagingen."
...
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://newhorizon.nl/
- Weitere URL: https://newhorizon.nl/urban-mining/circulair-oogsten/
- Weitere URL: https://newhorizon.nl/urban-mining/donorgebouwen/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We scannen verborgen materialen, berekenen de waarde en adviseren tijdens de oogst."

### NL:U40
- Name: Overtreders W
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "By making architecture demountable and reusable, by borrowing and leasing materials, and by using biobased and recycled sources, we develop a new perspective on building."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Het zo veel mogelijk voorkomen van het verspillen van materialen die nog voldoen"

### NL:P11
- Name: People’s Pavilion…
- Land: NL
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/en/peoplespavilion
- Weitere URL: https://overtredersw.nl/projects/peoples-pavilion
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "all of the materials needed to make the 250m2 building are borrowed"

### NL:U42
- Name: Pieters Bouwtechniek
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.pieters.net/constructie
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bij Pieters maken we duurzaamheid vanzelfsprekend - van circulair en demontabel bouwen tot materiaalbewuste keuzes"

### NL:U43
- Name: Popma ter Steege Architecten / PTSA
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://ptsa.nl/reuse-to-reduce/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "PTSA ziet het als de opgave van hun generatie architecten om vorm te geven aan een duurzaam bewoonbare wereld."
...
- Beleg-URL (MUSS geoeffnet werden): https://www.gelderland.nl/themas/duurzaamheid/circulaire-economie/prinsenhof
- Weitere URL: https://www.gelderland.nl/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Met provincie, gemeente Arnhem, Lagemaat en Dycore: uitvoeringsprotocol opgesteld voor de garantiestelling voor tweedehands kanaalplaatvloeren en dragende wanden"
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "contractual client: r creators (strukton, ballast nedam en facilicom)"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The building will be a knowledge centre for circular use of building components."

### NL:M14
- Name: Regts - Antieke Tegels
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.antieketegel.nl/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Regts – Antieke Tegels is gespecialiseerd in antieke Nederlandse tegels gemaakt tussen ca. 1580 en 1900."

### NL:X01
- Name: Repurpose
- Land: NL
- Beleg-URL (MUSS geoeffnet werden): https://repurpose.nl/
- Weitere URL: https://www.madopt.nl/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Oude gebouwen maken ruimte voor nieuwe. Hierbij verkwisten we waardevolle bouwproducten. Dat kan beter vinden wij."
