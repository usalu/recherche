...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Hierfür entstand auf dem Campus der Empa (Eidgenössische Materialprüfungs- und Forschungsanstalt) im schweizerischen Dübendorf das Forschungs- und Innovationsgebäude NEST"

### CH:I01
- Name: Entsorgung + Recycling Zürich (ERZ)
- Land: CH
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Betrieb_Nutzung / Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Das Recyclingzentrum Juch-Areal von Entsorgung + Recycling Zürich ist ein Pionierprojekt für die Wiederverwendung von Bauteilen und die Reduktion von Treibhausgasemissionen."

### CH:F04
- Name: EPFL
- Land: CH
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://epfl.ch/labs/sxl/index-html/research/ready-for-reuse
- Weitere URL: https://www.epfl.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "we are paving the way for the upcycling reuse of load-bearing components in buildings"

### CH:F05
- Name: ETH Zürich
- Land: CH
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://swircular.ethz.ch/
- Weitere URL: https://ethz.ch/en.html
- Weitere URL: https://swircular.ethz.ch/the-project.html
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Homepage – SWIRCULAR Project | ETH Zurich"

### CH:M08
- Name: GGZ@WORK Laden 2 Bauteile Zug
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://ggzatwork.ch/gaeste/laden2/laden-2-bauteile
- Weitere URL: https://ggzatwork.ch/auftragskunden/demontage-montage
- Weitere URL: https://ggzatwork.ch/auftragskunden/raeumung-entsorgung
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "im LADEN 2 - Bauteile im 1. OG finden Sie eine grosse Auswahl an gut erhaltenen Occasionsbauteilen"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Generalplanung und Architektur Graber Pulver Architekt:innen AG, Zürich"

### CH:F06
- Name: Gramazio Kohler Research
- Land: CH
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://gramaziokohler.arch.ethz.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Lost and Bound: Adaptive Detailing with Robotic Additive Joining for Reclaimed Steel"

### CH:P3
- Name: Grubenstrasse 29
- Land: CH
...
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.gruner.ch/en
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "From Training Centre to Housing: Re-Use as a Design Principle for Sustainable Construction"

### CH:S02
- Name: Gruner ReUse
- Land: CH
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://www.gruner-reuse.ch
- Weitere URL: https://www.gruner-reuse.ch/projekt
- Weitere URL: https://www.gruner-reuse.ch/produkte
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Die Bauteilplattform für zirkuläres Bauen"

### CH:U16
- Name: Haerter + Partner AG
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "HLKS-Planung (Building Systems Planning): Haerter + Partner AG, Zürich"

### CH:M09
- Name: Historisches Bauteillager Ostschweiz (Denkmal Stiftung Thurgau)
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.historisches-bauteillager.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Betrieb_Nutzung / Materialbroker / Reuse-Marketplace-Betreiber
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Die Wiederverwendung von historischen Bauteilen gewinnt im Sinne einer nachhaltigen Baukultur an Bedeutung."

### CH:F07
- Name: INEB – FHNW (Leitfaden Reuse Stahl/Stahlbeton)
- Land: CH
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.fhnw.ch/de/die-fhnw/hochschulen/architektur-bau-geomatik/institute/ineb/ineb-forschung/ressourceneffizientes-und-zirkulaeres-bauen/leitfaden-reuse-stahl-und-stahlbetonbauteilen
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Die Wiederverwendung von Bauteilen ist ein effizientes und sofort verfügbares Mittel, um in der Bauphase erhebliche Mengen grauer Energie und CO2-Emissionen einzusparen."

### CH:U17
- Name: Ingenieurbureau Heierli AG
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.stadt-zuerich.ch/de/planen-und-bauen/portfolio/bauten-anlagen/schulbauten/kindergarten-moeoeslistrasse.html
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bauingenieurwesen (Structural Engineering): Ingenieurbureau Heierli AG, Zürich"
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Timber Engineering: Josef Kolb AG"

### CH:P4
- Name: Juch-Areal Recyclingzent…
- Land: CH
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.stadt-zuerich.ch/de/planen-und-bauen/projekte-und-ausschreibungen/hochbauvorhaben/planung-ausfuehrung/recyclingzentrum-juch-areal.html
- Weitere URL: https://zirkular.net/de/projekt/erz-juchareal
- Weitere URL: https://www.stadt-zuerich.ch/de/aktuell/medienmitteilungen/2025/07/neubau-recyclingzentrum-juch-areal.html
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Beim Projekt von Graber Pulver Architekt:innen zeigt sich, dass das Bauen mit Re-Use-Bauteilen keine Einschränkung, sondern eine Bereicherung darstellt."

### CH:P5
- Name: K.118 (Kopfbau Halle 118)
- Land: CH
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://insitu.ch/projekte/196-k118-kopfbau-halle-118
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Die Tragstruktur stammt von einem rückgebauten Stahlskelettbau aus Basel"

### CH:P6
- Name: K.118 Winterthur
- Land: CH
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.zhaw.ch/de/forschung/projekt/71771
- Weitere URL: https://zirkular.net/de/projekt/k-118-kopfbau-halle-118
- Weitere URL: https://www.archdaily.com/968958/k118-kopfbau-halle-118-hauburo-in-situ
- Weitere URL: https://www.galvanizingeurope.org/case_studies/k-118-from-former-factory-to-beacon-of-sustainable-building
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "mit dem Projekt K.118 den derzeit grössten Neubau der Schweiz, der zu grossen Teilen aus wiederverwendeten Bauteilen konzipiert ist"
...
- Weitere URL: https://www.bs.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Projektpartner: Immobilien Basel-Stadt"

### CH:P7
- Name: Kindergarten Mööslistras…
- Land: CH
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.stadt-zuerich.ch/de/planen-und-bauen/portfolio/bauten-anlagen/schulbauten/kindergarten-moeoeslistrasse.html
- Weitere URL: https://www.stadt-zuerich.ch/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bauherrschaft: Stadt Zürich, Eigentümervertretung: Immobilien Stadt Zürich, Bauherrenvertretung: Amt für Hochbauten"
