...
- Name: 2emain.be
- Land: BE
- Beleg-URL (MUSS geoeffnet werden): https://opalis.eu/fr/projets/maison-vignette-karbon-architecture-et-urbanisme
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "40m² trouvées sur le site de petites annonces 2emain.be."
...
- Weitere URL: https://www.51n4e.com/
...
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.jzh.be/karreveld/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Le projet d'AgwA repose sur une analyse approfondie de la situation actuelle"

### BE:M01
- Name: Antiek Anresto
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://anresto.com/product-categorie/bouw-antiek/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bouw antiek"

### BE:M02
- Name: Antique Fireplaces First
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://antiquefireplacesfirst.com/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "At Antique Fireplaces First, we have over 30 years' experience dealing in fine and prestigious antique fireplaces."

### BE:M03
- Name: Authentieke Bouwmaterialen Storms nv
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.rikstorms.be/nl/voorstelling/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Door de jaren heen ging Rik Storms zich ook bezighouden met de verkoop van oude en antieke bouwmaterialen die hij met veel zorg en kennis voor het vak restaureerde."

### BE:F01
- Name: BAMB (Buildings as Material Banks)
- Land: BE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.bamb2020.eu/about-bamb/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "to move the building industry towards a circular economy"

### BE:M04
- Name: BatiTerre
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.batiterre.be/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "BATITERRE DONNE UNE SECONDE VIE AUX MATÉRIAUX DE CONSTRUCTION"

### BE:M05
- Name: BauMaB Kassel / Bauteilbörse Kassel
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://baumab-kassel.de/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Gebrauchte Baumaterialien und Baustoffe kaufen und verkaufen – das macht unsere Plattform möglich"

### BE:U03
- Name: BESP Stoffel & Partners / Pierre Stoffel
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bureaux d'études: BESP Stoffel & Partners"

### BE:U04
- Name: BLAF Architecten
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.blaf.be/onderzoek-ontwikkeling/lorem-ipsum-dolor-sit-amet-4/
- Weitere URL: https://www.blaf.be/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "volledige demontage en heropbouw van een recent gebouwde passiefwoning ... maximale inzet van gerecupereerde materialen"

### BE:M06
- Name: Bois Antique
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://boisantique.be/bois-antique/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bois Antique est un importateur de vieux bois en provenance d'anciennes granges et fermes européennes."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Contractors: De Coninck, Brudex."

### BE:I01
- Name: Brussels Environment
- Land: BE
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://cordis.europa.eu/project/id/642384
- Weitere URL: https://environnement.brussels/
- Weitere URL: https://opalis.eu/en/about
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "coordinated by BRUXELLES ENVIRONNEMENT - LEEFMILIEU BRUSSEL"

### BE:P1
- Name: Build Reversible In Conception (B.R.I.C.)
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.bamb2020.eu/topics/pilot-cases-in-bamb/bric/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The first construction set-up in 2018 (BRIC 1), tested the capacity of a wooden construction to integrate reclaimed materials, applying reversible solutions that minimise the waste during transformations."

### BE:F02
- Name: Buildwise
- Land: BE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.buildwise.be/nl/themas/duurzaam-bouwen/circulaire-economie/circulair-slopen/alles-over-hergebruik/
- Weitere URL: https://www.buildwise.be/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Buildwise heeft een procedure in 4 fasen ontwikkeld om de technische prestaties van herbruikte materialen aan te tonen."

### BE:U06
- Name: Bureau Bouwtechniek
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.b-b.be/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Unbestimmt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Materialen hergebruiken betekent nieuw leven"

### BE:U07
- Name: CC Autrement
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/sanitary-block-itterbeek-chiro
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Coopérative construction AUTREMENT listed under Contractors"

### BE:N01
- Name: CCRI Pilot Flanders
- Land: BE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://circular-cities-and-regions.ec.europa.eu/news/ccri-pilot-flanders-visits-rotor-learn-about-construction-material-reuse
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "representatives from CCRI Pilot Flanders visited Rotor, a pioneering marketplace for salvaged building materials located in Brussels"

### BE:N02
- Name: CCRI Pilot Uppsala
- Land: BE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://circular-cities-and-regions.ec.europa.eu/pilots/uppsala
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Uppsala set out to create a local marketplace for reusable construction materials that would make it easier to store, test and trade recovered building parts"
