...
- Beleg-URL (MUSS geoeffnet werden): https://recyclobat.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Un service de collecte pour particuliers et entreprises et une redistribution à prix solidaire de matériaux sauvés de la déchetterie"

### FR:M59
- Name: Reemployez.fr
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://reemployez.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Achat de matériaux de déconstruction"

### FR:M60
- Name: REFAIR Bordeaux
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://refair-bm.fr/
- Weitere URL: https://www.collectifcancan.fr/project/refair/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Bildung_Wissenstransfer / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Nachhaltigkeitsberatung / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Fabrique du réemploi et de la réutilisation de matériaux de construction dans la métropole bordelaise"

### FR:N09
- Name: REMIX / matériaux réemploi
- Land: FR
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): http://www.remixremix.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "REMIX est un bureau d'études œuvrant au développement des pratiques de réemploi des matériaux de construction."

### FR:M61
- Name: Rewood
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://rewood.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Rewood est une entreprise spécialisée dans le réemploi du bois et de ses dérivés issu de la déconstruction et des rebuts industriels."

### FR:M63
- Name: Réempro
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.reempro.com/marketplace
- Weitere URL: https://www.reempro.com/marketplace-reempro
- Weitere URL: https://www.reempro.com/on-parle-de-nous-sur-france-3
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Découvrez notre marketplace, une plateforme dédiée au réemploi de matériaux de qualité."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "La maîtrise d'ouvrage privée Réhabail a été un acteur moteur et volontaire dans la démarche de réemploi"
...
- Weitere URL: https://www.bellastock.com/projets/resilience
- Weitere URL: https://www.construction21.org/france/case-studies/h/resilience-la-ferme-des-possibles.html
- Weitere URL: https://www.socotec.fr/media/client-projects/reemploi-materiaux-novaedia
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "L'association Réavie a préparé et livré des éléments tels que des WC, des luminaires, des poignées de portes, des mitigeurs"

### FR:M64
- Name: Saint Emilion Matériaux
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://pierredetaille-gironde.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Matériaux anciens | Vente directe en Gironde | Saint-Emilion Matériaux"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Grand Huit avec Albert et cie (AMO), Scoping (BET TCE), Gamba (BET acoustique) et Toreana, Pouget (BE thermique), Mélanie Drevet paysagiste"

### FR:M67
- Name: Skop Marketplace
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://marketplace.skop.app/
- Weitere URL: https://www.skop.app/marketplace-materiaux-reemploi
- Weitere URL: https://www.francenum.gouv.fr/activateurs/skop
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "La marketplace de matériaux de réemploi pour les professionnels du BTP"
...
- Weitere URL: https://www.socotec.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "contrôleur technique : SOCOTEC"

### FR:U15
- Name: Soprema
- Land: FR
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.soprema-entreprises.fr/gestion-durable-dechets-btp-recyclage-reemploi/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "SOPREMA Entreprises se mobilise également, notamment à travers la rédaction de cahiers des charges dédiés à certains matériaux (bardages, gravillons, éléments de toiture)."

### FR:M69
- Name: Steel Alive
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://steelalive.co/produit/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "SteelAlive - LA marketplace de l'acier de réemploi"

### FR:U16
- Name: Synéthic
- Land: FR
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.synethic.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "SYNETHIC accompagne les maitres d'ouvrages publics et privés qui s'engagent en faveur de l'économie circulaire dans leurs chantiers BTP"

### FR:I02
- Name: Technische Dienste der Stadt Paris
- Land: FR
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "SERVICE TECHNIQUES DES BÂTIMENTS TERTIAIRES (STGCAI, SABA, SALPA) (second-œuvre)"

### FR:M70
- Name: TEXTIFLOOR
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.upcyfloor.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Upcyfloor vous propose un large choix de moquette ou de PVC en réemploi"

### FR:M72
- Name: Toit de Paris
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://en.toitdeparis.com/reemploi
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Toit de Paris collecte, trie et transforme les matériaux selon un protocole rigoureux, garantissant leur traçabilité, leur qualité et leur durabilité."

### FR:M73
- Name: Tonner Matériaux Anciens
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.tonner-materiaux-anciens.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Antiquités du Bâtiment - Décorations anciennes en pierre"

### FR:P6
- Name: Toulouse Métropole
- Land: FR
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://metropole.toulouse.fr/institutions-et-territoires/emploi-et-vie-economique/projets-europeens/life-waste2build
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Le projet, coordonné par Toulouse Métropole, est mené en collaboration avec 6 partenaires bénéficiaires"
