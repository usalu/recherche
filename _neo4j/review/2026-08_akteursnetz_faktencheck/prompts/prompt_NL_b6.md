...
- Beleg-URL (MUSS geoeffnet werden): https://research.tudelft.nl/en/projects/circular-built-environment-hub
- Weitere URL: https://www.tudelft.nl/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Automating building element detection for deconstruction planning and material reuse: A case study"

### NL:U55
- Name: Turntoo / Circularity-Kontext
- Land: NL
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Collaborators: Volker Wessels, Fokkema & Partners, INNAX, Kuiper Compagnons, Boele & van Eesteren bv, Homij and Turntoo."

### NL:N03
- Name: Urban Mining Collective
- Land: NL
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://bouwenuitvoering.nl/duurzaam/minder-co%E2%82%82-meer-bouwen-urban-mining-collective-en-circle-of-concrete/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Alle 22 partners van het Urban Mining Collective de 9 partners van de Circle of Concrete (9) pakten het initiatief op"

### NL:U56
- Name: Van der Wal Sloopwerken
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.wal-sloopwerken.nl/duurzaamheid/circulair-slopen
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "handel in 2e hands bouwmaterialen, hout wordt gescheiden van het glas en gerecycled tot nieuwe producten zoals bijvoorbeeld palletkorrels"

### NL:U57
- Name: Van Dijk Maasland B.V.
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Kraaijvanger Architects is collaborating on this project with ... Van Dijk Maasland B.V."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Warren van Hoof, van adviesbureau VanNimwegen, is onder andere op het gebied van wooncoöperaties onze adviseur."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Kraaijvanger Architects is collaborating on this project with ... VIA landscape"

### NL:U61
- Name: Vic Obdam Staalbouw
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://bouwakkoordstaal.nl/nieuws/nieuwe-partner-vic-obdam-staalbouw
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "the 40 year old steel construction company has built a reputation in directly reusing 'secondhand' steel construction parts in new building projects."

### NL:U62
- Name: Victory Group
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.cushmanwakefield.com/en/netherlands/news/2021/12/verkoop-abn-amro-zuidas
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "ABN AMRO has set specific sustainability criteria for the buyer's plans and for the reuse of our circular landmark pavilion Circl."

### NL:P15
- Name: Villa Welpeloo Enschede
- Land: NL
...
- Weitere URL: https://eurocodes.jrc.ec.europa.eu/sites/default/files/2021-12/EUR23252EN.pdf
- Weitere URL: https://www.baunetzwissen.de/gesund-bauen/fachwissen/regelwerke/normen-fuer-den-lehmbau-3393643
- Weitere URL: https://www.superuse-studios.com/projectplus/villa-welpeloo
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The wood used in the façade was taken from 200 damaged cable reels, which gave pieces of a uniform size and shape."

### NL:U63
- Name: Vintis installatieadviseurs
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.kraaijvanger.nl/en/news/de-handtekeningen-zijn-gezet-montessorischool-maassluis
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Kraaijvanger Architects is collaborating on this project with ... Vintis Installatieadviseurs"
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Constructeur Volantis bepaalt welke materialen en elementen uit de flat herbruikbaar zijn."

### NL:M19
- Name: Weever Circulair (Kampen)
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.weever-circulair.nl/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bij Weever Circulair worden deze grondstoffen geoogst, gesorteerd en verwerkt, zodat deze opnieuw tijdens het bouwproces kunnen worden ingezet."

### NL:P16
- Name: Woongroep Boschgaard…
- Land: NL
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://boschgaard.nl/circulariteit
- Weitere URL: https://www.superuse-studios.com/projectplus/woongroep-boschgaard
- Weitere URL: https://boschgaard.nl/duurzaam-bouwen
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "de ontwerpen van architect Superuse Studios, die gespecialiseerd zijn in hergebruik"
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Zayaz ondersteunt en faciliteert hen hierin. En blijft eigenaar van het gebouw"

### NL:F04
- Name: Zuyd Hogeschool
- Land: NL
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://surd.nl/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Circular Building Technologies, Energy Transition en Urban Transformation — ontwikkelen wij nieuwe kennis en oplossingen."
