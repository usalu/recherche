...
- Weitere URL: https://www.construction21.org/france/case-studies/h/pavillon-de-sanitaires-du-chiro-d-itterbeek.html
- Weitere URL: https://www.construction21.org/belgique/case-studies/h/pavillon-de-sanitaires-du-chiro-d-itterbeek-dilbeek.html
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The facade, for example, is entirely made of reusable bricks provided by Jan Franck."

### BE:P3
- Name: Circular Retrofit Lab
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.bamb2020.eu/topics/pilot-cases-in-bamb/retrofit-lab/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The pilot project tested and implemented different scenarios for the reuse and refurbishment of the VUB Campus' prefabricated student housing, without generating a large amount of waste."

### BE:I02
- Name: Commune de Dilbeek
- Land: BE
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Municipality of Dilbeek listed as Project owner"

### BE:M08
- Name: Composil
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://blog.composil.eu/en/sustainable-building-materials-reused-carpets
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "At Composil, we offer a more sustainable solution: our reuse and recycling program is not only eco-friendly but also economically advantageous compared to incineration."
...
- Weitere URL: https://www.conixrdbm.com/
...
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/multi-de-brouckere-tower
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Contractor: Cordeel"

### BE:M09
- Name: Cornermat / Retrival
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.cornermat.be/
- Weitere URL: https://www.cornermat.be/shop
- Weitere URL: https://advitam-material.be/nl/actor/cornermat
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Votre fournisseur de matériaux de réemploi"
...
### BE:M10
- Name: De Groene Poort
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.degroenepoort.com/en/about-us
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "You will discover the most original furniture and treasures in De Groene Poort: seventeenth-century prison doors, wood from wreckages to incorporate in your catering business, cupboards made from old doors, shutters, windows"

### BE:M11
- Name: De Oude Dakpan
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://de-oude-dakpan.be/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Oude dakpannen zijn niet alleen een esthetische verrijking voor uw dak, maar bieden ook een duurzame en milieuvriendelijke oplossing."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Denis Dujardin"
...
- Weitere URL: https://www.dexia.com/
...
### BE:M12
- Name: Doehetzelf 2dehands bouwmarkt
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.2dehandsbouwmarkt.be
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Specialist in nieuwe stock ramen en 2de handse ramen & deuren"

### BE:M14
- Name: Eeuwenhout Antoine Verhofstede
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.verhofstede.be/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "And naturally we present to you 'Eeuwenhout', a collection wood of the best quality from long gone times that we breathe new life into for you."

### BE:P4
- Name: EFP (Espace Formation PME / Brussels training centre)
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://guidebatimentdurable.brussels/construction-dun-batiment-circulaire-evolutif-reversible-projet-bric
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Le réemploi, l'approvisionnement local en matériaux ... ont aussi été étudiés avec attention."

### BE:N03
- Name: Embuild
- Land: BE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.embuildvlaanderen.be/focus/circulair-bouwen/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Minder afval dankzij hergebruik en recyclage"

### BE:G01
- Name: ERDF / FEDER Brüssel-Hauptstadt
- Land: BE
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "This project was made possible thanks to an ERDF subvention from the Brussels-Capital Region."

### BE:U15
- Name: Evelia Macal
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.agwa.be/en/projects/1718_verbiest/201/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "AgwA + Evelia Macal"

### BE:U16
- Name: Franck
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.franck.be/en/about-us
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "the production and trade of unique roof tiles, new and reclaimed facade bricks"
...
- Beleg-URL (MUSS geoeffnet werden): https://www.franck.be/en/about-us
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "unique roof tiles, new and reclaimed facade bricks"
