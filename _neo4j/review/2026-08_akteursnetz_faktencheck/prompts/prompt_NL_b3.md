...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Circulaire kliniek GGZ Emergis Ithaka voor jeugdpsychiatrie"

### NL:U27
- Name: Exasun
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://circulairemaakindustrie.nl/case/exasun-multifunctionele-en-lang-meegaande-zonnedaken/
- Weitere URL: https://www.exasun.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "As part of a consortium with TNO and DSM, Exasun is working on a technical solution to disassemble solar panels after their lifespan and subsequently recycle them."

### NL:M06
- Name: Excess Materials Exchange (EME)
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://excess.company/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We connect your surplus with verified, high-value reuse opportunities."

### NL:I02
- Name: Gemeente Kerkrade
- Land: NL
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://www.kerkrade.nl/superlocal-bleijerheide
- Weitere URL: https://www.kerkrade.nl/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Oeffentliche_Hand_Foerderung / Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Om te experimenteren met nieuwe technieken is er een partnerschap gevormd tussen 12 partijen ... en Gemeente Kerkrade."

### NL:M07
- Name: GP Groot recycling (Heiloo)
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.gpgrootrecycling.nl/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Geef bouwmaterialen een tweede leven! De circulaire bouwhub slaat de brug tussen vraag en aanbod."

### NL:M08
- Name: Gubbels (Helvoirt)
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://gubbels.nl/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Deze tweedehands bouwmaterialen verkopen we via onze marktplaats pagina."

### NL:M09
- Name: GWW Circulair (Broek op Langedijk)
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.gwwcirculair.nl/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Nieuwe en gebruikte materialen van een goede kwaliteit vind je op deze site."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Built by: Ham & Sybesma"

### NL:M10
- Name: Handelsonderneming Klepper
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://woodfarm.nl/product-category/bouwmaterialen/gebruikte-bouwmaterialen/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Gebruikte bouwmaterialen"
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Betrieb_Nutzung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "HEEMwonen, gemeente Kerkrade en IBA Parkstad hebben de ambitie en uitgangspunten van het concept bewaakt en gecoördineerd."

### NL:M11
- Name: Hoogeboom
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.allesovercirculairslopen.nl/sloopmaterialen/aangeboden/-2006-hoogeboom/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "De circulaire HUBs van Hoogeboom in Raalte en Zwolle zijn opslagplaatsen voor circulaire bouwmaterialen, van waaruit ook verkocht wordt."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We're teaming up with lcp-circulair, a joint venture between cepezedprojects and Lagemaat."
...
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/en/peoplespavilion
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "New Horizon, IJB groep, Stiho groep, Govaplast, Tetris, Elektroned, DEGO, Morssinkhof, Vitra & Keizersgrachtkerk"

### NL:U32
- Name: IMd Raadgevende Ingenieurs
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://imdbv.nl/expertises
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Het donorskelet is van concept uitgegroeid tot circulaire werkelijkheid"

### NL:M12
- Name: Insert Marketplace
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.insert.nl/producten/insert-marktplaats/
- Weitere URL: https://www.insert.nl/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Insert Marktplaats is een platform waar je jouw gebruikte materialen uit de bouw en buitenruimte en groenobjecten kunt aanbieden."

### NL:M13
- Name: Jan van IJken Oude Bouwmaterialen
- Land: NL
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://oudebouwmaterialen.nl/jan-van-ijken-oude-authentieke-bouwmaterialen-bv/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Wij handelen in oude bouwmaterialen en maken ze weer geschikt voor hergebruik."

### NL:P8
- Name: Jeugdkliniek Ithaka
- Land: NL
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.burobas.nl/project/emergis-ithaka-circulariteit-duurzaamheid-healing-environment-ontwerp
- Weitere URL: https://www.burobas.nl/nieuws/kinder-en-jeugdkliniek-van-emergis-volgens-jury-mooiste-gebouw-van-zeeland
- Weitere URL: https://www.innax.nl/kennisbank/toekomstvast-bouwen/emergis
- Weitere URL: https://www.skipr.nl/nieuws/circulair-herbouwde-kliniek-emergis-geopend
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "contractor steel construction: kampstaal"

### NL:U34
- Name: Kraaijvanger Architects
- Land: NL
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.kraaijvanger.nl/en/projects/montessori-maassluis
- Weitere URL: https://www.kraaijvanger.nl/
