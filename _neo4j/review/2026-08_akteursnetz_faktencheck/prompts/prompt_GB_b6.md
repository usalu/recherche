...
- Beleg-URL (MUSS geoeffnet werden): https://staxreclamation.com/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We've been amassing a huge depth of stock in our yard since 1995, whether you're looking for new or reclaimed building materials to start a new project"

### GB:U54
- Name: Stiff + Trevillion
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.stiffandtrevillion.com/projects/tower-bridge-court
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "20 tonnes of 1930s steel beams were salvaged from the former House of Fraser on Oxford Street and reused within TBC."

### GB:X02
- Name: Studierende, Schulkinder und Freiwillige
- Land: GB
- Typ (Altdaten, unbestaetigt): Unbekannt
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "70 students worked on the Waste House in their workshops and over 250 students helped in total"

### GB:U55
- Name: Studio PDP
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://studiopdp.com/3033-sloane-street
- Weitere URL: https://www.studiopdp.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Circular economy: reducing the need for further major refurbishment, internal layout flexibility, facade retained, re-use of existing fabric and reducing new materials."

### GB:U56
- Name: Studio RHE
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.architectsjournal.co.uk/news/developer-urban-mines-broadgate-steel-frame-for-southwark-retrofits
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Studio RHE took the project through the planning phase before Sheppard Robson took over delivery"

### GB:M22
- Name: Surplus Building & Plumbing Materials
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://surplusbuildingsupplies.co.uk/
- Weitere URL: https://surplusbuildingsupplies.co.uk/how-it-works
- Weitere URL: https://surplusbuildingsupplies.co.uk/building-materials.html
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The Marketplace for Surplus Building & Plumbing Materials"

### GB:S02
- Name: Sustainability Yard
- Land: GB
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://ukgbc.org/resources/marketplace-for-reusable-building-materials/
- Weitere URL: https://sustainabilityyard.com/
- Weitere URL: https://sustainabilityyard.com/docs/sell-on-sustainability-yard
- Weitere URL: https://sustainabilityyard.com/docs/sell-on-sustainability-yard-business
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "A marketplace platform for anyone in the construction industry to buy, sell or give away their excess (reusable) building materials."

### GB:U57
- Name: Symmetrys
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://symmetrys.com/about-us/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Reuse_Zirkularitaetsberatung / Tragwerksplanung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "BIM, Civil Engineering, Demountable Structures & MMC, Facade Remediation, Pre-Planning & Basements, Structural Engineering"

### GB:U58
- Name: TFT Consultants
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.tftconsultants.com/services/circular-economy
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "For construction, the circular economy provides a means of reducing material waste, carbon emissions and project costs."

### GB:M23
- Name: The Antique Oak Flooring Company
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://reclaimedflooring.co.uk/about-us/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "a family-run business with Cornish heritage and almost a working lifetime steeped in the reclamation and re-use of antique and reclaimed flooring"

### GB:M24
- Name: The Architectural Forum
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.thearchitecturalforum.com/pages/about-us
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We are very conscious of the importance of reclaiming and salvaging, and the positive impact on our global resources and environment."

### GB:U59
- Name: The Built Environment Trust
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.steelconstruction.info/Circular_building
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Arup, The Built Environment Trust, Frener & Reifer and BAM teamed up to discover how we might apply circular economy principles to the design and construction of buildings."

### GB:U60
- Name: The Engineers Reuse Collective (TERC)
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://terc.org.uk/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "a not-for-profit group of practising engineers championing, accelerating and delivering reuse in the built environment"

### GB:M25
- Name: The Old Slate Yard
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://theoldslateyard.co.uk/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The Old Slate Yard, Builders Merchant reclaimed bricks"

### GB:M26
- Name: The Reclaimed Company
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://shop.thereclaimedcompany.co.uk/home/about-us/reclaimed-materials/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Buy, sell and discover reclaimed building materials, architectural salvage and one-off pieces with genuine history, character and practical value."

### GB:P14
- Name: Timber Square London
- Land: GB
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://hoarelea.com/project-story/timber-square/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "retaining a quarter of the existing Print Building (the basement and structural frame) to mix elements of the old with the new"

### GB:F02
- Name: UCL Circular Economy Lab
- Land: GB
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.ucl.ac.uk/circular-economy-lab/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "aiming to use UCL's expertise to improve the design of buildings and products, their re-use and recycling, and the return of their constituent materials back to the economy"

### GB:U61
- Name: UK CLT
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://ukclt.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "UKCLT is a research and development led company that localises the manufacture of cross-laminated timber and glulam using high quality recovered wood."
...
- Weitere URL: https://www.brighton.ac.uk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Betrieb_Nutzung / Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "a building in continuous use at the University of Brighton as a space for eco-design thinking and experimentation"

### GB:F04
- Name: University of East Anglia
- Land: GB
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.uea.ac.uk/about/news/article/east-anglia-to-the-core-celebrating-10-years-of-ueas-hairy-building
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "reclaimed materials within the building including the African Iroko benches from an old university chemistry lab"
