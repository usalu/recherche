...
- Beleg-URL (MUSS geoeffnet werden): https://www.aix.se/att-aterbruka/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf / Reuse-Beratung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Att återbruka (eigene dauerhafte Leistungsseite von AIX Arkitekter zu Wiederverwendung von Bauteilen und Inredning)"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "14 parter ingår i projektkonsortium: RISE, Akademiska Hus, Bjerking, Codesign, Förbo, Heidelberg Materials-Precast Contiga, KTH, Magnolia Bostad, NCC, Palats"

### SE:U03
- Name: Anthesis
- Land: SE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.anthesisgroup.com/se/referensprojekt/aterbruk-i-byggsektorn/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Återbruk i byggsektorn | Anthesis Sverige (einzelne Referenzprojekt-Seite, kein dauerhafter Leistungsbereich)"

### SE:U04
- Name: Atrium Ljungberg
- Land: SE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://corporate.al.se/hallbarhet/miljomassig-hallbarhet/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Genom återbruk, ökad sortering och minskat avfall skapar vi en mer hållbar materialanvändning."
...
- Land: SE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://bjerking.se/vara-tjanster/teknikomrade/aterbruk
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi kan hjälpa dig bedöma potentialen för cirkularitet och återbruk i ditt projekt så att det blir så klimatsmart som möjligt."

### SE:M01
- Name: Brattöns Återbruk
- Land: SE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.brattonsaterbruk.se/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Brattöns Återbruk – Begagnat byggmaterial (Firmenname und Seitentitel der eigenen Website; Geschäftszweck ist Verkauf gebrauchten Baumaterials)"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Initiativet Handslaget ska mynna ut i användbart lärande och konkreta åtgärder inom cirkulärt byggande."

### SE:M02
- Name: Bygghubben
- Land: SE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://bygghubben.se/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bygghubben ägs och drivs av sex delägarföretag, varav fyra konkurrerande byggbolag."

### SE:M03
- Name: ByggRetur
- Land: SE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://byggretur.se/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Marketplace-Betreiber / Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Sveriges modernaste marknadsplats för överblivet byggmaterial"

### SE:M04
- Name: Byggåterbruket (Umeå)
- Land: SE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
...
- Beleg-URL (MUSS geoeffnet werden): https://ccbuild.se/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "CCBuild is a platform for actörer who want to contribute to more sustainable and resource-efficient building, with a digital marketplace and product bank for reuse"

### SE:U08
- Name: Codesign Sweden AB
- Land: SE
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Innovationsprojektet Återhus – att bygga hus av hus leds av Codesign i samarbete med NCC, RISE och Stockholms stad"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Medverkar gör även Stockholm stad, Vasakronan, Fabege, Atrium Ljungberg, Contiga, Zengun, Anthesis, Svensk Betong, Ramboll och KTH."

### SE:M05
- Name: Fabege
- Land: SE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.fabege.se/kunskap-och-inspiration/nyheter/2025/aterbrukshubben-fyller-tva-ar/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Just nu finns ca 157 ton material i vår återbrukshubb redo att återbrukas i våra projekt."

### SE:P1
- Name: H22 Pavilion / ReCreate Sweden Pilot
- Land: SE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/recreate-exhibitions/h22-pilot/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "99% reused material (by weight)"
...
### SE:N01
- Name: Handslag för cirkulärt byggande
- Land: SE
...
### SE:U11
- Name: Helsingborgshem
- Land: SE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://helsingborgshem.se/artikel/vart-miljoarbete
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Materialanvändning och återbruk: Att hushålla och återvinna med material är viktigt för att minska både klimatpåverkan"
...
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.businessregiongoteborg.se/naringslivsutveckling/hallbar-utveckling/goteborgs-plattform-klimatneutralt-byggande/handslag-cirkulart-byggande
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "HSB Göteborg"
