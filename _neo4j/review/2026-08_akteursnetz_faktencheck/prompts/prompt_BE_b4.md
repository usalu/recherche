...
### BE:M30
- Name: La Ressourcerie Fribourg
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.la-ressourcerie.ch/
- Weitere URL: https://www.la-ressourcerie.ch/projets
- Weitere URL: https://www.la-ressourcerie.ch/les-mat%C3%A9riaux
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Le magasin de la Ressourcerie propose aux particuliers et aux professionnels un lieu où se fournir en matériaux de construction à moindre coût et de manière durable."

### BE:M31
- Name: Labeur Atelier - Labeur
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://labeur.be/over-labeur/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "we verzamelen van resthout en afgeschreven materialen, die we selecteren en bewerken"

### BE:F04
- Name: Laboratory for Green Transformable Buildings (GTB Lab)
- Land: BE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.gtb-lab.com/about
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "GTB Lab develops and realises concrete, sustainable, adaptable and innovative building systems"

### BE:I03
- Name: Lo-Reninge town council
- Land: BE
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://noaarchitecten.net/projects/1/046-lo-reninge-town-hall
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Betrieb_Nutzung / Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Client Dexia / Lo-Reninge town council"

### BE:P6
- Name: Lo-Reninge Town Hall…
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://noaarchitecten.net/projects/1/046-lo-reninge-town-hall
- Weitere URL: https://www.vai.be/en/buildings/publieke-gebouwen/stadhuis-lo-lo-reninge
- Weitere URL: https://adokin.eu/fr/category/comment/projets
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We used recycled brick whose shades of colour, form and size relate to the brick of the convent."

### BE:U27
- Name: Loeliger Strub
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.espazium.ch/de/aktuelles/loeliger-strub-lysp8-basel
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Loeliger Strub Architektur realisieren mit LysP8 auf dem Basler Lysbüchel-Areal Wohnungen aus wiederverwendeten Bauteilen"

### BE:S01
- Name: Madaster / EPEA
- Land: BE
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://madaster.de/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Denn nur durch zirkuläres Bauen können wir die Abfallmenge und die CO2-Emissionen drastisch reduzieren"

### BE:P7
- Name: Maison DnA
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://opalis.eu/fr/projets/maison-dna
- Weitere URL: https://www.archdaily.com/423660/dna-house-blaf-architecten
- Weitere URL: https://archello.com/project/dna-house
- Weitere URL: https://www.vai.be/en/buildings/eensgezinswoning/woning-dn-a-asse
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "la façade est constituée de briques de réemploi, cette méthode de construction est donc compatible avec les matériaux ... du réemploi"

### BE:P8
- Name: Maison Vignette
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://guidebatimentdurable.brussels/construction-dune-maison-unifamiliale-paille-projet-vignette
- Weitere URL: https://opalis.eu/fr/projets/maison-vignette
- Weitere URL: https://gidsduurzamegebouwen.brussels/sites/default/files/documents/2024-06/dt4_2_2_project-sheets_041023_lr.pdf
- Weitere URL: https://opalis.eu/fr/projets/maison-vignette-karbon-architecture-et-urbanisme
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "majoritairement biosourcés et faiblement transformés ou issus des filières du réemploi"

### BE:M32
- Name: Materialenbank Leuven / Atelier Circuler
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://ateliercirculer.be/materialenbank
- Weitere URL: https://ateliercirculer.be/
- Weitere URL: https://ateliercirculer.be/materialenbank/catalogus
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Hout, Stenen, Metaal, Isolatie, Verwarming & Sanitair, Elektriciteit & Verlichting, Ramen & Deuren, Afgewerkte Producten"

### BE:U28
- Name: Matriciel
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/zinneke-feder-masui4ever
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "In 2016, Ouest architecture and Matriciel were selected to join the project."

### BE:P9
- Name: Multi Brussels
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/reuse-multi-project
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "six-year long collaboration between Whitewood, Conix RDBM and Rotor"

### BE:P10
- Name: Musée de Folklore Vie…
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://cellule.archi/fr/integration-oeuvres-art/musee-du-folklore-de-mouscron
- Weitere URL: https://simonboudvin.fr/UN-NOUVEAU-MUSEE-Mouscron-2012-2019
- Weitere URL: https://www.vplus.org/folklore-museum
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "30.000 briques ont été récupérées et insérées dans la maçonnerie"

### BE:M33
- Name: MVV Afbraakwerken Martin
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.mvvafbraak.be/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Verkoop van recuperatiebouwmaterialen (na afspraak)"

### BE:N05
- Name: Namur Croisade pauvreté
- Land: BE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.namur.be/fr/annuaire/croisade-et-pauvrete-asbl
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "récupère et commercialise des matériaux, châssis, portes, meubles, pierres anciennes ... destinés ... à être réutilisés dans le cadre de la restauration d'immeubles"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Restoration and extension of a former convent to create a town hall"

### BE:N06
- Name: Opalis
- Land: BE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://opalis.eu/en/about
- Weitere URL: https://experimentationsurbaines.ademe.fr/blog/ressource/opalis-plateforme-de-reemploi-de-materiaux-de-construction-et-de-renovation/
- Weitere URL: https://librairie.ademe.fr/economie-circulaire-et-dechets/5516-reemploi-des-materiaux-de-construction.html
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Forschung_Dokumentation / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Rotor is an association active since 2005 in the field of reuse of building elements, through research, interior projects with reclaimed materials, and various collaborations with architects, contractors and building owners."

### BE:U31
- Name: Ouest Architecture
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://ouest.be/projet/destruction-reemploi-dans-le-processus-participatif/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Projektmanagement_Koordination / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Conférence Rotor / Ouest architecture / Zinneke asbl"

### BE:I05
- Name: OVAM (Openbare Vlaamse Afvalstoffenmaatschappij)
- Land: BE
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://ovam.vlaanderen.be/circulair-materialenbeheer
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Circulair materialenbeheer wil de milieu-impact verkleinen van materialen die gebruikt worden of vrijkomen bij bouwen, renoveren en slopen."

### BE:P11
- Name: OXY Centre Monnaie
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/oxy-centre-monnaie
- Weitere URL: https://rotordb.org/en/news/material-donnerie-oxy-friday-25-november
- Weitere URL: https://rotordb.org/en/news/works-oxy-well-underway
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Rotor was asked to join the project team to help define a circular approach to the project, integrate reuse principles"
