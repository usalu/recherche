...
### DE:N03
- Name: Bygherreforeningen i Danmark (BID)
- Land: DE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://bygherreforeningen.dk/baeredygtighed/cirkulaer-oekonomi-i-byggeriet/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Genbrug/genanvendelse af materialer fra nedrevet skole til ny skole."

### DE:P4
- Name: CIRCOFIN (Circular Construction Finance)
- Land: DE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://circular-cities-and-regions.ec.europa.eu/ccri-projects/circofin-circular-construction-finance
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "showcase how they transform local and regional markets for secondary building components and materials"

### DE:F02
- Name: Circular Material Systems
- Land: DE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://circularmaterialsystems.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "This website is an ongoing project creating an atlas of best-practice examples to learn from and to get inspired by."

### DE:U13
- Name: Circular Structural Design
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://circular-structural-design.eu/en/
- Weitere URL: https://www.din.de/de/din-und-seine-partner/presse/mitteilungen/zirkulaer-bauen-zweites-leben-fuer-altes-baumaterial-931612
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We develop demountable structural concepts that facilitate the reuse of materials at the end of a building's life cycle"

### DE:U14
- Name: CITYFÖRSTER
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.cityfoerster.net/expertise/re_use-622-2.html
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The building sector is responsible for 38% of global CO2 emissions while also being the largest producer of waste."
...
- Weitere URL: https://www.tu.berlin/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "sagt Claus Asam vom Institut für Erhaltung und Modernisierung von Bauwerken an der Technischen Universität Berlin (IEMB)"

### DE:S01
- Name: Concular
- Land: DE
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://concular.de/
- Weitere URL: https://concular.de/urban-mining/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Nachhaltigkeitsberatung / Reuse_Zirkularitaetsberatung / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Urban Mining inkl. Vermarktung und rechtssicherer Wiedereinbau"

### DE:P5
- Name: Consolis DW Systembau
- Land: DE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.dw-systembau.de/Concular.html
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "werden künftig Gebäude als Materiallager dienen"

### DE:P6
- Name: CRCLR House
- Land: DE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.zrs.berlin/en/project/crclr-house-2/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Another special feature is the reuse of the steel components from the hall's roof structure."
...
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.nbl.berlin/projects/reallabor-be-ware/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Rückbau- und Logistikbetriebe: HTR – Holz-Transporte, DARE GmbH (Rückbau)"

### DE:G02
- Name: Deutsche Bundesstiftung Umwelt (DBU)
- Land: DE
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Plattenvereinigung wird durch die Deutsche Bundesstiftung Umwelt (DBU) als Projekt für „Berufsbildung und öffentlichen Diskurs zum Ressourcenschutz am Beispiel eines modellhaften mobilen Recyclinggebäudes"

### DE:U18
- Name: Die Zusammenarbeiter
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Christian Schöningh ist Teil der TRNSFRM eG und mit „Die Zusammenarbeiter" einer der planenden Architekten vor Ort."

### DE:U19
- Name: DREWES + SPETH Beratende Ingenieure
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.aknds.de/architektur-baukultur/staatspreis-2020/engere-wahl-2020/recyclinghaus-hannover-kronsberg-hannover
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Tragwerksplanung: DREWES + SPETH Beratende Ingenieure im Bauwesen Partnerschaftsgesellschaft mbB, Hannover"

### DE:U20
- Name: Ed. Züblin AG
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://din.one/spaces/ra/pages/160465865/Standardisierung+von+R%C3%BCckbaukonzepten+bei+Bestandsgeb%C3%A4uden
- Weitere URL: https://www.zueblin.de/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Ed. Züblin AG (Potenzielle Projektpartner*innen, Standardisierung von Rückbaukonzepten bei Bestandsgebäuden)"

### DE:P7
- Name: EDGE Suedkreuz Berlin
- Land: DE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://edge.tech/portfolio/edge-suedkreuz-berlin
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The building was constructed using a recyclable hybrid timber system... embody the 'circular economy', and are smart, modular, and intelligent."
...
- Beleg-URL (MUSS geoeffnet werden): https://www.dbz.de/artikel/crclr-house-berlin-3945221.html
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Energieberatung / Energiezentrale: eZeit Ingenieure GmbH, Berlin, www.ezeit-ingenieure.de"

### DE:U22
- Name: Faltlhauser Krapf
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://fk-ing.com/projekt/neubau-jugendtreff-ingersheim/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Tragwerksplanung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Betonschalungen der Baustelle des neuen Hauptbahnhofs in Stuttgart einen neuen Zweck zuführen"

### DE:U23
- Name: gabb-GebrauchtBauMarkt Saarbrücken
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): http://www.bauteilnetz.de/bauteilnetz/website/stdws_adresse/bauteilboersen/saarbruecken.html
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Der Gebrauchtbaumarkt wurde im Dez 2016 geschlossen."

### DE:N04
- Name: Gate 21
- Land: DE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://gate21.dk/saadan-arbejder-vi/fokusomraader/cirkulaer_omstilling/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Derfor arbejder vi i Gate 21 for en cirkulær omstilling, hvor vi anvender færre ressourcer, udnytter vores ressourcer bedre og i længere tid og mindsker affaldsmængderne."
