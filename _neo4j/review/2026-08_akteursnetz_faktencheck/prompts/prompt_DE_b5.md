...
- Beleg-URL (MUSS geoeffnet werden): https://www.roskilde.dk/da-dk/om-kommunen/kommunen-i-udvikling/vi-udvikler-byerne-og-landdistrikterne/byggeri-og-renovering-i-kommunen/baeredygtigt-byggeri/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi anskuer vores bygningsmasse som en materialebank"

### DE:F11
- Name: Roskilde Universitet
- Land: DE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://forskning.ruc.dk/en/projects/partnerskab-for-cirkul%C3%A6re-kommuner/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Roskilde University (lead)"

### DE:P18
- Name: Saint-Gobain (Germany)
- Land: DE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://madaster.de/neuigkeiten/pressemitteilung_5/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Saint-Gobain Deutschland wird Mitglied im Madaster Kennedy-Netzwerk."

### DE:U41
- Name: Seidl + Seidl Architekten
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.seidlarchitekten.de/haus-hos-muehlhausen/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "haus hos muehlhausen – Seidl+Seidl Architekten"

### DE:U43
- Name: Solares Bauen
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.dbz.de/artikel/crclr-house-berlin-3945221.html
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "TGA-Planung: Solares Bauen GmbH, Freiburg, www.solares-bauen.de"

### DE:S02
- Name: SURAP GmbH
- Land: DE
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://www.surap.de/
- Weitere URL: https://baumab-kassel.de/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Nachhaltigkeitsberatung / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bauteilbörsen & ReUse-Plattformen"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Sven Urselmann (carpenter & circularity expert)"

### DE:U46
- Name: TOMAS
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://kontextur.info/project/tomas
- Weitere URL: https://www.tomas-architecture.com
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Materiallieferung_Markt / Projektmanagement_Koordination / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "we also offer the transformation process for underrated buildings and circular construction as a service for others"
...
- Beleg-URL (MUSS geoeffnet werden): https://www.dbz.de/artikel/crclr-house-berlin-3945221.html
- Weitere URL: https://junge-genossenschaften.berlin/buendnis/trnsfrm/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Betrieb_Nutzung / Entwurf_Planung / Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "die TRNSFRM eG, zuständig für das partizipative Quartierskonzept, errichtete in experimenteller Holz-Hybridbauweise einen Neubau mit dem Namen ALLTAG"

### DE:F12
- Name: TU Berlin
- Land: DE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.tu.berlin/en/nbl
- Weitere URL: https://www.tu.berlin/circulareconomy/forschung/hdm
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "designed in line with circular principles, will initiate a long-overdue revision of how we build and renovate buildings"

### DE:F13
- Name: TU Berlin Fachgebiet Bauphysik und Baukonstruktionen
- Land: DE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.tu.berlin/en/bauphysik/research/past-projects/projekt-plattenvereinigung
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The building was developed in partnership with the Chair of Building Physics and Building Constructions at TU Berlin."

### DE:F14
- Name: Universität Wuppertal
- Land: DE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://team-arch.uni-wuppertal.de/de/
- Weitere URL: https://www.uni-wuppertal.de/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Urban Mining und kreislaufgerechtes Bauen"

### DE:N06
- Name: Unternehmerverband Historische Baustoffe e.V. (UHB)
- Land: DE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.historische-baustoffe.de/en/the-uhb/about-uhb/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "An association of dealers of historical building materials in Germany."

### DE:S03
- Name: Urban Mining Index
- Land: DE
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://urban-mining-index.de
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Der Urban Mining Index ist eine Systematik zur quantitativen Bewertung der Kreislaufpotenziale von Baukonstruktionen in der Neubauplanung."

### DE:U47
- Name: Urselmann Interior
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://urselmann-interior.de/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Entwurf_Planung / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "urselmann interior baut anders: zirkulär geplant, modular produziert, zum marktüblichen Preis."

### DE:U48
- Name: Werner Sobek
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://labs.aap.cornell.edu/ccl/umar-unit
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The building design created by Werner Sobek with Dirk E. Hebel and Felix Heisel demonstrates how a responsible approach to dealing with our natural resources can go hand in hand with appealing architectural form."

### DE:U49
- Name: Wiewiorra Hopp Architekten
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
...
### DE:U50
- Name: ZIRKULAAR Architektur
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.zirkulaar.de
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vermittlung und Planung mit gebrauchten Bauteilen"

### DE:U51
- Name: ZRS Ingenieure
- Land: DE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.zrs.berlin/en/office/
- Weitere URL: https://www.zrs.berlin/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Fachplanung_Nachweis / Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "aim to develop material concepts based on re-use and longevity"

### DE:O03
- Name: zukunftsgeraeusche GbR
- Land: DE
- Typ (Altdaten, unbestaetigt): Organisation
- Beleg-URL (MUSS geoeffnet werden): https://www.plattenvereinigung.de/imprint/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Plattenvereinigung ist ein Projekt der zukunftsgeraeusche GbR"
