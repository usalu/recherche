...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Projektmanagement_Koordination / Unbestimmt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Opera (Project Manager – 55 Great Suffolk Street)"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "led by the Peabody Trust in partnership with Bill Dunster Architects, Ellis & Moore Consulting Engineers, BioRegional, Arup"
...
- Weitere URL: https://plparchitecture.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Betrieb_Nutzung / Entwurf_Planung / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "92% of materials from the previous studio were either reused or donated, with a further 7% recycled, saving 175.78 tonnes of CO2 from landfill."

### GB:P11
- Name: PLP London HQ circular…
- Land: GB
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Cost Consultant: PT Projects"
...
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): http://drmmstudio.com/project/hastings-pier/
- Weitere URL: https://www.ramboll.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Multidisciplinary Engineering: Ramboll"

### GB:M16
- Name: Reclaimed Brick Company
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://reclaimedbrickcompany.co.uk/pages/about-us
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Reclaimed Brick Company specialise in reclaiming and supplying authentic reclaimed imperial bricks and natural stone from across the UK."

### GB:M17
- Name: Reclaimed World
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.reclaimedworld.com/about-us/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Discover our passion for rescuing forgotten reclaimed building materials."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "ReFrame is a series of adaptable, single-span agricultural kit buildings made from 75%+ reclaimed or repurposed steel."
...
- Beleg-URL (MUSS geoeffnet werden): https://relondon.gov.uk/built-environment
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "reusing our existing materials; and designing for an adaptable and zero-waste future"

### GB:N05
- Name: Reusefully
- Land: GB
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.reusefully.co.uk/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We ensure that all materials and waste from existing buildings are managed according to the material value hierarchy and champion the recovery of products and materials."

### GB:M18
- Name: Romsey Reclamation
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.romseyreclamation.com/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We are major importers of quality reclaimed railway sleepers."

### GB:M19
- Name: Roofslates.com
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://roofslates.com/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "quality reclaimed roof slates"

### GB:P13
- Name: Roots in the Sky
- Land: GB
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://symmetrys.com/project/roots-in-the-sky
- Weitere URL: https://ukgbc.org/resources/roots-in-the-sky
- Weitere URL: https://www.macegroup.com/en-us/news/fabrix-appoints-mace-as-main-contractor-for-transformational-roots-in-the-sky-development
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The re-use of existing foundations reduce the embodied carbon energy"

### GB:N06
- Name: Salvo Ltd
- Land: GB
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.salvoweb.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Forschung_Dokumentation / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The Architectural Salvage & Reclaimed Materials Marketplace"
...
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.salvoweb.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Bildung_Wissenstransfer / Forschung_Dokumentation / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The Architectural Salvage & Reclaimed Materials Marketplace"

### GB:U51
- Name: Sheppard Robson
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Weitere URL: https://www.sheppardrobson.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Sheppard Robson is delivering this 'radical reimagining' of the former Blackfriars Crown Court"

### GB:U52
- Name: Simple Works
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.simple-works.co.uk/latest/reclaimed
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Reclaimed asks what happens when structural leftovers meet artistic intent"

### GB:U53
- Name: Solus
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://designwanted.com/solus-ceramics-spolia-terrazzo-sustainable-tiles/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Spolia is Solus Ceramics' newest product, which uses construction waste to create sustainable and beautiful terrazzo tiles within a UK-based circular production system."
