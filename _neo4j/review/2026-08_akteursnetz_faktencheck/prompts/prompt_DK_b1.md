...
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.again.dk
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We take discarded materials and remanufacture them into new, standardised building products that meet the same performance and compliance requirements as conventional alternatives."

### DK:I01
- Name: Aarhus Kommune
- Land: DK
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://www.erhvervsby.dk/byggegruppen/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Projektpartnerne er Gladsaxe Kommune og Gladsaxe Erhvervsby ... Aarhus Kommune, WeBuildDenmark, Pihl Holdings og Danske Regioner"
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Bauherr_Auftraggeber
...
### DK:U04
- Name: Aksel V. Jensen A/S
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.avj.dk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Boernehuset Svanen"

### DK:U05
- Name: Artelia
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://arteliagroup.dk/en/services/reuse-and-recycling/
- Weitere URL: https://www.arteliagroup.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Unbestimmt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Reuse and recycling of construction materials"
...
- Beleg-URL (MUSS geoeffnet werden): https://www.bango.dk/tilbud/genbrug/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Her finder du alle Bango brugte vare"

### DK:N01
- Name: Bolius genbrugsmaterialer directory
- Land: DK
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.bolius.dk/her-kan-du-koebe-genbrugsmaterialer-10121
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Videncentret Bolius har samlet en liste af byggemarkeder med brugte byggematerialer i Danmark."

### DK:M05
- Name: Byggeboersen
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.xn--byggebrsen-5cb.dk/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi fungerer som en søgemaskine, der hjælper private med at finde genbrugsmaterialer hurtigere."

### DK:M06
- Name: Bærebyg
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://baerebyg.dk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi tilbyder et bredt udvalg af genbrugte byggematerialer – fra døre, vinduer og køkkener til VVS-dele og el-artikler"

### DK:M07
- Name: Carlsberg
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.carlsbergbyen.dk/om-carlsberg-byen/historie/transformation-af-bygninger
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "gamle mursten fra Søndermarkshuset er blevet genanvendt for at genskabe"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "90 % af de materialer, som bruges til at bygge Circle House, kan genanvendes stort set uden at tabe værdi."

### DK:M08
- Name: Circue
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://circue.dk
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Use Circue's free platform to browse reused materials available in the market now."

### DK:M09
- Name: Dem fra Nordlunde
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://demfranordlunde.dk/shop/254-brugt-marked
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi har altid er godt udvalg i brugte byggematerialer fra vores nedrivning, og fra opkøb."

### DK:M10
- Name: Den Grønne Genbrugshal
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.gronnehal.dk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Stort udvalg af genbrug og bæredygtige varer"

### DK:U08
- Name: DOVISTA / KRONE
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://dovista.com/krone-brandcase
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "KRONE supplied all the windows to the building, including the upcycled windows."

### DK:F01
- Name: DTU
- Land: DK
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.dtu.dk/forskning/omraader/byggeri/cirkulaert-byggeri
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Ved at genbruge hele bygningsdele bevarer byggeriet de økonomiske værdier og den energi, der er brugt til at bearbejde råmaterialer og fremstille de enkelte bygningsdelene."

### DK:U09
- Name: Gamle Mursten
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://gamlemursten.dk/en/produkter/red-reclaimed-danish-bricks/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "These recycled bricks come from Danish demolition projects where they have retained their strength over decades."

### DK:U10
- Name: Genbrugssten ApS
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://genbrugssten.dk/om-os/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "At indsamle, sortere og rense mursten fra nedbrydning, så de kan afsættes til nye bæredygtige byggerier"
