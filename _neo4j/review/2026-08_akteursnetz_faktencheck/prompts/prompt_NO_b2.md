...
- Beleg-URL (MUSS geoeffnet werden): https://www.multiconsult.no/tjenester/bygg-og-eiendom/fag-og-tjenester/ombruksradgivning-fra-a-til-a/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Multiconsult tilbyr helhetlig ombruksrådgivning for prosjekter med ombruk av bygg og materialer gjennom alle faser."

### NO:F01
- Name: Nordlandsforskning AS
- Land: NO
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Nordlandsforskning har ansvar for å utvikle rammeverk og indikatorer for å evaluere aktivitetene i alle byene."

### NO:F02
- Name: NTNU
- Land: NO
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.trondheim.kommune.no/tema/klima-miljo-og-naring/miljo/gjenom-veileder/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "GjenOm er et forskningsprosjekt ledet av Trondheim kommune, i samarbeid med SINTEF, NTNU, Asplan Viak og Loopfront."

### NO:N04
- Name: Ombruk i nord (Remiks)
- Land: NO
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://remiks.no/nyheter/bedrift/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Ombruk og gjenbruk med Remiks"

### NO:N05
- Name: Ombruks-HUB Sørlandet AS
- Land: NO
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://bolgenbks.no/ombruks-hub
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "demontering, frakt, mellomlagring og distribusjon"

### NO:M05
- Name: OMBYGG
- Land: NO
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.ressurssentral.no/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "I teltet tilbyr driftsselskapet Ombygg ombruksvarer av høy kvalitet og utleie av lagerplass til ombruksvarer."

### NO:N06
- Name: Regionalt ombruksnettverk for byggematerialer (Oslo-Trondheim)
- Land: NO
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.multiconsult.no/etablerer-nettverk-for-mer-ombruk-av-byggematerialer/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Loopfront og Multiconsult etablerer nå nettverk for ombruk av byggematerialer."

### NO:S03
- Name: Rehub
- Land: NO
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://www.rehub.no/ombruk-i-byggebransjen
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Ombruk i byggebransjen: Slik får du oversikt, sparer penger og bygger mer bærekraftig"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Resirkula er et gjenbrukskjøpesenter i kretsløpsparken ved Hamar og er Sirkula IKS sin satsing på ombruk, avfallsreduksjon og sirkulærøkonomi."

### NO:U11
- Name: Scenario Interiørarkitekter
- Land: NO
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.scenario.no/prosjekter/ka13-tullinlokka
- Weitere URL: https://www.scenario.no/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Her har Scenario hatt ansvar for interiøret i kontorbyggets åtte etasjer."

### NO:S04
- Name: Sirken
- Land: NO
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://sirken.no/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Norges markedsplass for sirkulære byggematerialer. Kjøp brukte byggevarer og bidra til en grønnere fremtid."

### NO:U12
- Name: Sirkula IKS
- Land: NO
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.sirkula.no/ombruk/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "De brukbare tingene du ikke trenger lenger, kan andre ha glede av."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Sirkulær Ressurssentral skal bidra til økt ombruk av byggevarer."
...
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.multiconsult.no/etablerer-nettverk-for-mer-ombruk-av-byggematerialer/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "deltar med bygg som skal kartlegges, blant annet Oslo Areal, Omsorgsbygg Oslo KF, Asker kommune, Trondheim kommune, TOBB, NTNU og SINTEF"
...
- Beleg-URL (MUSS geoeffnet werden): https://www.trondheim.kommune.no/tema/klima-miljo-og-naring/miljo/gjenom-veileder/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "GjenOm Veileder - for gjenbruk av bærende konstruksjoner, skal hjelpe bygningseiere med å vurdere ombruk, tekniske vurderinger og klimatiltak"
