...
- Beleg-URL (MUSS geoeffnet werden): https://www.lindner-group.com/de/kompetenzen/nachhaltiges-bauen-zirkulaeres-bauen/reused-products-wiederverwendbare-produkte
- Weitere URL: https://www.lindner-group.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Diese werden nach ihrer Nutzung in unserem Werk aufbereitet und nach technischer Prüfung als gleichwertige Gebrauchtprodukte weiter verkauft."

### CH:P8
- Name: LYSP8 Basel
- Land: CH
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.baunetzwissen.de/fassade/objekte/wohnen/wohnhaus-lysp8-in-basel-10095918
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Zahlreiche Bauteile, Materialien und Einrichtungsgegenstände erhielten dabei ein zweites Leben."

### CH:S03
- Name: Madaster
- Land: CH
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://madaster.ch/en/
- Weitere URL: https://circulareconomy.europa.eu/platform/en/dialogue/existing-eu-platforms/madaster
- Weitere URL: https://madaster.com/material-passport/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Materialbroker / Reuse-Marketplace-Betreiber / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "It also enables determining whether materials and products can be reused after disassemblage."

### CH:U23
- Name: manoa Landschaftsarchitekten
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.stadt-zuerich.ch/de/planen-und-bauen/projekte-und-ausschreibungen/hochbauvorhaben/planung-ausfuehrung/recyclingzentrum-juch-areal.html
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Landschaftsarchitektur manoa Landschaftsarchitekten GmbH, Meilen"

### CH:M10
- Name: Matériuum
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://materiuum.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Bildung_Wissenstransfer / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Matériuum est une association genevoise ayant pour mission la préservation des ressources naturelles. Pour cela elle promeut et facilite le réemploi dans les milieux de la construction."

### CH:M11
- Name: Matériuum Genève Ressourcerie
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://materiuum.ch/ressourcerie-espace-magasin-shop-geneve/
- Weitere URL: https://materiuum.ch/lassociation/
- Weitere URL: https://materiuum.ch/boutique/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "La Ressourcerie se charge aussi de récupérer des éléments de scénographie intéressants pour leur donner une seconde vie."

### CH:U24
- Name: Meili Partner Baumanagement
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Baumanagement (Construction Management): Meili Partner Baumanagement, Zürich"

### CH:U25
- Name: Modissa Immobilien AG
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://zirkular.net/de/projekt/grubenstrasse-29/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Auftraggeber (Client): Modissa Immobilien AG"

### CH:U26
- Name: Monotti Ingegneri
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.metalocus.es/en/news/parabase-wins-competition-residential-development-reuse-building-elements-areal-walkeweg-nord-basel
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Tragwerksplanung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Structural Engineering.- Monotti Ingegneri Consulenti SA: Mario Monotti."

### CH:U28
- Name: Nomol
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.nomol.ag/uber-uns
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Projektmanagement_Koordination / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Sie entwickelt und betreibt innovative, kreislaufwirtschaftliche Geschäftsmodelle und Prozesse zur Rückgewinnung, Aufbereitung und Wiederverwendung von Baukomponenten"
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Civil engineer: Oberli Ingenieurbau AG"

### CH:U31
- Name: PARABASE
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.parabase.eu/
- Weitere URL: https://www.parabase.ch
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Areal Walkeweg Nord Basel «Re-use» Competition, 2023. 1st Prize. Ongoing"

### CH:U32
- Name: Pascal Flammer Architekten
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.espazium.ch/de/aktuelles/winterthur-hobelwerk-architektur-reuse-flammerarchitkten-nettonull
- Weitere URL: https://www.pascalflammer.com
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Das Baubüro in situ übernahm die Fachplanung des Bereichs Re-Use ... untersuchten in situ und PFA 60 Elemente, aus denen schlussendlich 21 für Erwerb und Einbau ausgewählt wurden."

### CH:U33
- Name: PIRMIN JUNG Schweiz AG
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.baublatt.ch/baupraxis/kreislauffaehiger-holzbau-vom-abbruchmaterial-zur-ressource-39291
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Reuse_Zirkularitaetsberatung / Tragwerksplanung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Das Unternehmen beschäftigt sich seit mehreren Jahren mit dem Thema zirkuläres Bauen."

### CH:N02
- Name: RE-WIN
- Land: CH
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://re-win.ch/verein/ueber
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Forschung_Dokumentation / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Der Verein RE-WIN will einerseits eine Kultur der Wiederverwendung von Bauteilen sowohl in den Architektur- und Planungsbüros als auch in der Bauwirtschaft selber fördern"

### CH:P9
- Name: Re:Crete footbridge
- Land: CH
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.epfl.ch/schools/enac/recrete/
- Weitere URL: https://www.construction21.org/articles/h/recrete-footbridge.html
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "To demonstrate this, the Sructural Xploration Lab (SXL) has built the RE:CRETE prototype, a footbridge built from 25 reused concrete blocks."

### CH:O01
- Name: Re:Crete Forschungsteam
- Land: CH
- Typ (Altdaten, unbestaetigt): Organisation
- Beleg-URL (MUSS geoeffnet werden): https://www.smartlivinglab.ch/en/projects/recrete-reused-of-cut-concrete/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Brütting, Jan; Bastien-Masse Maléna; Devènes, Julie; Grangeot, Maxence; Küpfer, Célia; Fivet, Corentin"

### CH:M13
- Name: Ressourcerie Lausanne / Matériuum / R-UUL
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://materiuum.ch/ressourcerie-lausanne-magasin-shop/
- Weitere URL: https://materiuum.ch/boutique/
- Weitere URL: https://materiuum.ch/deconstruction-et-valorisation/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "D'une surface totale d'environ 800m2, la Ressourcerie Matériuum Lausanne (RUUL) permet de stocker et de prolonger la durée de vie d'une grande quantité de matières."

### CH:M14
- Name: ReUse Recycling Center Riedtwil / wiederverwendung.ch
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://hiltbrunnerag.ch/reuse-recycling.html
- Weitere URL: https://www.wiederverwendung.ch/
- Weitere URL: https://shop.wiederverwendung.ch/de/434/gebrauchte-bauteile-occasion-bauteile
- Weitere URL: https://shop.wiederverwendung.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "ReUse - direkte Wiederverwendung: Verkauf von wiederverwendbaren Gebrauchtwaren und Baumaterialien"

### CH:S04
- Name: REUZI
- Land: CH
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://reuzi.ch/
- Weitere URL: https://reuzi.ch/agora/
- Weitere URL: https://www.immobilier.ch/fr/actualite/reuzi-ressource-les-chantiers-avec-du-reemploi-13814
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "plateforme numérique et collaborative de diffusion et de mise en valeur des bonnes pratiques"
