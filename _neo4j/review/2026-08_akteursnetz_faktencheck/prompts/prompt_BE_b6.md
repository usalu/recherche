...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Maître d'ouvrage / Ville de Mouscron"

### BE:F08
- Name: Vlaamse Instelling voor Technologisch Onderzoek (VITO)
- Land: BE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://vito.be/nl/circulaire-economie/circulaire-transitie-in-vlaanderen
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Samen met de bouwindustrie zoeken we oplossingen die gericht zijn op recyclage en hergebruik van waardevolle bouwmaterialen"

### BE:F09
- Name: Vrije Universiteit Brussel (VUB) – Architectural Engineering
- Land: BE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://press.vub.ac.be/europese-primeur-voor-vub-eerste-circulaire-renovatieproject-circular-retrofit-lab-feestelijk-ingehuldigd
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "VUB Architectural Engineering doet al meer dan 10 jaar onderzoek naar veranderingsgericht bouwen."
...
- Weitere URL: https://www.whitewood.eu/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Commissioner: Whitewood"
...
- Weitere URL: https://feder.brussels/2022/03/02/masui4ever-2
- Weitere URL: https://biblio.ugent.be/publication/01K7S2ZVKT545EJ2SR62RCCHF9
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "In 2015, Zinneke invited Rotor to join the long-term project for the renovation of their 4.000 m² new facilities at Place Masui."
