...
### FI:P5
- Name: Lokomotion Technology…
- Land: FI
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.lokomotion.fi/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "recycled concrete elements were reused in construction"
...
### FI:P6
- Name: Melkinlaituri Primary…
- Land: FI
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.yit.fi/en/projects/melkinlaituri-elementary-school-and-daycare-centre-helsinki
- Weitere URL: https://verstasarkkitehdit.fi/projects/melkinlaituri-school-and-daycare-centre/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The project utilizes recycled hollow-core slabs and low-carbon concrete."
...
### FI:U14
- Name: Mikkelin Kehitysyhtiö Miksei Oy
- Land: FI
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Land: FI
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.peikko.com/products/circular-economy/overview/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "In time and led by our R&D department, we aim to establish a fully circular product portfolio and building system that enables reusing building materials several times over."

### FI:U16
- Name: Purkukolmio Oy
- Land: FI
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.purkukolmio.fi/purkukolmio-yrityksena
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Purkukolmio on perheyritys, joka myy vanhaa tavaraa uusiokäyttöön."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Purkutori.fi-palvelun tarjoaa Purkupiha Oy – yksi Suomen suurimmista purkuliikkeistä ja johtava suomalaisomisteinen rakennusten ja teollisuuden purkaja Suomessa."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "we at Ramboll developed designing the refurbishment of the reclaimed elements in collaboration with the factory"

### FI:F03
- Name: ReCreate Finnish cluster
- Land: FI
...
### FI:P7
- Name: Rovastinkangas School Expansion
- Land: FI
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://orivesi.fi/rovastinkankaan-koulun-laajennusosaan-750-nelion-monitoimitila-uudisrakentamisessa-hyodynnetaan-poikkeuksellisella-tavalla-kiertotaloutta/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Tiilet välivarastoidaan ja niitä tullaan käyttämään uuden laajennusosan rakentamisessa."

### FI:U20
- Name: Sitowise
- Land: FI
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.ttl.fi/tutkimus/hankkeet/uudelleenkaytettavien-rakennusosien-kayton-edistaminen-talonrakentamisessa-uuraket
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Osatoteuttajat: Aalto-yliopisto, AFRY Buildings Finland Oy, A-insinöörit, Eurofins Expert Services Oy, Ideastructura Oy, Sitowise Oy, Työterveyslaitos ja Ytekki Oy"

### FI:U21
- Name: Skanska Finland
- Land: FI
- Typ (Altdaten, unbestaetigt): Unternehmen
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Skanska is committed to a green deal for circular economy. We will focus on reusing construction products by exploiting the learnings from ReCreate."

### FI:M03
- Name: Spolia
- Land: FI
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.spolia.fi/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Spolia Design Oy on purettujen materiaalien uudelleen käyttöön erikoistunut asiantuntija-organisaatio, joka suunnittelee cleantech-rakennushankkeita."

### FI:G02
- Name: SÄILÖ: Purusta säilöön ja kiertoon
- Land: FI
...
- Land: FI
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.tuni.fi/en/tau/research/recreate
- Weitere URL: https://parma.fi/betonielementtien-uudelleenkayttoa-koeponnistettu-onnistuneesti-recreate-hankkeen-minipiloteissa/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "ReCreate (Reusing prefabricated concrete for a circular economy) is an EU funded project focused on deconstruction and reuse of precast concrete elements."

### FI:I05
- Name: Tampereen kaupunki (City of Tampere)
- Land: FI
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/precast-concrete
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Forschung_Dokumentation
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "ReCreate's Finnish cluster is formed by Tampere University, Skanska, Consolis Parma, Ramboll Finland, Umacon, LIIKE architects, and the City of Tampere."
...
- Land: FI
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.vttresearch.com/en/ourservices/circularity-built-environment
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Instead of generating waste, the built environment becomes a bank of resources designed to be reused, repurposed and refurbished over multiple lifecycles."
