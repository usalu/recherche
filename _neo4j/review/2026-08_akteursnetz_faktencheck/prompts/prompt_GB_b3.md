...
### GB:P7
- Name: Enterprise Centre UEA
- Land: GB
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://timberdevelopment.uk/case-studies/the-enterprise-centre-norwhich-east-anglia/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "An original Norman Foster reception desk reclaimed from the nearby Sainsbury Centre"

### GB:M10
- Name: Enviromate
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.enviromate.co.uk/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The award winning closed loop marketplace where people connect to buy, sell or donate leftover building materials."
...
- Weitere URL: https://www.erith.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Erith will deliver the basement box and demolition works as part of the two-stage construction process."
...
- Weitere URL: https://eurban.co.uk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The building also utilises Cross Laminated Timber floor slabs supplied by Eurban"

### GB:U25
- Name: Fabrix
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.fabrix.london/impact-and-news/urban-mining/
- Weitere URL: https://fabrix.co.uk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Betrieb_Nutzung / Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Shaping a more sustainable world has always been at the heart of what we do at Fabrix"

### GB:U26
- Name: FORE Partnership
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.theconstructionindex.co.uk/news/view/london-office-project-reuses-90-year-old-department-store-steel
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The deal to reuse steel from House of Fraser was conceived between Fore and its consultants, Civic Engineers"

### GB:U27
- Name: Four Bay Structures
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.willmottdixon.co.uk/now-or-never/case-studies/tower-bridge-court-sets-standard-for-reuse-of-building-materials
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Bauausfuehrung_Fertigung / Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Our supply chain partner, Four Bay Structures, took away, cleaned, tested, certified, prepared and then delivered all the reclaimed steel to site."

### GB:M11
- Name: Frome Reclamation Ltd
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.fromerec.co.uk/reclamation/about
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Frome Reclamation buy and sell traditional building materials and architectural antique items."

### GB:N03
- Name: futuREuse directory
- Land: GB
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://futureuse.co.uk/futureuse-directory/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "a comprehensive listing of reclamation yards and go-to salvage-friendly specialists across the UK & Ireland"
...
- Weitere URL: https://www.galldris.co.uk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We have since been awarded the infrastructure framework for this prestigious £7 billion development in North London"
...
- Weitere URL: https://www.gardiner.com/about-us
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Projektmanagement_Koordination / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Gardiner & Theobald (Project Manager – reclaimed steel initiative)"

### GB:X01
- Name: Globechain
- Land: GB
- Beleg-URL (MUSS geoeffnet werden): https://www.bluepatch.org/directory/globechain/
- Weitere URL: https://globechain.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Bildung_Wissenstransfer / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Our marketplace allows businesses to effortlessly manage and track their items, reduce costs, increase transparency and generate ESG data for your reporting."

### GB:O02
- Name: Granby Workshop
- Land: GB
- Typ (Altdaten, unbestaetigt): Organisation
- Beleg-URL (MUSS geoeffnet werden): https://granbyworkshop.co.uk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Entwurf_Planung / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Granby Workshop | Recycled Ceramic Tiles"

### GB:U30
- Name: Grants of Shoreditch
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.grantsint.com/stone-reuse-in-facade-construction/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Mick Denyer and Glenn Henson from Grants presented a practical approach to salvaging and reusing natural stone from existing building facades"
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "in partnership with waste reusage expert Cat Fletcher and her Freegle organisation, Mears Group housing and social care provider, Greater Brighton Metropolitan College"

### GB:U31
- Name: Grosvenor
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.grosvenor.com/property/uk-f346afcca4062fd904b22f82bec4831e/sustainability-e61a0d93d64824159703ac62da083e68
- Weitere URL: https://www.grosvenor.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Our resource responsibility aim fully integrates circular economy principles across our business to minimise the impact of our material use and disposal."

### GB:N04
- Name: Hastings & Bexhill Wood Recycling
- Land: GB
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Furniture Design: dRMM & Bexhill Wood Recycling"

### GB:O03
- Name: Hastings Pier Charity
- Land: GB
- Typ (Altdaten, unbestaetigt): Organisation
- Beleg-URL (MUSS geoeffnet werden): http://drmmstudio.com/project/hastings-pier/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber / Betrieb_Nutzung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Client: Hastings Pier Charity"

### GB:P8
- Name: Hastings Pier Visitor…
- Land: GB
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): http://drmmstudio.com/project/hastings-pier/
- Weitere URL: https://www.drmm.co.uk/project/hastings-pier/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The new visitor centre is built from cross laminated timber, clad in the timber decking that survived the 2010 fire."

### GB:U32
- Name: Hawkins\Brown
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.hawkinsbrown.com/sub-services/circular-economy/
- Weitere URL: https://www.hawkinsbrown.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "conceiving and delivering a number of recycled buildings, together with material passport data"
