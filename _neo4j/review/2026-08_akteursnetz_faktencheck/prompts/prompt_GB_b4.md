...
### GB:U33
- Name: Heyne Tillett Steel / HTS
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://hts.uk.com/research-innovation/stockmatcher/
- Weitere URL: https://hts.uk.com/practice/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis / Reuse_Zirkularitaetsberatung / Tragwerksplanung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Through development of this, we've highlighted the need and value of new tools to facilitate the circular economy within our industry."
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Sustainability: Hoare Lea"

### GB:P9
- Name: Holbein Gardens, London
- Land: GB
...
- Weitere URL: https://www.grosvenor.com/news-insights/some-of-uk%E2%80%99s-first-salvaged-steelwork-reused-in-holbein-gardens-retrofit
- Weitere URL: https://hts.uk.com/project/holbein-gardens
- Weitere URL: https://www.istructe.org/journal/volumes/volume-101-%282023%29/issue-3/holbein-gardens-low-carbon-reclaimed-steel
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "is one the first projects in the UK to reuse structural steelwork salvaged directly from a demolition site"
...
- Weitere URL: https://www.stiffandtrevillion.com/projects/tower-bridge-road
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "a job done by the Hybrid Structures division of specialist Hare, which also did the steelwork"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Architect IF_DO, working with London-based artist Lakwena, has created a multicoloured, permanent public artwork wrapped around a new electrical substation next to London's A406 North Circular Road"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "CLT Supplier: KLH"
...
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://ukgbc.org/resources/timber-square/
- Weitere URL: https://landsec.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Client: Landsec"

### GB:I01
- Name: London Borough of Barnet
- Land: GB
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://transformingbx.co.uk/vision/partnerships/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Oeffentliche_Hand_Foerderung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Brent Cross Town is being developed by Brent Cross South Limited Partnership, a joint venture between Barnet Council and property developer Related Argent which was set up in 2016 with the purpose of developing Brent Cross Town."

### GB:M12
- Name: London Reclaimed Brick Merchants
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.lrbm.com/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Reclaimed Bricks & Natural Stone Merchants"

### GB:M13
- Name: London Reclamation and Salvage Ltd
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.londonreclamation.net/about-us
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Our Peckham site is over 90 years old and deals with reclaimed timber and architectural salvage."
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Fabrix, the developer behind the £180m project, has appointed Mace as main contractor for the 430,000 sq ft office building"

### GB:M14
- Name: Material Index
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://material-index.co.uk/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Material Index is the UK's circular construction platform: a reclaimed materials marketplace, pre-demolition audit service and digital platform."

### GB:S01
- Name: Material Reuse Portal
- Land: GB
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://materialreuseportal.com/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The Material Reuse Portal is designed to bring together data on available materials from multiple sources."
...
- Weitere URL: https://www.mclarengroup.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Civic Engineers liaised with McLaren Construction, contractor on the House of Fraser refurbishment, to support the proposal."
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The original construction involved collaboration with several key organizations: Mears Group (housing and social care provider)"

### GB:U44
- Name: Method
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.methodltd.com/sustainability
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Projektmanagement_Koordination
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We can help guide in the transformation of your recycled materials into stunning surface finishes that will enhance your environment"

### GB:M15
- Name: Milton Keynes Antiques & Architectural Salvage
- Land: GB
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.mkantiquesandsalvage.co.uk/about
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We stock all types of old building materials and furniture."

### GB:U45
- Name: Morgan Sindall
- Land: GB
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.morgansindallconstruction.com/our-approach/responsible-business/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Material optimisation via the waste hierarchy – prevent waste, reuse, recycle, recover; pre-demolition audits to maximise reuse and recycling opportunities"
...
- Beleg-URL (MUSS geoeffnet werden): http://drmmstudio.com/project/hastings-pier/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Funding: Heritage Lottery Fund (£11.4 million grant)"
