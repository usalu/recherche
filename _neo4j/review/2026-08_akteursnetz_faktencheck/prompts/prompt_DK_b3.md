...
### DK:U23
- Name: NKR Demolition Group
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://royaldanishacademy.com/en/node/6345
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Jesper Nielsen (NKR Demolition)"
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Client: NREP"

### DK:M15
- Name: OKpriser.dk A/S
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://okpriser.dk/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "OKpriser.dk A/S er et af de ældste og mest velrenommerede virksomheder indenfor salg af genbrugsmaterialer."

### DK:U25
- Name: Orbicon
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://vandkunsten.com/en/projects/circle-house
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Engineer: Orbicon"

### DK:U26
- Name: P. Olesen / PO Genbrug
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://pogenbrug.dk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "P. Olesen genbrug – Salg af genbrugs byggematerialer"
...
### DK:U28
- Name: Pihlmann Architects
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://pihlmann.dk/info
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "selective dismantling, preservation, and reconfiguration expose latent potential in the overproduced and underestimated."

### DK:M16
- Name: PlusByg
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://affaldplus.dk/plusbyg-naestved
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Lige overfor Næstved Genbrugsplads ligger genbrugsbyggemarkedet PlusByg. Her finder du byggematerialer og værktøj men også større møbler og hus- og haveartikler."

### DK:U29
- Name: Realdania
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://realdania.dk/nyheder/2025/08/circue-lancerer-ny-digital-boers
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Realdania har støttet Circue-projektet og udviklingen af børsen"

### DK:P3
- Name: Resource Rows
- Land: DK
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://lendager.com/project/resource-rows/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Old facades from cement-mortar brick facades have been cut out and reassembled into new facade modules"

### DK:P2
- Name: Resource Rows
- Land: DK
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://circularmaterialsystems.com/en/case/02_en_resource-rows/
- Weitere URL: https://dac.dk/en/magazine/resource-rows
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "In an intensive cooperation between the client and the team of Lendager Group, Resource Rows proves that ... upcycling building materials is possible."

### DK:M17
- Name: Råt&Godt
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://raatoggodt.dk/om
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Materialerne kan også købes rå til dine egne byggeprojekter i Materialebanken."

### DK:N03
- Name: Røde Kors Byggegenbrug
- Land: DK
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://viborg.rodekors.dk/byggegenbrug/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi har åbnet et genbrugscenter i Viborg på Farvervej 23B. Formålet er dedikeret til at reducere affald og fremme bæredygtighed i byggebranchen."

### DK:U30
- Name: Sanderum-Otterup Murerforretning
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://fliser-tagsten.dk/brugte-fliser-2l/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi tilbyder også et stort udvalg af brugte fliser med et stort lager af brugte kvalitetsfliser."

### DK:F02
- Name: SBi (Statens Byggeforskningsinstitut), Aalborg University
- Land: DK
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.engineering.aau.dk/forskning/baeredygtige-fokusomrader/engineerings-ni-baeredygtighedsindsatser/genbrug-og-cirkulaer-okonomi
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Genanvendelse af plastic, byggematerialer og -komponenter"

### DK:U31
- Name: Skave Nedbrydning
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.dba.dk/shop/skave-nedbrydning
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi sælger vinduer, døre, tømmer, jern og andet muligt forekommende fra nedbrydninger."

### DK:P4
- Name: Svanen
- Land: DK
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.troldtekt.com/references/children-and-youth/boernehuset-svanen
- Weitere URL: https://lendager.com/project/the-swan
- Weitere URL: https://stateofgreen.com/en/solutions/a-swan-takes-shape
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "materials from the existing school are carefully dismantled, sorted, and stored before being reintroduced into the new architecture"

### DK:U32
- Name: Sweco / Sweco Architects
- Land: DK
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.danskindustri.dk/synligbeton.dk/projekter/byggeri/bornehuset-svanen/
- Weitere URL: https://www.sweco.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Entrepenoer: Ason (med SWECO som raadgivere)"

### DK:M18
- Name: Sydhavn Genbrugscenter
- Land: DK
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://affald.kk.dk/genbrug/sydhavn-genbrugscenter
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Alle vores møbler, lamper, byggematerialer m.m. er genstande, som er blevet indleveret af borgerne"

### DK:P5
- Name: Thoravej 29 Copenhagen
- Land: DK
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.hoffmann.dk/projekter/thoravej-29-fokus-paa-baeredygtighed/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Hoffmann skal renovere Bikubenfondens nyerhvervede bygning, ud fra et princip om at bygningen skal genanvende sig selv"
