...
- Beleg-URL (MUSS geoeffnet werden): https://www.asker.kommune.no/klima-og-miljo/ombruk/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Asker kommune jobber for å redusere avfall og forbruket av knappe naturressurser."

### NO:U01
- Name: Asplan Viak
- Land: NO
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Weitere URL: https://www.asplanviak.no/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Landscape Architect: Asplan Viak / Environmental Consultant: Asplan Viak AS"

### NO:P1
- Name: B-camp
- Land: NO
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://helenhard.no/work/b-camp/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The project repurposes discarded modules from an offshore accommodation barge to create affordable rental units."

### NO:U02
- Name: Bevar / Urban Reuse (NG Group)
- Land: NO
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.urbanreuse.ngnordic.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bevar builds the new with the old, offering consulting and specialist expertise in groundwork, demolition, and the construction of new steel and concrete structures within existing buildings"

### NO:I02
- Name: Bodø Kommune
- Land: NO
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://www.nordlandsforskning.no/prosjekter/2019/09/30/nb-project-cityloops
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "I Bodø er det sirkulering av ressursene på det militære flyplassområdet som er i fokus."

### NO:N01
- Name: byggogbevar directory
- Land: NO
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://byggogbevar.no/ombruk/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Råd og tips om regelverk, praktisk ombruk og ny bruk i eksisterende bygg"

### NO:N02
- Name: CCRI Pilot Asker
- Land: NO
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.asker.kommune.no/klima-og-natur/siste-nytt-om-klima-og-natur/tre-ar-med-sirkulare-fremskritt/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "I 2022 ble Asker kommune valgt som én av 12 piloter i EU-kommisjonens program European Circular Cities and Regions Initiative (CCRI)."

### NO:S01
- Name: Donorbygg
- Land: NO
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://donorbygg.no
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "synliggjør ombruksmaterialer for verdikjeden"
...
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Weitere URL: https://entra.no/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauherr_Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Developer: Entra"

### NO:M01
- Name: FornyBygg
- Land: NO
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://sites.google.com/fornybygg.no/ombruksglede/meny/om-oss
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "FornyBygg selger brukte byggevarer og overskuddsmaterialer gjennom vårt lager på Stjørdal, via facebook og her."

### NO:N03
- Name: FutureBuilt
- Land: NO
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/om-oss
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "sirkulære bygg og bydeler"

### NO:U04
- Name: Helen & Hard
- Land: NO
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://helenhard.no/work/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "150 apartments recycled from temporary dwelling modules"

### NO:U05
- Name: Insenti
- Land: NO
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://insenti.no/prosjekt/kristian-augusts-gate-13-ka13/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Projektmanagement_Koordination / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Insenti er engasjert av Entra som byggherrens representant med byggeledelse, prosjektledelse, prosjekteringsgruppeledelse, miljørådgiving og ombrukskoordinering."

### NO:M03
- Name: Iris Ombrukssentral / Saltnes ombruk
- Land: NO
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://iris-ombruksentral.no/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Vi vi gjør det enkelt å velge brukt når du skal bygge noe nytt."

### NO:U06
- Name: IWG Group / Spaces
- Land: NO
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Betrieb_Nutzung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Entra in close collaboration with IWG Group and their Spaces concept"

### NO:U07
- Name: JCS AS
- Land: NO
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.jcs-as.no/materialbank
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "MaterialBanken er eit konsept som fyst ble utvikla av Materialbanken for Bygningsvern i Vanse."
...
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Kristian Augusts gate relates to FutureBuilt's criteria for circular buildings."

### NO:S02
- Name: Loopfront
- Land: NO
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://www.loopfront.com/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Loopfront's digital platform makes it easy for companies to save costs, CO2 and waste by reusing furniture, building materials and more"

### NO:U08
- Name: MAD arkitekter / Mad as
- Land: NO
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Weitere URL: https://www.mad.no/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Architect: Mad"

### NO:M04
- Name: Materialbanken for bygningsvern
- Land: NO
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://materialbankenforbygningsvern.no/dette-er-materialbanken/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "I Materialbanken finner du alt fra gamle dører og vinduer, brukte takstein i alle varianter, stokker, gulvbord til pyntegjenstander!"
