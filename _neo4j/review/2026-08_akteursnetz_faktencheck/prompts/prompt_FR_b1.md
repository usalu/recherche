...
- Beleg-URL (MUSS geoeffnet werden): https://albert-and-co.fr/references/reemploi/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Mise en place et fabrication du mobilier urbain avec des matériaux récupérés de monuments"

### FR:M01
- Name: Allibert Matériaux Anciens
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.allibert-materiauxanciens.fr/fr/materiaux/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Large gammes de matériaux anciens pour extérieur ou intérieur de votre maison"

### FR:U02
- Name: Archipel zéro
- Land: FR
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://archipelzero.wixsite.com/archipelzero
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Architecture frugale - bois, paille, terre crue, réemploi"

### FR:M04
- Name: Articonnex
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://articonnex.com/
- Weitere URL: https://articonnex.com/collections/reemploi
- Weitere URL: https://www.jaimelesstartups.fr/articonnex-economie-circulaire-anti-gaspi-materieux-bricolage
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Seconde vie | Tous nos produits issus du réemploi"

### FR:N01
- Name: Association Réavie
- Land: FR
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://asso-reavie.fr/
- Weitere URL: https://opalis.eu/fr/fournisseurs/reavie
- Weitere URL: https://seinesaintdenis.fr/actualite/ecologie/transition-ecologique/ReaVie-lassociation-qui-donne-une-seconde-vie-aux-materiaux-du-BTP/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "tonnes de matériaux sauvées de la benne"

### FR:M07
- Name: Backacia
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://backacia.com/
- Weitere URL: https://opalis.eu/fr/fournisseurs/backacia
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "un bureau d'études économie circulaire et réemploi"

### FR:M08
- Name: Baignoires Anciennes
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://baignoires-anciennes.com/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "baignoires anciennes has begun supplying restored antique bathtubs to architects, designers, antique material merchants and the private sector"

### FR:U03
- Name: Barrault-Pressacco
- Land: FR
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://barraultpressacco.com/about
- Weitere URL: https://www.barrault-pressacco.com
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Objets trouvés, Culture and Forms of repurposing"

### FR:M09
- Name: Bathestia Recup
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://bathestia.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "réemploi, matériaux sains, locaux et biosourcés, frugalité. La matériauthèque, vous propose des matériaux à prix solidaires."

### FR:S01
- Name: BatRecup
- Land: FR
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://www.batrecup.com/
- Weitere URL: https://play.google.com/store/apps/details?id=com.batrecup
- Weitere URL: https://www.batrecup.com/batrecup-lappli-cest-parti
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "la plateforme communautaire pour le réemploi des matériaux"

### FR:M10
- Name: BCA Matériaux Anciens
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.bca-materiauxanciens.com/qui-sommes-nous/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "entreprise spécialisée dans le négoce de matériaux anciens en France et à l'international"
...
- Weitere URL: https://experimentationsurbaines.ademe.fr/blog/ressource/programmes-repar-1-et-2/
- Weitere URL: https://experimentationsurbaines.ademe.fr/blog/ressource/site-de-bellastock-expert-sur-le-reemploi-de-materiaux-de-construction/
- Weitere URL: https://www.bellastock.com/projets/opalis-france/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Entwurf_Planung / Forschung_Dokumentation / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bellastock et le CSTB en France, Bruxelles-Environnement, Belgian Building Research Institute (BBRI) et la Confédération de la Construction en Belgique, la School of Architecture and Design de l'Université de Brighton et l'opérateur britannique Salvo."

### FR:M11
- Name: BOBI Réemploi
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.bobi-reemploi.fr/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "spécialiste du réemploi des matériaux de la construction"

### FR:O01
- Name: Booster du Réemploi (A4MT)
- Land: FR
- Typ (Altdaten, unbestaetigt): Organisation
- Beleg-URL (MUSS geoeffnet werden): https://cd2e.com/domaines-dexpertise/economie-circulaire/booster-du-reemploi/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Nachhaltigkeitsberatung / Projektmanagement_Koordination / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "le CD2E et Action for Market Transformation – A4MT joignent leurs forces pour organiser un nouveau Booster du Réemploi local"

### FR:M13
- Name: Bourgogne Matériaux Anciens
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://opalis.eu/en/dealers/bourgogne-materiaux-anciens
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Created at the end of the 1980s, Bourgogne Matériaux Anciens is specialised in the sale of old building materials."

### FR:M14
- Name: Broc'Antique
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://opalis.eu/en/dealers/brocantique
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "inventory includes wooden joinery, ironwork, furniture, stones, paving, fireplaces, and distinctive architectural elements"

### FR:M15
- Name: Bâti Récup'
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://batirecup.com/a-propos/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Depuis sa création en 2016, Bâti Récup' s'est imposé comme un acteur clé du réemploi des matériaux de construction en Bretagne"

### FR:M16
- Name: Bâticycle
- Land: FR
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://baticycle.fr/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bâticycle est un magasin de matériaux et d'équipements de construction d'occasion pour les professionnels du bâtiment."

### FR:U04
- Name: Camping Design
- Land: FR
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://encoreheureux.org/en/projects/pavillon-circulaire
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "TRIBU (HQE) + BONNEFRITE (illustrations) + CAMPING DESIGN (graphisme)"

### FR:U05
- Name: CANCAN Architecture
- Land: FR
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.collectifcancan.fr/project/refair/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Assistance à Maitrise d'Ouvrage / Expert Réemploi"
