...
### CH:U04
- Name: aik Architektur + Ingenieur Kollektiv
- Land: CH
...
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Unbestimmt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Bauphysik (Building Physics): aik, Architektur + Ingenieur Kollektiv, Zürich"

### CH:U05
- Name: Amstein+Walthert AG
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://amstein-walthert.ch/de/blog/graue-energie-im-fokus-wie-die-kreislaufwirtschaft-das-bauen-verandert/
- Weitere URL: https://www.amstein-walthert.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): TGA_Gebaeudetechnik
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Kreislaufgerechte Bauplanung: Beratung und Planung nach Prinzipien des zirkulaeren Bauens - z.B. Entwicklung von Rueckbau- und Wiederverwendungskonzepten"

### CH:U06
- Name: Anima Engineering AG
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://anima.engineering/nachhaltigkeit
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Fachplanung_Nachweis
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Wir testen neue Materialen und stehen für den sinnvollen Umgang mit den Themen Kreislaufwirtschaft und ReUse ein."

### CH:M01
- Name: Archipel Sion Ressourcerie
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://archipelsion.ch/ressourcerie/inventaire/
- Weitere URL: https://archipelsion.ch/
- Weitere URL: https://archipelsion.ch/evenements/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Inventaire • L'archipel · Tiers-lieu · Sion"

### CH:U08
- Name: baubüro in situ
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://insitu.ch/themen
- Weitere URL: https://www.insitu.ch/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Zirkulation: Wir setzen Bauteile wieder ein."

### CH:M02
- Name: Baumatpool.ch
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.baumatpool.ch/de/
- Weitere URL: https://www.baumatpool.ch/de/content/impressum/
- Weitere URL: https://www.baumatpool.ch/de/content/faq/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Die Schweizer Materialbörse – Baumaterialien und Restposten einfach finden, kaufen und verkaufen."

### CH:M03
- Name: Bauteilbörse Basel
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://bauteilboerse-basel.ch/ueber-uns/
- Weitere URL: https://bauteilboerse-basel.ch/bauteile/
- Weitere URL: https://bauteilboerse-basel.ch/nachhaltigkeit/
- Weitere URL: https://bauteilboerse-basel.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Die demontierten Bauteile werden geprüft, gereinigt und aufbereitet. Im Anschluss gelangen sie in den Verkauf und somit wieder in den Nutzungskreislauf."

### CH:M04
- Name: Bauteilkatalog Immobilien Basel-Stadt
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://bauteile-ibs.ch/
- Weitere URL: https://bauteile-ibs.ch/info
- Weitere URL: https://bauteile-ibs.ch/components
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Forschung_Dokumentation / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Immobilien Basel-Stadt Bauteilkatalog zur Wiederverwendung"

### CH:M05
- Name: Bauteilladen Winterthur
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://bauteilladen.ch/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Börse für Secondhand Bauteile"

### CH:M06
- Name: Bauteilvermittlung Zürichsee-Oberland
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.btvz.ch/angebote/
- Weitere URL: https://www.btvz.ch/so-funktioniert-es/
- Weitere URL: https://www.btvz.ch/portraet/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Angebotene Bauteile"

### CH:M07
- Name: Bauteilverwertung Köppel & Klein
- Land: CH
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.bauteilverwertung.ch/
- Weitere URL: https://www.bauteilverwertung.ch/abbruch.html
- Weitere URL: https://www.bauteilverwertung.ch/verkauf.html
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Aus alt mach neu – Gebrauchte Bauteile und was daraus wieder gemacht wurde"

### CH:U09
- Name: Bischof Föhn Architektur
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://meter-magazin.ch/ch/architektur/19924-aus-wohnungen-wird-ein-kindergarten
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung / Projektmanagement_Koordination / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Mit dem Umbauprojekt wollten sie ein Pionierprojekt der Kreislaufwirtschaft schaffen. Der Einsatz von möglichst vielen Re-Use-Bauteilen war dabei entscheidend."

### CH:X01
- Name: Circular Construction Catalyst 2033
- Land: CH
- Beleg-URL (MUSS geoeffnet werden): https://www.circularconstructioncatalyst.ch/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "zirkuläres Bauen und Bewirtschaften im Hoch- und Tiefbau in der Schweiz bis 2033 als das „neue Normal" zu etablieren"

### CH:X02
- Name: Circular Economy Switzerland
- Land: CH
- Beleg-URL (MUSS geoeffnet werden): https://www.circular-economy-switzerland.ch/en
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "AKB | CES Circle Bern @ TecLab Burgdorf "Zirkuläres Weiterbauen""

### CH:F02
- Name: Circular Engineering for Architecture / ETH Zürich
- Land: CH
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://cea.ibi.ethz.ch/about_us.html
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "The Chair of Circular Engineering for Architecture (CEA) develops research on matching reused architectural materials & projects through digitalization for circularity."

### CH:N01
- Name: Cirkla
- Land: CH
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.cirkla.ch/en/
- Weitere URL: https://www.cirkla.ch/en/lassociation-cirkla/
- Weitere URL: https://www.cirkla.ch/en/le-reseau-du-reemploi/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bildung_Wissenstransfer / Forschung_Dokumentation / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Cirkla is the umbrella organization for the Swiss recycling industry. It brings together organizations, companies and private individuals to raise the profile of the reuse scene."

### CH:U11
- Name: Desso / Tarkett
- Land: CH
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.tarkett-group.com/en/climate-circular-economy/circular-economy/
- Weitere URL: https://www.tarkett.com/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Materiallieferung_Markt
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "It all starts with the collection of end-of-use flooring for recycling. Once sorted, these used floors are processed using unique technologies that separate the components and remove the adhesive."

### CH:S01
- Name: Digvis GmbH
- Land: CH
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://bauteile-ibs.ch/contact
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Programmierung: digvis GmbH Industriestrasse 59 8152 Glattbrugg"

### CH:P1
- Name: ELEMENTA Walkeweg
- Land: CH
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://www.bs.ch/medienmitteilungen/fd/2023-entwicklungsareal-walkeweg-kanton-baut-ueber-100-preisguenstige-wohnungen-unter-einsatz-von-wiederverwendeten-bauteilen
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Indem Bauteile aus rückgebauten kantonalen Liegenschaften wiederverwendet werden, wird sogenannte «graue Energie» eingespart"

### CH:P2
- Name: ELYS Kultur- und…
- Land: CH
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://zirkular.net/en/project/culture-commercial-center-elys
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "They received a lot of attention and were the trigger for the foundation of Zirkular by the involved planners."
