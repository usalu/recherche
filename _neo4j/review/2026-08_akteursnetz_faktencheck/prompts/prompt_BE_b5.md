...
### BE:P12
- Name: Plateforme Réemploi
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/plateforme-reemploi
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "a public platform for all actors involved in reuse"

### BE:O01
- Name: Pouvoir Organisateur Pluriel / POP
- Land: BE
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "asbl Pouvoir Organisateur Pluriel"

### BE:S02
- Name: Preuse
- Land: BE
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://preuse.nweurope.eu/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "PREUSE is an international research project that aims to help local and regional public authorities improve the management of their material resources and implement solutions within their territory to reclaim and reuse building materials."

### BE:M34
- Name: Recupan bvba
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): http://www.recupan.be/
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Aan- en verkoop van recuperatie dakpannen"

### BE:P13
- Name: Recypark Demets
- Land: BE
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/recypark-anderlecht
- Weitere URL: https://51n4e.com/projects/recypark
- Weitere URL: https://brusselsarchitectureprize.be/en/project/recypark-demets
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "51N4E, Witteveen&Bos and Rotor joined forces and won the competition with a project that focused on reusing an existing structure"
...
- Weitere URL: https://rotordb.org/en
- Weitere URL: https://rotordb.org/en/projects
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Bauausfuehrung_Fertigung / Entwurf_Planung / Fachplanung_Nachweis / Forschung_Dokumentation / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik
...
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://rotordc.com/
- Weitere URL: https://rotordc.com/blog/salvaging-by-rotordc-3/generale-banks-hq-brussels-72
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Aufbereitung_Refurbishment / Betrieb_Nutzung / Fachplanung_Nachweis / Materialbroker / Reuse-Marketplace-Betreiber / Materiallieferung_Markt / Reuse_Zirkularitaetsberatung / Rueckbau_Bauteilernte_Logistik / Software_Digitalisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "We are a Brussels-based cooperative that has been active since 2016 in the dismantling, processing and sale of reusable building materials and finishing elements"

### BE:N08
- Name: Sarajevo Green Design Foundation
- Land: BE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://sarajevogreendesign.com/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "GDC is showcasing reuse of historic sites and promotes methods to transform and revitalise historic buildings"

### BE:M36
- Name: Stadshout.be
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://belgiumisdesign.be/designers/stadshout
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "rescue city trees, destined to be cut down, and convert them into furniture instead of firewood"

### BE:I06
- Name: Stadt Kassel
- Land: BE
- Typ (Altdaten, unbestaetigt): Oeffentliche_Institution
- Beleg-URL (MUSS geoeffnet werden): https://baumab-kassel.de/impressum/
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Oeffentliche_Hand_Foerderung / Reuse_Zirkularitaetsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Gefördert durch: Stadt Kassel"

### BE:S03
- Name: Sundahus
- Land: BE
- Typ (Altdaten, unbestaetigt): Software_Tool_Anbieter
- Beleg-URL (MUSS geoeffnet werden): https://sundahus.se/byggprojekt/fastighetsagare/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "underlätta organisationers egna ambitioner om cirkularitet och återbruk"

### BE:U35
- Name: Taktyk
- Land: BE
- Typ (Altdaten, unbestaetigt): Unternehmen
- Beleg-URL (MUSS geoeffnet werden): https://www.architectura.be/fr/actualite/un-nouvel-ecrin-pour-le-musee-de-folklore-de-mouscron
- Alt-Rollen (Altdaten, NICHT als Beleg verwenden): Entwurf_Planung
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "L'équipe formée par V+ (architecture), Projectiles (architecture, muséographie), Taktyk (paysage), Greisch, Daidalos Peutz et Bureau Bouwtechniek (bureaux d'études)"

### BE:F05
- Name: Technische Universität München (TUM)
- Land: BE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.mission-networks.tum.de/en/circular-economy/home/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Reuporsing and resuse, deconstruction and urban mining"

### BE:N09
- Name: Tracimat vzw
- Land: BE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://www.tracimat.be/over-ons/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "materialen uit sloop en renovatie zo zuiver mogelijk vrijkomen. Zo kunnen ze maximaal en op hoogwaardige wijze worden hergebruikt of gerecycleerd."

### BE:N10
- Name: TWG Circular Construction and Buildings (CCRI)
- Land: BE
- Typ (Altdaten, unbestaetigt): NGO_Verband_Netzwerk
- Beleg-URL (MUSS geoeffnet werden): https://circular-cities-and-regions.ec.europa.eu/twg-circular-construction-and-buildings
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Thematic Working Group focuses on topics such as managing construction and demolition waste, facilitating markets for secondary materials"

### BE:F06
- Name: Universidade do Minho (UMinho)
- Land: BE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://www.dstsgps.com/press-room/news/grupo-dst-e-universidade-do-minho-com-novo-projeto-no-setor-da-construcao-2-en-us/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Rehabilitation of Construction in the Circular Economy"

### BE:F07
- Name: University of Twente
- Land: BE
- Typ (Altdaten, unbestaetigt): Forschung_Lehre
- Beleg-URL (MUSS geoeffnet werden): https://research.utwente.nl/en/publications/managing-circular-building-projects
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "exploring how information can be used to reduce, reuse and/or recycle building materials"

### BE:M37
- Name: Van Dijck
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): http://www.van-dijck.be
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "pavés de réemploi entiers, recyclés ou sciés"

### BE:M38
- Name: Van Huele
- Land: BE
- Typ (Altdaten, unbestaetigt): Materialhub_Bauteilboerse
- Beleg-URL (MUSS geoeffnet werden): https://www.vanhuele.be/
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "Al onze oude recuperatie bouwmaterialen zijn origine en authentiek: wij verkopen uitsluitend gerecupereerde bouwmaterialen uit afbraak"
...
- Eintragsart: BAUVORHABEN/OBJEKT (keine Organisation) -- siehe Regel P
- Beleg-URL (MUSS geoeffnet werden): https://brusselsarchitectureprize.be/en/project/esp-karreveld/
- Weitere URL: https://www.agwa.be/en/projects/1718_verbiest/201
- Weitere URL: https://www.agwa.be/en/projects/1619_TAKEDA/185
- Weitere URL: https://www.agwa.be/en/projects/1811_KARREVELD/212
- Gespeichertes Belegzitat (Nachweis-Schnipsel, KEINE Taetigkeitsbeschreibung): "AgwA paid particular attention to the circularity of the project, approaching the site and existing buildings as a bank of available materials."
