...
- Knoten B: Vlaamse Instelling voor Technologisch Onderzoek (VITO)  [Forschung/Lehre]
- Land: BE
- Belegstatus: GEPRUEFT
...
### BE:K083
- Kantenart: AKTEUR-AKTEUR
- Knoten A: CCRI Pilot Flanders  [NGO/Verband/Netzwerk]
- Knoten B: TWG Circular Construction and Buildings (CCRI)  [NGO/Verband/Netzwerk]
- Land: BE
- Belegstatus: UNGEPRUEFT
...
### BE:K084
- Kantenart: AKTEUR-AKTEUR
- Knoten A: CCRI Pilot Uppsala  [NGO/Verband/Netzwerk]
- Knoten B: TWG Circular Construction and Buildings (CCRI)  [NGO/Verband/Netzwerk]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://circular-cities-and-regions.ec.europa.eu/twg-circular-construction-and-buildings
- Bisherige Beschreibung (Altdaten, nur Hinweis): Pilot-Mitgliedschaft in der Thematic Working Group
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Pilots: Uppsala"

### BE:K085
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Groep Van Roey  [Unternehmen]
- Knoten B: Vrije Universiteit Brussel (VUB) – Architectural Engineering  [Forschung/Lehre]
- Land: BE
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauunternehmen/Koordinator im Circular-Retrofit-Lab-Projekt von VUB Architectural Engineering
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Algemeen aannemer Groep Van Roey leidde de coördinatie van het volledige project"

### BE:K086
- Kantenart: AKTEUR-AKTEUR
- Knoten A: OVAM (Openbare Vlaamse Afvalstoffenmaatschappij)  [Öffentliche Institution]
- Knoten B: Tracimat vzw  [NGO/Verband/Netzwerk]
- Land: BE
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
