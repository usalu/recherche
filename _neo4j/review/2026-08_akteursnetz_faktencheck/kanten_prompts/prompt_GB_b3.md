...
- Knoten B: Heyne Tillett Steel / HTS  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://asbp.org.uk/case-studies/holbein-gardens
- Bisherige Beschreibung (Altdaten, nur Hinweis): Tragwerksplaner von Holbein Gardens
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Engineers and consultants: TFT (Sustainability Consultant) HTS (Structural Engineer)"
...
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Holbein Gardens, London  [Bauvorhaben/Objekt]
- Knoten B: Eurban  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://asbp.org.uk/case-studies/holbein-gardens
- Bisherige Beschreibung (Altdaten, nur Hinweis): CLT-Materiallieferant fuer Holbein Gardens
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "The building also utilises Cross Laminated Timber floor slabs supplied by Eurban"

### GB:K044
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Holbein Gardens, London  [Bauvorhaben/Objekt]
- Knoten B: TFT Consultants  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://asbp.org.uk/case-studies/holbein-gardens
- Bisherige Beschreibung (Altdaten, nur Hinweis): Nachhaltigkeitsberater (Circular Economy) von Holbein Gardens
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Engineers and consultants: TFT (Sustainability Consultant)"

### GB:K045
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Holbein Gardens, London  [Bauvorhaben/Objekt]
- Knoten B: Blenheim House  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://asbp.org.uk/case-studies/holbein-gardens
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ausfuehrender Bauunternehmer von Holbein Gardens
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Contractor: Blenheim House"

### GB:K046
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Heyne Tillett Steel / HTS  [Unternehmen]
- Knoten B: Cleveland Steel & Tubes  [Unternehmen]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
### GB:K048
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Cleveland Steel & Tubes  [Unternehmen]
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Cleveland Steel & Tubes  [Unternehmen]
- Knoten B: Channel Projects  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Projektpartner im Reuse-Pilotprojekt 'ReFrame'
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "To realise the ReFrame project, Channel worked with Simple Works (structural engineer) and Cleveland Steel and Tubes (steel stockholder, client and fabricator)."
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Stahllieferant fuer Elliott-Wood-Projekt (Namensvariante 'Cleveland Steel Stock')
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Sourced from Cleveland Steel Stock, 4% of the steel is reclaimed, and 1% is recovered"

### GB:K052
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: House of Fraser  [Bauvorhaben/Objekt]
- Knoten B: FORE Partnership  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Entwickler, initiierte den Stahl-Reuse-Deal aus House of Fraser
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "The deal to reuse steel from House of Fraser was conceived between Fore and its consultants, Civic Engineers"

### GB:K053
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: House of Fraser  [Bauvorhaben/Objekt]
- Knoten B: Willmott Dixon  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Hauptauftragnehmer, integrierte den wiederverwendeten Stahl aus House of Fraser
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Collaboration between supply chain partners flagged the potential to reuse steel from the demolition of the House of Fraser building on Oxford Street"

### GB:K054
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: House of Fraser  [Bauvorhaben/Objekt]
- Knoten B: Stiff + Trevillion  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.stiffandtrevillion.com/projects/tower-bridge-court
- Bisherige Beschreibung (Altdaten, nur Hinweis): Architekt des Reuse-Projekts, eigene Projektseite nennt House of Fraser als Stahlquelle
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "20 tonnes of 1930s steel beams were salvaged from the former House of Fraser on Oxford Street and reused within TBC."

### GB:K055
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: House of Fraser  [Bauvorhaben/Objekt]
- Knoten B: ECE Architecture  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.willmottdixon.co.uk/now-or-never/case-studies/tower-bridge-court-sets-standard-for-reuse-of-building-materials
- Bisherige Beschreibung (Altdaten, nur Hinweis): Mitarchitekt, auf der Fallstudienseite des Reuse-Projekts genannt, aber ohne HoF-Bezug im selben Satz
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Designed by architects Stiff + Trevillion, and ECE, the building's energy performance is forecast to shift from EPC D to A rating."

### GB:K056
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: House of Fraser  [Bauvorhaben/Objekt]
- Knoten B: Webb Yates Engineers  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.theconstructionindex.co.uk/news/view/london-office-project-reuses-90-year-old-department-store-steel
- Bisherige Beschreibung (Altdaten, nur Hinweis): Tragwerksplaner fuer Nutzung des wiederverwendeten Materials
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Webb Yates, the engineer appointed to TBC London, ensured there was a smooth transition for using the recycled materials in the Thames-side design"

### GB:K057
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: House of Fraser  [Bauvorhaben/Objekt]
- Knoten B: Four Bay Structures  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.willmottdixon.co.uk/now-or-never/case-studies/tower-bridge-court-sets-standard-for-reuse-of-building-materials
- Bisherige Beschreibung (Altdaten, nur Hinweis): Aufbereitung und Logistik des wiederverwendeten Stahls
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Our supply chain partner, Four Bay Structures, took away, cleaned, tested, certified, prepared and then delivered all the reclaimed steel to site."

### GB:K058
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: House of Fraser  [Bauvorhaben/Objekt]
- Knoten B: McLaren Construction  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.theconstructionindex.co.uk/news/view/london-office-project-reuses-90-year-old-department-store-steel
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ausfuehrender Rueckbau-/Ausbaubetrieb am House-of-Fraser-Gebaeude, unterstuetzte den Reuse-Vorschlag
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Civic Engineers liaised with McLaren Construction, contractor on the House of Fraser refurbishment, to support the proposal."

### GB:K059
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: House of Fraser  [Bauvorhaben/Objekt]
- Knoten B: Civic Engineers  [Unternehmen]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: House of Fraser  [Bauvorhaben/Objekt]
- Knoten B: Studio PDP  [Unternehmen]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
