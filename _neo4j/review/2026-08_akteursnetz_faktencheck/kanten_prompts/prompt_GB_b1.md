...
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "CBRE (sustainability consultant)"

### GB:K002
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Gardiner & Theobald  [Unternehmen]
- Knoten B: BedZED  [Bauvorhaben/Objekt]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://en.wikipedia.org/wiki/BedZED
- Bisherige Beschreibung (Altdaten, nur Hinweis): Cost Consultant
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "led by the Peabody Trust in partnership with Bill Dunster Architects, Ellis & Moore Consulting Engineers, BioRegional, Arup and the cost consultants Gardiner and Theobald"
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://asbp.org.uk/case-studies/55-great-suffolk-street
- Bisherige Beschreibung (Altdaten, nur Hinweis): Project Manager (reclaimed steel initiative)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Gardiner & Theobald (Project Manager – reclaimed steel initiative)"

### GB:K004
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Cantillon  [Unternehmen]
- Knoten B: 55 Great Suffolk Street  [Bauvorhaben/Objekt]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://asbp.org.uk/case-studies/55-great-suffolk-street
- Bisherige Beschreibung (Altdaten, nur Hinweis): Demolition Contractor / Stahllieferant
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Fabrix purchased reclaimed steel from demolition contractor Cantillon"

### GB:K005
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Material Reuse Portal  [Software/Tool-Anbieter]
- Knoten B: Warp It
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://materialreuseportal.com/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Partnerlisting (Logo) auf S01-Seite, Warp It nennt Material Reuse Portal nicht
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Warp-it logo in partner carousel section ("The reuse ecosystem")"
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://materialreuseportal.com/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Partnerlisting (Logo) auf S01-Seite, Grosvenor nennt Material Reuse Portal nicht
- Gespeichertes Belegzitat (Nachweis-Schnipsel): ""Grosvenor re-use" logo in partner carousel section ("The reuse ecosystem")"

### GB:K007
- Kantenart: AKTEUR-AKTEUR
- Knoten A: SalvoWEB  [Materialhub/Bauteilbörse]
- Knoten B: Arc Reclamation Ltd  [Materialhub/Bauteilbörse]
- Land: GB
- Belegstatus: UNGEPRUEFT
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: SalvoWEB  [Materialhub/Bauteilbörse]
- Knoten B: Frome Reclamation Ltd  [Materialhub/Bauteilbörse]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: SalvoWEB  [Materialhub/Bauteilbörse]
- Knoten B: London Reclamation and Salvage Ltd  [Materialhub/Bauteilbörse]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: SalvoWEB  [Materialhub/Bauteilbörse]
- Knoten B: Milton Keynes Antiques & Architectural Salvage  [Materialhub/Bauteilbörse]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: SalvoWEB  [Materialhub/Bauteilbörse]
- Knoten B: Reclaimed World  [Materialhub/Bauteilbörse]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: SalvoWEB  [Materialhub/Bauteilbörse]
- Knoten B: Stax Reclamation  [Materialhub/Bauteilbörse]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: SalvoWEB  [Materialhub/Bauteilbörse]
- Knoten B: CS Architectural Salvage  [Materialhub/Bauteilbörse]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: SalvoWEB  [Materialhub/Bauteilbörse]
- Knoten B: Wells Reclamation  [Materialhub/Bauteilbörse]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: SalvoWEB  [Materialhub/Bauteilbörse]
- Knoten B: Wilsons Yard  [Materialhub/Bauteilbörse]
- Land: GB
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
### GB:K016
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: CascadeUp  [Bauvorhaben/Objekt]
- Knoten B: UCL Circular Economy Lab  [Forschung/Lehre]
- Land: GB
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): UCL Circular Economy Lab führt CascadeUp als eigenes Forschungspilotprojekt (Wiederverwendung von Abbruchholz zu Massivholzprodukten)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "The pilot, known as CascadeUp, brings our bio-based, circular economy research to life."

### GB:K017
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: CascadeUp  [Bauvorhaben/Objekt]
- Knoten B: UK CLT  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://ukclt.com/
- Bisherige Beschreibung (Altdaten, nur Hinweis): UK CLT liefert das aus wiedergewonnenem Holz gefertigte glulamST/CLST-Material für das CascadeUp-Pilotgebäude; Projekt auf UK CLTs eigener Seite als 'CascadeUp pilot' dargestellt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "This pilot modular building uses glulamST for its structural frame, and CLST as wall and floor panels."

### GB:K018
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Brent Cross Town…  [Bauvorhaben/Objekt]
- Knoten B: Brent Cross South Limited Partnership  [Organisation]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://transformingbx.co.uk/vision/partnerships/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Entwickler/Joint-Venture-Partner (Bauherr) fuer Brent Cross Town
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Brent Cross Town is being developed by Brent Cross South Limited Partnership, a joint venture between Barnet Council and property developer Related Argent"

### GB:K019
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Brent Cross Town…  [Bauvorhaben/Objekt]
- Knoten B: Related Argent  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://transformingbx.co.uk/vision/partnerships/
- Bisherige Beschreibung (Altdaten, nur Hinweis): JV-Partner/Entwickler (Related Argent) von Brent Cross Town
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Brent Cross Town is being developed by Brent Cross South Limited Partnership, a joint venture between Barnet Council and property developer Related Argent"

### GB:K020
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Brent Cross Town…  [Bauvorhaben/Objekt]
- Knoten B: London Borough of Barnet  [Öffentliche Institution]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://transformingbx.co.uk/vision/partnerships/
- Bisherige Beschreibung (Altdaten, nur Hinweis): JV-Partner (Barnet Council) von Brent Cross Town
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Brent Cross Town is being developed by Brent Cross South Limited Partnership, a joint venture between Barnet Council and property developer Related Argent"
