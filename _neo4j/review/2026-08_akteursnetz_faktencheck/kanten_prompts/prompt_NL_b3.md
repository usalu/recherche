...
- Knoten B: Van Dijk Maasland B.V.  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Construction partner for Montessori Maassluis
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Kraaijvanger Architects is collaborating on this project with ... IMd Raadgevende Ingenieurs, and Van Dijk Maasland B.V."

### NL:K042
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Montessori Maassluis  [Bauvorhaben/Objekt]
- Knoten B: A. de Jong Groep  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.kraaijvanger.nl/en/news/de-handtekeningen-zijn-gezet-montessorischool-maassluis
- Bisherige Beschreibung (Altdaten, nur Hinweis): Contractor partner for Montessori Maassluis
...
### NL:K043
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: People’s Pavilion…  [Bauvorhaben/Objekt]
- Knoten B: Dutch Design Foundation  [Organisation]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/en/peoplespavilion
- Bisherige Beschreibung (Altdaten, nur Hinweis): Auftraggeberin (Client) des Projekts People's Pavilion
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Client: Dutch Design Foundation"

### NL:K044
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: People’s Pavilion…  [Bauvorhaben/Objekt]
- Knoten B: Ham & Sybesma  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/en/peoplespavilion
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauausfuehrender des Projekts People's Pavilion
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Built by: Ham & Sybesma"

### NL:K045
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: People’s Pavilion…  [Bauvorhaben/Objekt]
- Knoten B: IJB groep  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/en/peoplespavilion
- Bisherige Beschreibung (Altdaten, nur Hinweis): Materialpartner (Dank-Abschnitt) des Projekts People's Pavilion
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "New Horizon, IJB groep, Stiho groep, Govaplast, Tetris, Elektroned, DEGO, Morssinkhof, Vitra & Keizersgrachtkerk"

### NL:K046
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: People’s Pavilion…  [Bauvorhaben/Objekt]
- Knoten B: Stiho group  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/en/peoplespavilion
- Bisherige Beschreibung (Altdaten, nur Hinweis): Materialpartner (Dank-Abschnitt) des Projekts People's Pavilion
...
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: People’s Pavilion…  [Bauvorhaben/Objekt]
- Knoten B: Overtreders W  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/en/peoplespavilion
- Bisherige Beschreibung (Altdaten, nur Hinweis): Overtreders W ist Mitentwerferin/Betreiberin des eigenen Projekts People's Pavilion
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Overtreders W and bureau SLA have accomplished this with a radical new approach: all of the materials needed to make the 250m2 building are borrowed."

### NL:K048
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: People’s Pavilion…  [Bauvorhaben/Objekt]
- Knoten B: bureau SLA  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/en/peoplespavilion
- Bisherige Beschreibung (Altdaten, nur Hinweis): bureau SLA ist Mitentwerfer (in cooperation with) des Projekts People's Pavilion
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "In cooperation with: bureau SLA"

### NL:K049
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: People’s Pavilion…  [Bauvorhaben/Objekt]
- Knoten B: New Horizon  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.overtreders-w.nl/en/peoplespavilion
- Bisherige Beschreibung (Altdaten, nur Hinweis): Materialpartner (Dank-Abschnitt) des Projekts People's Pavilion
...
- Knoten A: Stiho group  [Unternehmen]
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Stiho ist Partner im (von New Horizon getragenen) Urban Mining Collective
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Oogstbedrijf New Horizon Urban Mining en Stiho zijn partners in circulair"

### NL:K051
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: SUPERLOCAL Expogebouw  [Bauvorhaben/Objekt]
- Knoten B: HEEMwonen  [Organisation]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.superlocal.eu/superlocal/expogebouw/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Koordinator/Auftraggeber (Ambitie und uitgangspunten bewaakt)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "HEEMwonen, gemeente Kerkrade en IBA Parkstad hebben de ambitie en uitgangspunten van het concept bewaakt en gecoördineerd."

### NL:K052
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: SUPERLOCAL Expogebouw  [Bauvorhaben/Objekt]
- Knoten B: Gemeente Kerkrade  [Öffentliche Institution]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.superlocal.eu/superlocal/expogebouw/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Koordinator/Gemeente (Ambitie und uitgangspunten bewaakt)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "HEEMwonen, gemeente Kerkrade en IBA Parkstad hebben de ambitie en uitgangspunten van het concept bewaakt en gecoördineerd."

### NL:K053
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: SUPERLOCAL Expogebouw  [Bauvorhaben/Objekt]
- Knoten B: IBA Parkstad  [Organisation]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.superlocal.eu/superlocal/expogebouw/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Koordinator (Ambitie und uitgangspunten bewaakt)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "HEEMwonen, gemeente Kerkrade en IBA Parkstad hebben de ambitie en uitgangspunten van het concept bewaakt en gecoördineerd."

### NL:K054
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: SUPERLOCAL Expogebouw  [Bauvorhaben/Objekt]
- Knoten B: Maurer United  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.superlocal.eu/superlocal/expogebouw/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Architekt (Entwurf gebunden an wiederverwendbare Elemente)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "De architect Maurer United is in zijn ontwerp gebonden aan deze herbruikbare elementen in plaats van nieuwe onderdelen."

### NL:K055
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: SUPERLOCAL Expogebouw  [Bauvorhaben/Objekt]
- Knoten B: Volantis  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.superlocal.eu/superlocal/expogebouw/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Constructeur (bepaalt herbruikbare materialen/elementen)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Constructeur Volantis bepaalt welke materialen en elementen uit de flat herbruikbaar zijn."

### NL:K056
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: SUPERLOCAL Expogebouw  [Bauvorhaben/Objekt]
- Knoten B: Dusseldorp  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.superlocal.eu/superlocal/expogebouw/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Sloopbedrijf/Materiallieferant (oogst bouwmaterialen tijdens sloop)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Sloopbedrijf Dusseldorp is leverancier van de bouwmaterialen, die ze oogsten tijdens de sloop van de flat."

### NL:K057
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: SUPERLOCAL Expogebouw  [Bauvorhaben/Objekt]
- Knoten B: Bouwbedrijven Jongen  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.superlocal.eu/superlocal/expogebouw/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Aannemer (afhankelijk van staat/kwaliteit geoogste materialen)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "De aannemer, Bouwbedrijven Jongen was afhankelijk van de staat en kwaliteit van de geoogste materialen."

### NL:K058
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: SUPERLOCAL Expogebouw  [Bauvorhaben/Objekt]
- Knoten B: Zuyd Hogeschool  [Forschung/Lehre]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.kerkrade.nl/superlocal-bleijerheide
- Bisherige Beschreibung (Altdaten, nur Hinweis): Konsortialpartner der uebergeordneten SUPERLOCAR-Partnerschap (12 partijen)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "een partnerschap gevormd tussen 12 partijen: HEEMwonen, Dusseldorp infra, sloop en milieutechniek, Bouwbedrijven Jongen, WML, Waterschapsbedrijf Limburg, Zuyd Hogeschool"

### NL:K059
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: The Green House Utrecht  [Bauvorhaben/Objekt]
- Knoten B: Rijksvastgoedbedrijf / Central Government Real Estate Agency  [Öffentliche Institution]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.cepezed.com/projects/the-green-house/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauherr/Auftraggeber (primary client)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "primary client: rijksvastgoedbedrijf"

### NL:K060
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: The Green House Utrecht  [Bauvorhaben/Objekt]
- Knoten B: R Creators  [Unternehmen]
- Land: NL
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.cepezed.com/projects/the-green-house/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Vertraglicher Auftraggeber (Konsortium)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "contractual client: r creators (strukton, ballast nedam en facilicom)"
