...
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://re-win.ch/supporters/baubuero-in-situ-ag-und-zirkular-gmbh/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Mitinitiator/Supporter der RE-WIN-Kampagne
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Das Baubüro in situ hat zusammen mit der Zirkular GmbH die erste Fenster-Sammelaktion gestartet und den ersten LKW Transport in die Ukraine bezahlt."

### CH:K042
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Zirkular  [Unternehmen]
- Knoten B: Bauteilkatalog Immobilien Basel-Stadt  [Materialhub/Bauteilbörse]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://zirkular.net/de/projekt/bauteilkatalog-immobilien-basel-stadt/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ausfuehrende Bauteilkatalogisierung
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Im Rahmen der Projektwettbewerbe «Walkeweg» und «Schliengerweg» katalogisierte Zirkular die Re-Use-Bauteile"

### CH:K043
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: UMAR Unit  [Bauvorhaben/Objekt]
- Knoten B: Lindner SE  [Unternehmen]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.lindner-group.com/de/referenzen/nest-unit-umar
- Bisherige Beschreibung (Altdaten, nur Hinweis): Lindner realisierte als Projektpartner speziell entwickelte Plafotherm-Heiz-/Kuehldecken fuer die NEST-Unit UMAR.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Lindner realisierte dort speziell entwickelte Plafotherm® Heiz-/Kühldecken."

### CH:K044
- Kantenart: AKTEUR-AKTEUR
- Knoten A: ZHAW  [Forschung/Lehre]
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): ZHAW (IKE) als gemeinsam forschender Projektpartner des FHNW-INEB-Leitfadenprojekts genannt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Zwei Institute - INEB der FHNW und IKE der ZHAW - untersuchen im Rahmen eines Projekts die Wiederverwendung."

### CH:K045
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: ELEMENTA Walkeweg  [Bauvorhaben/Objekt]
- Knoten B: Monotti Ingegneri  [Unternehmen]
- Land: CH
- Belegstatus: UNGEPRUEFT
...
### CH:K046
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Digvis GmbH  [Software/Tool-Anbieter]
- Knoten B: Bauteilkatalog Immobilien Basel-Stadt  [Materialhub/Bauteilbörse]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://bauteile-ibs.ch/contact
- Bisherige Beschreibung (Altdaten, nur Hinweis): Programmierung des Bauteilkatalogs
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Programmierung: digvis GmbH Industriestrasse 59 8152 Glattbrugg"
