...
- Knoten A: Resource Rows  [Bauvorhaben/Objekt]
- Knoten B: Lendager  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://circularmaterialsystems.com/en/case/02_en_resource-rows/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Lendager Group als Entwurfs-/Upcycling-Team von Resource Rows
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "In an intensive cooperation between the client and the team of Lendager Group, Resource Rows proves that ... upcycling ... is possible."

### DK:K002
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Svanen  [Bauvorhaben/Objekt]
- Knoten B: Gladsaxe Kommune / Gladsaxe Municipality  [Öffentliche Institution]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.troldtekt.com/references/children-and-youth/boernehuset-svanen
- Bisherige Beschreibung (Altdaten, nur Hinweis): Gladsaxe Kommune ist Bauherr des Svanen-Projekts
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Builder: Gladsaxe Kommune Ejendomscenteret"

### DK:K003
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Svanen  [Bauvorhaben/Objekt]
- Knoten B: Sweco / Sweco Architects  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.danskindustri.dk/synligbeton.dk/projekter/byggeri/bornehuset-svanen/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Sweco als Berater des Entreprenoers Ason bei Svanen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Entrepenoer: Ason (med SWECO som raadgivere)"

### DK:K004
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Svanen  [Bauvorhaben/Objekt]
- Knoten B: NIRAS  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.danskindustri.dk/synligbeton.dk/projekter/byggeri/bornehuset-svanen/
- Bisherige Beschreibung (Altdaten, nur Hinweis): NIRAS als Abbruch-/Umweltberater von Svanen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "NIRAS har forestaaet raadgivning for nedrivningen af den gamle skole og for miljoekortlaegningen"

### DK:K005
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Svanen  [Bauvorhaben/Objekt]
- Knoten B: Tscherning  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://vaerdibyg.dk/case/svanen-i-gladsaxe-cirkulaer-nedrivning/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Tscherning als Abbruchunternehmer von Svanen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "For entreprenoeren Tscherning har udfordringen vaeret, at man normalt kan nedrive meget med maskine"

### DK:K006
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Svanen  [Bauvorhaben/Objekt]
- Knoten B: Ason A/S  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.danskindustri.dk/synligbeton.dk/projekter/byggeri/bornehuset-svanen/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ason als Hauptentreprenoer von Svanen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Entrepenoer: Ason (med SWECO som raadgivere)"

### DK:K007
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Svanen  [Bauvorhaben/Objekt]
- Knoten B: Aksel V. Jensen A/S  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.avj.dk/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Nur Referenzlisten-Nennung auf eigener AVJ-Seite, keine ausformulierte Rollenbeschreibung (Projektunterseite 404)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Boernehuset Svanen"
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.troldtekt.com/references/children-and-youth/boernehuset-svanen
- Bisherige Beschreibung (Altdaten, nur Hinweis): Lendager als Architekt von Svanen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Architects: Lendager Arkitekter ApS / SWECO architects"

### DK:K009
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Gladsaxe Kommune / Gladsaxe Municipality  [Öffentliche Institution]
- Knoten B: Aarhus Kommune  [Öffentliche Institution]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.erhvervsby.dk/byggegruppen/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Gemeinsame Projektpartner im BygCirkulaert-Portalprojekt (Verzeichnis fuer gebrauchte Bauteile)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Projektpartnerne er Gladsaxe Kommune og Gladsaxe Erhvervsby ... Aarhus Kommune, WeBuildDenmark, Pihl Holdings og Danske Regioner"

### DK:K010
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Tscherning  [Unternehmen]
- Knoten B: GreenDozer ApS  [Software/Tool-Anbieter]
- Land: DK
- Belegstatus: UNGEPRUEFT
...
### DK:K011
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Thoravej 29 Copenhagen  [Bauvorhaben/Objekt]
- Knoten B: Hoffmann A/S  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.hoffmann.dk/projekter/thoravej-29-fokus-paa-baeredygtighed/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Totalentreprenoer/Bauausfuehrender fuer das Projekt Thoravej 29
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Hoffmann har sammen med Pihlmann Architects og ABC Rådgivende Ingeniører vundet totalentreprisen på udviklingen af Bikubenfondens nyerhvervede bygning."

### DK:K012
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Thoravej 29 Copenhagen  [Bauvorhaben/Objekt]
- Knoten B: DTU  [Forschung/Lehre]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://dac.dk/en/magazine/places/thoravej-29-what-can-be-reused-must-be-reused-376
- Bisherige Beschreibung (Altdaten, nur Hinweis): DTU erstellte Analysebericht (CO2-Einsparung) zum Projekt Thoravej 29
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "A report from the Technical University of Denmark (DTU) on the Thoravej 29 project shows that compared to constructing an entirely new building, CO2 emissions"

### DK:K013
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: TRÆ High-Rise  [Bauvorhaben/Objekt]
- Knoten B: Kilden & Hindby  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://lendager.com/project/trae
- Bisherige Beschreibung (Altdaten, nur Hinweis): Kilden & Hindby als Bauherr/Client von TRAE
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Client Kilden & Hindby [and] PFA Ejendomme"

### DK:K014
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: TRÆ High-Rise  [Bauvorhaben/Objekt]
- Knoten B: PFA Ejendomme  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://lendager.com/project/trae
- Bisherige Beschreibung (Altdaten, nur Hinweis): PFA Ejendomme als Bauherr/Client von TRAE
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Client Kilden & Hindby [and] PFA Ejendomme"

### DK:K015
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: TRÆ High-Rise  [Bauvorhaben/Objekt]
- Knoten B: a:gain  [Unternehmen]
- Land: DK
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: TRÆ High-Rise  [Bauvorhaben/Objekt]
- Knoten B: DOVISTA / KRONE  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://dovista.com/krone-brandcase
- Bisherige Beschreibung (Altdaten, nur Hinweis): DOVISTA/KRONE als Fensterlieferant (Upcycling-Fenster) fuer TRAE
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "KRONE supplied all the windows to the building, including the upcycled windows."

### DK:K017
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: TRÆ High-Rise  [Bauvorhaben/Objekt]
- Knoten B: Artelia  [Unternehmen]
- Land: DK
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://lendager.com/project/trae
- Bisherige Beschreibung (Altdaten, nur Hinweis): Lendager als Entwurfsteam von TRAE, dokumentiert auf eigener Projektseite
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "TRAE ... a 78-meter beacon of circular construction, showing that large-scale architecture can combine reused materials"

### DK:K019
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: a:gain  [Unternehmen]
- Knoten B: Upcycle Studios Copenhag…  [Bauvorhaben/Objekt]
- Land: DK
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.again.dk/project-references/upcycle-studios
- Bisherige Beschreibung (Altdaten, nur Hinweis): Projektreferenz auf a:gains eigener Seite (Reference-Liste); konkrete Lieferrolle nicht spezifiziert
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "In Upcycle Studios, 75% of the windows came from public housing in North Jutland"

### DK:K020
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Upcycle Studios Copenhag…  [Bauvorhaben/Objekt]
- Knoten B: NREP  [Unternehmen]
- Land: DK
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): NREP als Bauherr/Bygherre von Upcycle Studios (bestaetigt zusaetzlich durch danskeark.com Projektcredits: Client NREP)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "NREP og Arkitektgruppen har netop taget første spadestik på endnu et byggeri i Ørestad Syd, nemlig byggeriet af 20 rækkehuse under navnet Upcycle Studios."
