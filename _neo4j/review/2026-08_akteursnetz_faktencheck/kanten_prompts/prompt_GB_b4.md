...
- Knoten A: Webb Yates Engineers  [Unternehmen]
...
### GB:K062
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Civic Engineers  [Unternehmen]
- Knoten B: Studio PDP  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://studiopdp.com/blog/permission-granted-318-oxford-street
- Bisherige Beschreibung (Altdaten, nur Hinweis): Projektteam-Credit auf Studio PDPs eigener Projektseite zu 318 Oxford Street: Civic Engineers als Structural and Facade Engineer gelistet, Studio PDP als Architekt/Autor der Seite.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Structural and Facade Engineer: Civic Engineers"
...
- Knoten A: BedZED  [Bauvorhaben/Objekt]
- Knoten B: BioRegional  [NGO/Verband/Netzwerk]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://en.wikipedia.org/wiki/BedZED
- Bisherige Beschreibung (Altdaten, nur Hinweis): Initiator / Nachhaltigkeitsberatung
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "led by the Peabody Trust in partnership with Bill Dunster Architects, Ellis & Moore Consulting Engineers, BioRegional, Arup"

### GB:K065
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: BedZED  [Bauvorhaben/Objekt]
- Knoten B: Peabody Trust  [Organisation]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://en.wikipedia.org/wiki/BedZED
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauherr/Entwickler
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "The project was led by the Peabody Trust in partnership with Bill Dunster Architects"

### GB:K066
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: BedZED  [Bauvorhaben/Objekt]
- Knoten B: Bill Dunster / ZEDfactory  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://en.wikipedia.org/wiki/BedZED
- Bisherige Beschreibung (Altdaten, nur Hinweis): Architect
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "in partnership with Bill Dunster Architects, Ellis & Moore Consulting Engineers, BioRegional, Arup"

### GB:K067
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: BedZED  [Bauvorhaben/Objekt]
- Knoten B: Ellis & Moore Consulting Engineers  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://en.wikipedia.org/wiki/BedZED
- Bisherige Beschreibung (Altdaten, nur Hinweis): Consulting/Structural Engineer
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Ellis & Moore Consulting Engineers, BioRegional, Arup and the cost consultants Gardiner and Theobald"

### GB:K068
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: PLP London HQ circular…  [Bauvorhaben/Objekt]
- Knoten B: Method  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://plparchitecture.com/plp-architecture-circular-studio-fit-out/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Contractor am PLP Circular Studio Fit-Out
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Contractor Method"

### GB:K069
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: PLP London HQ circular…  [Bauvorhaben/Objekt]
- Knoten B: Contrax Furniture  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://plparchitecture.com/plp-architecture-circular-studio-fit-out/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Joinery am PLP Circular Studio Fit-Out
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Joinery Contrax Furniture"

### GB:K070
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: PLP London HQ circular…  [Bauvorhaben/Objekt]
- Knoten B: Solus  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://plparchitecture.com/plp-architecture-circular-studio-fit-out/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Terrazzo-Lieferant am PLP Circular Studio Fit-Out
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Terrazzo Feature Solus"

### GB:K071
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: PLP London HQ circular…  [Bauvorhaben/Objekt]
- Knoten B: Grants of Shoreditch  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://plparchitecture.com/plp-architecture-circular-studio-fit-out/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Lieferant Reclaimed Marble am PLP Circular Studio Fit-Out
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Reclaimed Marble Grants of Shoreditch"

### GB:K072
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Method  [Unternehmen]
- Knoten B: PLP Architecture  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://plparchitecture.com/plp-architecture-circular-studio-fit-out/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Contractor (PLP-eigene Projektseite, Team-Credits)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Contractor Method"

### GB:K073
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Contrax Furniture  [Unternehmen]
- Knoten B: PLP Architecture  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://plparchitecture.com/plp-architecture-circular-studio-fit-out/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Joinery-Partner (PLP-eigene Projektseite, Team-Credits)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Joinery Contrax Furniture"

### GB:K074
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Solus  [Unternehmen]
- Knoten B: PLP Architecture  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://plparchitecture.com/plp-architecture-circular-studio-fit-out/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Terrazzo-Lieferant (PLP-eigene Projektseite, Team-Credits)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Terrazzo Feature Solus"

### GB:K075
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Grants of Shoreditch  [Unternehmen]
- Knoten B: PLP Architecture  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://plparchitecture.com/plp-architecture-circular-studio-fit-out/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Lieferant Reclaimed Marble (PLP-eigene Projektseite, Team-Credits)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Reclaimed Marble Grants of Shoreditch"

### GB:K076
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Roots in the Sky  [Bauvorhaben/Objekt]
- Knoten B: Studio RHE  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Entwurf_Planung (Planungsphase, vor Uebergabe an Sheppard Robson)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Studio RHE took the project through the planning phase before Sheppard Robson took over delivery"

### GB:K077
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Roots in the Sky  [Bauvorhaben/Objekt]
- Knoten B: Sheppard Robson  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.architectsjournal.co.uk/news/developer-urban-mines-broadgate-steel-frame-for-southwark-retrofits
- Bisherige Beschreibung (Altdaten, nur Hinweis): Entwurf_Planung (ausfuehrender Architekt)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Sheppard Robson is delivering this 'radical reimagining' of the former Blackfriars Crown Court"

### GB:K078
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Roots in the Sky  [Bauvorhaben/Objekt]
- Knoten B: AKT II  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.architectsjournal.co.uk/news/developer-urban-mines-broadgate-steel-frame-for-southwark-retrofits
- Bisherige Beschreibung (Altdaten, nur Hinweis): Fachplanung/Tragwerksberatung (Kollaboration im Projektteam)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "collaboration from AKT II, Gardiner & Theobald and Atelier Ten"

### GB:K079
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Roots in the Sky  [Bauvorhaben/Objekt]
- Knoten B: Symmetrys  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://symmetrys.com/project/roots-in-the-sky
- Bisherige Beschreibung (Altdaten, nur Hinweis): Tragwerksplanung/Reuse-Beratung (eigene Projektseite)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Symmetrys introduced a lightweight hybrid steel and CLT frame"

### GB:K080
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Roots in the Sky  [Bauvorhaben/Objekt]
- Knoten B: Mace  [Unternehmen]
- Land: GB
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauausfuehrung (Hauptauftragnehmer)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Fabrix, the developer behind the £180m project, has appointed Mace as main contractor for the 430,000 sq ft office building"
