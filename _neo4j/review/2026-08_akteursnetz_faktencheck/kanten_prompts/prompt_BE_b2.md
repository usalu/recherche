...
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Commissioner: Immobel"

### BE:K022
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Musée de Folklore Vie…  [Bauvorhaben/Objekt]
- Knoten B: Ville de Mouscron  [Öffentliche Institution]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://cellule.archi/fr/integration-oeuvres-art/musee-du-folklore-de-mouscron
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ville de Mouscron ist als Maître d'ouvrage (Bauherr) des Musée-du-Folklore-Projekts benannt.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Maître d'ouvrage / Ville de Mouscron"

### BE:K023
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Musée de Folklore Vie…  [Bauvorhaben/Objekt]
- Knoten B: Bureau Bouwtechniek  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bureau Bouwtechniek ist als Ingenieurbuero (bureau d'études) im Planungsteam des Musée-du-Folklore-Projekts genannt.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "L'équipe formée par V+ (architecture), Projectiles (architecture, muséographie), Taktyk (paysage), Greisch, Daidalos Peutz et Bureau Bouwtechniek (bureaux d'études)"

### BE:K024
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Musée de Folklore Vie…  [Bauvorhaben/Objekt]
- Knoten B: Greisch  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.architectura.be/fr/actualite/un-nouvel-ecrin-pour-le-musee-de-folklore-de-mouscron
- Bisherige Beschreibung (Altdaten, nur Hinweis): Greisch ist als Ingenieurbuero (bureau d'études) im Planungsteam des Musée-du-Folklore-Projekts genannt.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "L'équipe formée par V+ (architecture), Projectiles (architecture, muséographie), Taktyk (paysage), Greisch, Daidalos Peutz et Bureau Bouwtechniek (bureaux d'études)"

### BE:K025
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Musée de Folklore Vie…  [Bauvorhaben/Objekt]
- Knoten B: Taktyk  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.architectura.be/fr/actualite/un-nouvel-ecrin-pour-le-musee-de-folklore-de-mouscron
- Bisherige Beschreibung (Altdaten, nur Hinweis): Taktyk ist als Landschaftsplaner (paysage) im Planungsteam des Musée-du-Folklore-Projekts genannt.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "L'équipe formée par V+ (architecture), Projectiles (architecture, muséographie), Taktyk (paysage), Greisch, Daidalos Peutz et Bureau Bouwtechniek (bureaux d'études)"

### BE:K026
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Greisch  [Unternehmen]
- Knoten B: Recypark Demets  [Bauvorhaben/Objekt]
- Land: BE
- Belegstatus: UNGEPRUEFT
...
### BE:K027
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Recypark Demets  [Bauvorhaben/Objekt]
- Knoten B: 51N4E  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/recypark-anderlecht
- Bisherige Beschreibung (Altdaten, nur Hinweis): Wettbewerbsgewinner-Team
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "51N4E, Witteveen&Bos and Rotor joined forces and won the competition with a project that focused on reusing an existing structure"
...
### BE:K029
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: OXY Centre Monnaie  [Bauvorhaben/Objekt]
- Knoten B: Rotor  [NGO/Verband/Netzwerk]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/oxy-centre-monnaie
- Bisherige Beschreibung (Altdaten, nur Hinweis): Beratungspartner
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Rotor was asked to join the project team to help define a circular approach to the project, integrate reuse principles"
...
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/news/works-oxy-well-underway
- Bisherige Beschreibung (Altdaten, nur Hinweis): Materialaufbereitung
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "300 running meters of original aluminium facade profiles which will be reconverted to lighting fixtures by RotorDC"

### BE:K031
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Verbiest + Karreveld  [Bauvorhaben/Objekt]
- Knoten B: AgwA  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.jzh.be/karreveld/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Entwurfsarchitekt des Reuse-Projekts
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Le projet d'AgwA repose sur une analyse approfondie de la situation actuelle"

### BE:K032
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Verbiest + Karreveld  [Bauvorhaben/Objekt]
- Knoten B: Evelia Macal  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.agwa.be/en/projects/1718_verbiest/201/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Mitglied Design-Team (Verbiest)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "AgwA + Evelia Macal"
...
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Verbiest + Karreveld  [Bauvorhaben/Objekt]
- Knoten B: Kahle Acoustics  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): http://www.agwa.be/en/projects/1811_KARREVELD/212/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Akustik-Consultant des Projekts
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "JZH&Partners, Kahle acoustics, Denis Dujardin"

### BE:K035
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Verbiest + Karreveld  [Bauvorhaben/Objekt]
- Knoten B: Denis Dujardin  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): http://www.agwa.be/en/projects/1811_KARREVELD/212/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Landschaftsarchitekt des Projekts
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "JZH&Partners, Kahle acoustics, Denis Dujardin"
...
### BE:K037
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Zinneke  [Bauvorhaben/Objekt]
- Knoten B: Zinneke asbl  [NGO/Verband/Netzwerk]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/zinneke-feder-masui4ever
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauherr/Initiator
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "In 2015, Zinneke invited Rotor to join the long-term project for the renovation of their 4.000 m² new facilities at Place Masui."

### BE:K038
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Zinneke  [Bauvorhaben/Objekt]
- Knoten B: Matriciel  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/zinneke-feder-masui4ever
- Bisherige Beschreibung (Altdaten, nur Hinweis): Fachplaner
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "In 2016, Ouest architecture and Matriciel were selected to join the project."

### BE:K039
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Zinneke  [Bauvorhaben/Objekt]
- Knoten B: De Coninck  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/zinneke-feder-masui4ever
- Bisherige Beschreibung (Altdaten, nur Hinweis): Contractor
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Contractors: De Coninck, Brudex."

### BE:K040
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Zinneke  [Bauvorhaben/Objekt]
- Knoten B: Brudex  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/zinneke-feder-masui4ever
- Bisherige Beschreibung (Altdaten, nur Hinweis): Contractor
