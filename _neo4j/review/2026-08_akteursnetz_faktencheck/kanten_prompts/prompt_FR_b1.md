...
- Knoten A: Bâticycle  [Materialhub/Bauteilbörse]
- Knoten B: Skop Marketplace  [Materialhub/Bauteilbörse]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://marketplace.skop.app/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bâticycle als gelisteter Verkäufer/Vendor auf Skops Marketplace
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "magasin de réemploi des matériaux de second œuvre"

### FR:K002
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Cycle Up  [Materialhub/Bauteilbörse]
- Knoten B: Institut National de l'Économie Circulaire (INEC)  [NGO/Verband/Netzwerk]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://institut-economie-circulaire.fr/evenement-construction-circulaire-paris/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Cycle Up nimmt als Projekttraeger/Pitch-Teilnehmer an einer von INEC organisierten Veranstaltung zu réemploi/commande publique circulaire teil
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "CYCLE UP représenté par Hugo Bonnet, Directeur Général et Associé"

### FR:K003
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Cycle Up  [Materialhub/Bauteilbörse]
- Knoten B: MAISON CARRELLE  [Materialhub/Bauteilbörse]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://site.cycle-up.fr/maison-carrelle/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Maison Carrelle ist annonceur-partenaire (Werbe-/Handelspartner) auf Cycle Ups Marktplatz
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Maison Carrelle – partenaire annonceur de Cycle Up"

### FR:K004
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Cycle Up  [Materialhub/Bauteilbörse]
- Knoten B: METAMO  [Materialhub/Bauteilbörse]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://site.cycle-up.fr/annonceurs-partenaires/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Metamo in Cycle Ups Partner-/Anbieterverzeichnis 'Nos annonceurs partenaires' gelistet
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "METAMO - Réemploi et l'upcycling d'éléments métalliques à destination du BTP et des collectivités locales"

### FR:K005
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Cycle Up  [Materialhub/Bauteilbörse]
- Knoten B: MOBIOUS  [Materialhub/Bauteilbörse]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://site.cycle-up.fr/annonceurs-partenaires/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Mobious in Cycle Ups Partner-/Anbieterverzeichnis 'Nos annonceurs partenaires' gelistet
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "MOBIOUS - Artisan du bois et de l'acier, propose des lignes de mobiliers contemporaines et intemporelles à base de matériaux réutilisés"

### FR:K006
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Cycle Up  [Materialhub/Bauteilbörse]
- Knoten B: ORAK  [Materialhub/Bauteilbörse]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://site.cycle-up.fr/annonceur-plus-orak/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Orak steht in dokumentiertem partenariat mit Cycle Up fuer Textilboden-Reuse-Loesung
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Aujourd'hui Orak propose, en partenariat avec Cycle Up, une solution globale pour dalles textiles neuves ou réemployées"

### FR:K007
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Cycle Up  [Materialhub/Bauteilbörse]
- Knoten B: PROCLUS  [Materialhub/Bauteilbörse]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://site.cycle-up.fr/annonceurs-partenaires/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Proclus in Cycle Ups Partner-/Anbieterverzeichnis 'Nos annonceurs partenaires' gelistet
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "PROCLUS - Spécialiste des équipements électriques techniques du bâtiment 100% reconditionnés et garantis"

### FR:K008
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Cycle Up  [Materialhub/Bauteilbörse]
- Knoten B: TEXTIFLOOR  [Materialhub/Bauteilbörse]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://site.cycle-up.fr/textifloor-annonceurplus/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Dokumentierter partenariat Cycle Up x Textifloor zur Verbesserung der Wertschoepfungskette bei Bodenbelag-Reuse
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "le partenariat Cycle Up X Textifloor a pour objectif de contribuer à l'amélioration de la chaine de valeur"

### FR:K009
- Kantenart: AKTEUR-AKTEUR
- Knoten A: RAEDIFICARE
- Knoten B: CSTB  [Forschung/Lehre]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://raedificare.com/amo/
- Bisherige Beschreibung (Altdaten, nur Hinweis): RAEDIFICARE uebermittelt PEMD-Diagnosedaten automatisiert an die CSTB-Plattform
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "transmission automatisée du Cerfa N°16287*01 sur la plateforme du CSTB"

### FR:K010
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Réempro  [Materialhub/Bauteilbörse]
- Knoten B: CD2E  [NGO/Verband/Netzwerk]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://cd2e.com/portraits-adherents/reempro-cd2e-portraits-adherents/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Réempro ist Mitglied (adhérent) von CD2E, eigenes Portraet auf cd2e.com
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Grâce à la notoriété du CD2E, nous avons pu bénéficier d'un grand réseau d'acteurs du réemploi et ainsi améliorer notre expertise sur le sujet."

### FR:K011
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Circular Pavilion Paris  [Bauvorhaben/Objekt]
- Knoten B: TRIBU  [Unternehmen]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://encoreheureux.org/en/projects/pavillon-circulaire
- Bisherige Beschreibung (Altdaten, nur Hinweis): TRIBU als HQE-Ingenieurbuero im Team-Credit von Pavillon Circulaire genannt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "ENCORE HEUREUX ARCHITECTES (mandataires) + TRIBU (HQE)"

### FR:K012
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Circular Pavilion Paris  [Bauvorhaben/Objekt]
- Knoten B: Camping Design  [Unternehmen]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://encoreheureux.org/en/projects/pavillon-circulaire
- Bisherige Beschreibung (Altdaten, nur Hinweis): Camping Design als Grafikdesign ('graphisme') im Team-Credit von Pavillon Circulaire genannt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "TRIBU (HQE) + BONNEFRITE (illustrations) + CAMPING DESIGN (graphisme)"

### FR:K013
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Circular Pavilion Paris  [Bauvorhaben/Objekt]
- Knoten B: Ville de Paris – Pavillon de l Arsenal  [Öffentliche Institution]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://encoreheureux.org/en/projects/pavillon-circulaire
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ville de Paris / Direction de l'Architecture et du Patrimoine als Bauherr im Team-Credit von Pavillon Circulaire genannt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "VILLE DE PARIS / DIRECTION DE L'ARCHITECTURE ET DU PATRIMOINE"

### FR:K014
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Circular Pavilion Paris  [Bauvorhaben/Objekt]
- Knoten B: Technische Dienste der Stadt Paris  [Öffentliche Institution]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://encoreheureux.org/en/projects/pavillon-circulaire
- Bisherige Beschreibung (Altdaten, nur Hinweis): Service Techniques des Bâtiments Tertiaires (second-œuvre) im Team-Credit von Pavillon Circulaire genannt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "SERVICE TECHNIQUES DES BÂTIMENTS TERTIAIRES (STGCAI, SABA, SALPA) (second-œuvre)"

### FR:K015
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Circular Pavilion Paris  [Bauvorhaben/Objekt]
- Knoten B: Encore Heureux  [Unternehmen]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://encoreheureux.org/en/projects/pavillon-circulaire
- Bisherige Beschreibung (Altdaten, nur Hinweis): Encore Heureux Architectes als mandataire (Federfuehrer) von Pavillon Circulaire
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "ENCORE HEUREUX ARCHITECTES (mandataires)"

### FR:K016
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferme du Rail Paris  [Bauvorhaben/Objekt]
- Knoten B: Travail & Vie  [Organisation]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.ekopolis.fr/operations-batiment/la-ferme-du-rail
- Bisherige Beschreibung (Altdaten, nur Hinweis): ausfuehrendes_unternehmen_reuse_massnahmen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Dans les entreprises : Apijbat et Travail et Vie"

### FR:K017
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferme du Rail Paris  [Bauvorhaben/Objekt]
- Knoten B: Réhabail  [Unternehmen]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.ekopolis.fr/operations-batiment/la-ferme-du-rail
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauherr_Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "La maîtrise d'ouvrage privée Réhabail a été un acteur moteur et volontaire dans la démarche de réemploi"

### FR:K018
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferme du Rail Paris  [Bauvorhaben/Objekt]
- Knoten B: Pouget Consultants  [Unternehmen]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://grandhuit.eu/projet/ferme-du-rail/
- Bisherige Beschreibung (Altdaten, nur Hinweis): BE_thermique_Fachplaner
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Grand Huit avec Albert et cie (AMO), Scoping (BET TCE), Gamba (BET acoustique) et Toreana, Pouget (BE thermique), Mélanie Drevet paysagiste"

### FR:K019
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferme du Rail Paris  [Bauvorhaben/Objekt]
- Knoten B: Scoping  [Unternehmen]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://grandhuit.eu/projet/ferme-du-rail/
- Bisherige Beschreibung (Altdaten, nur Hinweis): BET_TCE_Fachplaner
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Grand Huit avec Albert et cie (AMO), Scoping (BET TCE), Gamba (BET acoustique) et Toreana, Pouget (BE thermique), Mélanie Drevet paysagiste"

### FR:K020
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferme du Rail Paris  [Bauvorhaben/Objekt]
- Knoten B: Albert & Co  [Unternehmen]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://grandhuit.eu/projet/ferme-du-rail/
- Bisherige Beschreibung (Altdaten, nur Hinweis): AMO_generaliste
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "rand huit avec albert et cie (amo), scoping (bet tce), gamba (bet acoustique) et toreana, pouget (be thermique), melanie drevet paysagi"
