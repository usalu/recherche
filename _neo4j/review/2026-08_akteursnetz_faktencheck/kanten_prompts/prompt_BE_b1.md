...
- Knoten A: Chiro d’Itterbeek  [Bauvorhaben/Objekt]
- Knoten B: Commune de Dilbeek  [Öffentliche Institution]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/sanitary-block-itterbeek-chiro
- Bisherige Beschreibung (Altdaten, nur Hinweis): Project owner
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Municipality of Dilbeek listed as Project owner"

### BE:K002
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Chiro d’Itterbeek  [Bauvorhaben/Objekt]
- Knoten B: CC Autrement  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/sanitary-block-itterbeek-chiro
- Bisherige Beschreibung (Altdaten, nur Hinweis): Contractor
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Coopérative construction AUTREMENT listed under Contractors"

### BE:K003
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Chiro d’Itterbeek  [Bauvorhaben/Objekt]
- Knoten B: Franck  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/sanitary-block-itterbeek-chiro
- Bisherige Beschreibung (Altdaten, nur Hinweis): Materiallieferant
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "The facade, for example, is entirely made of reusable bricks provided by Jan Franck."

### BE:K004
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Chiro d’Itterbeek  [Bauvorhaben/Objekt]
- Knoten B: Rotor  [NGO/Verband/Netzwerk]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/sanitary-block-itterbeek-chiro
- Bisherige Beschreibung (Altdaten, nur Hinweis): Projektdokumentation/-durchfuehrung (Rotor-eigene Projektdatenbank)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "This small sanitary block project is located next to the old farmhouse housing the Chiro d'Itterbeek, a youth organisation."

### BE:K005
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Chiro d’Itterbeek  [Bauvorhaben/Objekt]
- Knoten B: RotorDC  [Materialhub/Bauteilbörse]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/sanitary-block-itterbeek-chiro
- Bisherige Beschreibung (Altdaten, nur Hinweis): Materiallieferant
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "The interior of the sanitary block is mainly made of reuse materials sold by RotorDC."

### BE:K006
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: BLAF Architecten  [Unternehmen]
- Knoten B: Maison DnA  [Bauvorhaben/Objekt]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.archdaily.com/423660/dna-house-blaf-architecten
- Bisherige Beschreibung (Altdaten, nur Hinweis): Architekt des Projekts
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "dnA House / BLAF Architecten (Architekt: BLAF Architecten)"

### BE:K007
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Lo-Reninge Town Hall…  [Bauvorhaben/Objekt]
- Knoten B: noAarchitecten  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://noaarchitecten.net/projects/1/046-lo-reninge-town-hall
- Bisherige Beschreibung (Altdaten, nur Hinweis): Entwurf/Architekt des Projekts, dokumentiert auf noAarchitecten's eigener Projektportfolioseite
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Restoration and extension of a former convent to create a town hall"

### BE:K008
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Lo-Reninge Town Hall…  [Bauvorhaben/Objekt]
- Knoten B: Lo-Reninge town council  [Öffentliche Institution]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://noaarchitecten.net/projects/1/046-lo-reninge-town-hall
- Bisherige Beschreibung (Altdaten, nur Hinweis): Lo-Reninge town council als Auftraggeber/Bauherr des Rathausprojekts
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Client Dexia / Lo-Reninge town council"

### BE:K009
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Lo-Reninge Town Hall…  [Bauvorhaben/Objekt]
- Knoten B: Dexia  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://noaarchitecten.net/projects/1/046-lo-reninge-town-hall
- Bisherige Beschreibung (Altdaten, nur Hinweis): Dexia als Mit-Auftraggeber des Rathausprojekts
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Client Dexia / Lo-Reninge town council"

### BE:K010
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Maison Vignette  [Bauvorhaben/Objekt]
- Knoten B: Karbon’ architecture & urbanisme  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://opalis.eu/fr/projets/maison-vignette-karbon-architecture-et-urbanisme
- Bisherige Beschreibung (Altdaten, nur Hinweis): Architekt/Entwurfsverfasser des Projekts Maison Vignette
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Conception: Karbon' architecture & Urbanisme"

### BE:K011
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Maison Vignette  [Bauvorhaben/Objekt]
- Knoten B: BESP Stoffel & Partners / Pierre Stoffel  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://opalis.eu/fr/projets/maison-vignette-karbon-architecture-et-urbanisme
- Bisherige Beschreibung (Altdaten, nur Hinweis): Statik/Stabilitaetsplaner des Projekts Maison Vignette
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Technique / Stabilité: Pierre Stoffel"

### BE:K012
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Maison Vignette  [Bauvorhaben/Objekt]
- Knoten B: Franck Bricks  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://opalis.eu/fr/projets/maison-vignette-karbon-architecture-et-urbanisme
- Bisherige Beschreibung (Altdaten, nur Hinweis): Materiallieferant (gebrauchte Ziegel) des Projekts Maison Vignette
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Brique: Grote Boomse Steen, provenant de chez Franck"
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://opalis.eu/fr/projets/maison-vignette-karbon-architecture-et-urbanisme
- Bisherige Beschreibung (Altdaten, nur Hinweis): Fundstelle/Marktplatz fuer gebrauchte Blausteinplatten im Projekt Maison Vignette
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "40m² trouvées sur le site de petites annonces 2emain.be."
...
### BE:K015
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Multi Brussels  [Bauvorhaben/Objekt]
- Knoten B: Whitewood  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/multi-de-brouckere-tower
- Bisherige Beschreibung (Altdaten, nur Hinweis): Commissioner
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Commissioner: Whitewood"

### BE:K016
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Multi Brussels  [Bauvorhaben/Objekt]
- Knoten B: Cordeel  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/multi-de-brouckere-tower
- Bisherige Beschreibung (Altdaten, nur Hinweis): Contractor
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Contractor: Cordeel"

### BE:K017
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Multi Brussels  [Bauvorhaben/Objekt]
- Knoten B: CONIX RDBM  [Unternehmen]
- Land: BE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/reuse-multi-project
- Bisherige Beschreibung (Altdaten, nur Hinweis): Architekt/Kollaborationspartner
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "six-year long collaboration between Whitewood, Conix RDBM and Rotor"
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/multi-de-brouckere-tower
- Bisherige Beschreibung (Altdaten, nur Hinweis): Beratungspartner
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Conix RDBM and Whitewood invited Rotor to be involved in the Multi project."
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://rotordb.org/en/projects/multi-de-brouckere-tower
- Bisherige Beschreibung (Altdaten, nur Hinweis): Materialaufbereitung/-lieferung
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Flamed granite flooring, salvaged by Rotor DC from the Generale de Banque"

### BE:K020
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Whitewood  [Unternehmen]
- Knoten B: OXY Centre Monnaie  [Bauvorhaben/Objekt]
- Land: BE
- Belegstatus: GEPRUEFT
