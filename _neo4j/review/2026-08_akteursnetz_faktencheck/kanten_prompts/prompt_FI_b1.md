...
- Knoten A: Härmälänranta  [Bauvorhaben/Objekt]
- Knoten B: A-Kruunu  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/city-of-tampere/
- Bisherige Beschreibung (Altdaten, nur Hinweis): A-Kruunu als Bauherr/Auftraggeber des Härmälänranta-Neubaus mit wiederverwendeten Elementen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "The building was built by Skanska for the client, affordable rental housing company A-Kruunu"

### FI:K002
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Härmälänranta  [Bauvorhaben/Objekt]
- Knoten B: Skanska Finland  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/city-of-tampere/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Skanska als Hauptausfuehrender des Härmälänranta-Neubaus
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "The building was built by Skanska for the client, affordable rental housing company A-Kruunu"

### FI:K003
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Härmälänranta  [Bauvorhaben/Objekt]
- Knoten B: Consolis Parma  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/precast-concrete
- Bisherige Beschreibung (Altdaten, nur Hinweis): Consolis Parma refurbishing der fuer Härmälänranta wiederverwendeten Elemente
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "were quality controlled and factory refurbished in Consolis Parma's factory in Kangasala"

### FI:K004
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Härmälänranta  [Bauvorhaben/Objekt]
- Knoten B: Ramboll Finland  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/consolis-parma/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ramboll als Tragwerksplaner der Härmälänranta-Wiederverwendung
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "we at Ramboll developed designing the refurbishment of the reclaimed elements in collaboration with the factory"

### FI:K005
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Härmälänranta  [Bauvorhaben/Objekt]
- Knoten B: LIIKE Oy Arkkitehtistudio  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): LIIKE als Architekt im Rahmen der ReCreate-Minipilotprojekte, zu denen Härmälänranta zaehlt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Liike Oy Arkkitehtistudio – Architect"
...
- Knoten A: Skanska Finland  [Unternehmen]
- Knoten B: Consolis Parma  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/precast-concrete
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://parma.fi/betonielementtien-uudelleenkayttoa-koeponnistettu-onnistuneesti-recreate-hankkeen-minipiloteissa/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Skanska als Ausfuehrender der ReCreate-Minipilotprojekte, zu denen Metso Lokomotion zaehlt
...
### FI:K012
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Consolis Parma  [Unternehmen]
- Knoten B: Umacon  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/precast-concrete
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/consolis-parma/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ramboll unterstuetzte Consolis Parma bei der Aufbereitung wiederverwendeter Elemente
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://parma.fi/betonielementtien-uudelleenkayttoa-koeponnistettu-onnistuneesti-recreate-hankkeen-minipiloteissa/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Consolis Parma als Cluster-Aufbereiter der ReCreate-Minipilotprojekte, zu denen Metso Lokomotion zaehlt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "In the ReCreate research project, companies have participated in Skanska's building projects, which serve as the study's minipilots."
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/consolis-parma/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Consolis Parma als Aufbereiter der fuer das Melkinlaituri-Projekt wiederverwendeten Hohldielen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Slabs were transported to Consolis Parma's Nummela factory, where the refurbishment of the elements could begin"

### FI:K016
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Consolis Parma  [Unternehmen]
- Knoten B: Peikko Finland  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.peikko.com/blog/pilot-project-proves-that-the-dismount-and-reuse-of-concrete-elements-is-realistic-and-economical/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Peikko-eigene Seite nennt Consolis Parma als Mitbeteiligten am Demontage-Pilotprojekt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "We implemented a pilot project at the end of 2021...to prove that the connecting technology between load-bearing structures enables easy dismantling and reassembly."
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://parma.fi/betonielementtien-uudelleenkayttoa-koeponnistettu-onnistuneesti-recreate-hankkeen-minipiloteissa/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Umacon als Cluster-Rueckbaupartner der ReCreate-Minipilotprojekte, zu denen Metso Lokomotion zaehlt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "In the ReCreate research project, companies have participated in Skanska's building projects, which serve as the study's minipilots."
