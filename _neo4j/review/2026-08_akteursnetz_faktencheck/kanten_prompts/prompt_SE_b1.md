...
- Knoten A: Åhlin & Ekeroth  [Unternehmen]
- Knoten B: Bygghubben  [Materialhub/Bauteilbörse]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://ahlin-ekeroth.se/bygghubben-i-nytt-samarbete-med-k-bygg/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Delägare und Initiativtagare (Mitgründerin) von Bygghubben
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Bygghubben, som Åhlin & Ekeroth är delägare i och en av initiativtagarna till"

### SE:K002
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Akademiska Hus  [Unternehmen]
- Knoten B: Bjerking  [Unternehmen]
- Land: SE
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Konsortialmitglieder im Projektkonsortium Återhus 3.0
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "14 parter ingår i projektkonsortium: RISE, Akademiska Hus, Bjerking, Codesign, Förbo, Heidelberg Materials-Precast Contiga, KTH, Magnolia Bostad, NCC, Palats"

### SE:K003
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Akademiska Hus  [Unternehmen]
- Knoten B: Handslag för cirkulärt byggande  [NGO/Verband/Netzwerk]
- Land: SE
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Akademiska Hus als angeschlossener Fastighetsägare im Handslaget gelistet (Referenzliste auf N01-Seite)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Akademiska Hus"

### SE:K004
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Akademiska Hus  [Unternehmen]
- Knoten B: Tyresö kommun  [Öffentliche Institution]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.akademiskahus.se/om-oss/aktuellt/Nyheter/2023/december/samverkan-for-aterbruk-av-lastbarande-konstruktionsdelar/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Konsortialmitglieder im Projektkonsortium Återhus 3.0
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Akademiska Hus, Bjerking, Codesign, Förbo, Heidelberg Materials-Precast Contiga, KTH, Magnolia Bostad, NCC, Palats, QPG, Stockholms Stad, Svensk Betong, Tyresö Kommun."

### SE:K005
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Akademiska Hus  [Unternehmen]
- Knoten B: Wiklunds Åkeri  [Unternehmen]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.wiklunds.se/affarsomraden/cirkulart-byggande/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Gemeinsame Mitgliedschaft im KRETS-Initiativ für zirkulären Materialhub Stockholm/Uppsala
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Bland medlemmarna finns Vasakronan, Castellum, Wiklunds, Alecta Fastigheter, Akademiska Hus samt Uppsala klimatprotokoll"

### SE:K006
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Akademiska Hus  [Unternehmen]
- Knoten B: Palats  [Software/Tool-Anbieter]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.akademiskahus.se/om-oss/aktuellt/Nyheter/2023/december/samverkan-for-aterbruk-av-lastbarande-konstruktionsdelar/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Konsortialmitglieder im Projektkonsortium Återhus 3.0
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): gemeinsame Partner im Innovationsprojekt Återhus (Vinnova)
...
### SE:K008
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Atrium Ljungberg  [Unternehmen]
- Knoten B: Vasakronan  [Unternehmen]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://branschaktuellt.se/byggindustrin/62133-stora-aktorer-i-samverkan-om-aterhus/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Projektpartner (Pilotprojekte) im Återhus-Projekt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Flera fastighetsägare medverkar, till exempel Fabege, Atrium Ljungberg och Vasakronan, och bidrar bland annat med pilotprojekt där delmoment testas."

### SE:K009
- Kantenart: AKTEUR-AKTEUR
- Knoten A: BC-bygg  [Unternehmen]
- Knoten B: Bygghubben  [Materialhub/Bauteilbörse]
- Land: SE
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Mit-Delägare/Gründer von Bygghubben
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Företagen som gått ihop som delägare är Haga rot, Teknikbyggarna i Linköping AB, Åhlin & Ekeroth byggnads AB, BC bygg, Wilzéns och Partner RP i Linköping AB."

### SE:K010
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Business Region Göteborg  [Unternehmen]
- Knoten B: Handslag för cirkulärt byggande  [NGO/Verband/Netzwerk]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.businessregiongoteborg.se/naringslivsutveckling/hallbar-utveckling/goteborgs-plattform-klimatneutralt-byggande/handslag-cirkulart-byggande
- Bisherige Beschreibung (Altdaten, nur Hinweis): Business Region Göteborg als eine der vier Akteursgruppen des Handslaget genannt, keine explizite Betreiber-Formulierung gefunden
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Business Region Göteborg genom GCP"

### SE:K011
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Byggåterbruket (Umeå)  [Materialhub/Bauteilbörse]
- Knoten B: Umeå kommun  [Öffentliche Institution]
- Land: SE
- Belegstatus: UNGEPRUEFT
...
### SE:K012
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Bygghubben  [Materialhub/Bauteilbörse]
- Knoten B: Haga Rot  [Unternehmen]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.corren.se/nyheter/linkoping/artikel/sex-lokala-firmor-gar-ihop-startar-ny-bygghandel-i-linkoping/jv4gmzoj
- Bisherige Beschreibung (Altdaten, nur Hinweis): Mit-Delägare/Gründer von Bygghubben
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Bygghubben  [Materialhub/Bauteilbörse]
- Knoten B: RP (Bygghubben member)  [Unternehmen]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.corren.se/nyheter/linkoping/artikel/sex-lokala-firmor-gar-ihop-startar-ny-bygghandel-i-linkoping/jv4gmzoj
- Bisherige Beschreibung (Altdaten, nur Hinweis): Mit-Delägare/Gründer von Bygghubben (als "Partner RP i Linköping AB")
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Företagen som gått ihop som delägare är Haga rot, Teknikbyggarna i Linköping AB, Åhlin & Ekeroth byggnads AB, BC bygg, Wilzéns och Partner RP i Linköping AB."

### SE:K014
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Bygghubben  [Materialhub/Bauteilbörse]
- Knoten B: Teknikbyggarna  [Unternehmen]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://teknikbyggarna.se/hallbarhet/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Delägare von Bygghubben
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Vi är stolta delägare i ByggHubben, ett företag som främjar återbruk inom byggbranschen."

### SE:K015
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Bygghubben  [Materialhub/Bauteilbörse]
- Knoten B: Wilzéns  [Unternehmen]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://wilzens.se/hallbarhet/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Delägare und Gründer von Bygghubben
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Under 2023 har Wilzéns blivit delägare i och en av grundarna till Bygghubben"

### SE:K016
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Codesign Sweden AB  [Unternehmen]
- Knoten B: RISE (Research Institutes of Sweden)  [Forschung/Lehre]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.mynewsdesk.com/se/codesign/pressreleases/aaterhus-att-bygga-hus-av-hus-faar-vidare-finansiering-fraan-vinnova-3092349
- Bisherige Beschreibung (Altdaten, nur Hinweis): Codesign leitet Återhus-Konsortium mit RISE als Partner
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Innovationsprojektet Återhus leds av Codesign i samarbete med NCC, RISE och Stockholms stad"

### SE:K017
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Contiga  [Unternehmen]
- Knoten B: Fabege  [Materialhub/Bauteilbörse]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://branschaktuellt.se/byggindustrin/62133-stora-aktorer-i-samverkan-om-aterhus/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Konsortialmitglieder im Vinnova-Innovationsprojekt 'Återhus – att bygga hus av hus' (Wiederverwendung schwerer Bauteile)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Medverkar gör även Stockholm stad, Vasakronan, Fabege, Atrium Ljungberg, Contiga, Zengun, Anthesis, Svensk Betong, Ramboll och KTH."

### SE:K018
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Contiga  [Unternehmen]
- Knoten B: Zengun  [Unternehmen]
- Land: SE
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
### SE:K019
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Fabege  [Materialhub/Bauteilbörse]
- Knoten B: Reboost  [Materialhub/Bauteilbörse]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.fabege.se/kunskap-och-inspiration/nyheter/2026/fabege-overlater-aterbrukshubb-till-ragn-sells-och-blir-medlem-i-reboost/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Fabege ist im April 2026 neues Mitglied bei Ragn-Sells Reboost geworden und hat im Gegenzug die eigene Återbrukshubb an Ragn-Sells uebertragen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "ansluter Fabege som ny medlem i Ragn-Sells Reboost"

### SE:K020
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Handslag för cirkulärt byggande  [NGO/Verband/Netzwerk]
- Knoten B: HSB Göteborg  [Unternehmen]
- Land: SE
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.businessregiongoteborg.se/naringslivsutveckling/hallbar-utveckling/goteborgs-plattform-klimatneutralt-byggande/handslag-cirkulart-byggande
- Bisherige Beschreibung (Altdaten, nur Hinweis): HSB Göteborg als angeschlossener Fastighetsägare im Handslaget gelistet
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "HSB Göteborg"
