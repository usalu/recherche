...
- Knoten A: Ramboll Finland  [Unternehmen]
- Knoten B: Lokomotion Technology…  [Bauvorhaben/Objekt]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://parma.fi/betonielementtien-uudelleenkayttoa-koeponnistettu-onnistuneesti-recreate-hankkeen-minipiloteissa/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ramboll als Cluster-Fachplaner der ReCreate-Minipilotprojekte, zu denen Metso Lokomotion zaehlt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "In the ReCreate research project, companies have participated in Skanska's building projects, which serve as the study's minipilots."

### FI:K022
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ramboll Finland  [Unternehmen]
- Knoten B: Melkinlaituri Primary…  [Bauvorhaben/Objekt]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/consolis-parma/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ramboll unterstuetzte die Nachweisfuehrung fuer die im Melkinlaituri-Projekt wiederverwendeten Elemente
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Consolis Parma used Ramboll's help determine suitable refurbishment measures"

### FI:K023
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Ramboll Finland  [Unternehmen]
- Knoten B: City of Espoo  [Öffentliche Institution]
- Land: FI
- Belegstatus: UNGEPRUEFT
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Ramboll Finland  [Unternehmen]
- Knoten B: Tampereen kaupunki (City of Tampere)  [Öffentliche Institution]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://recreate-project.eu/tag/precast-concrete
- Bisherige Beschreibung (Altdaten, nur Hinweis): Gemeinsame Mitglieder des ReCreate Finnish cluster
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "ReCreate's Finnish cluster is formed by Tampere University, Skanska, Consolis Parma, Ramboll Finland, Umacon, LIIKE architects, and the City of Tampere."

### FI:K025
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Lokomotion Technology…  [Bauvorhaben/Objekt]
- Knoten B: Metso Oyj  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.lokomotion.fi/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Metso als Bauherr/Betreiber des Lokomotion-Technologiezentrums mit wiederverwendeten Betonelementen
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "recycled concrete elements were reused in construction"

### FI:K026
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Lokomotion Technology…  [Bauvorhaben/Objekt]
- Knoten B: Tampere University  [Forschung/Lehre]
- Land: FI
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
### FI:K027
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Melkinlaituri Primary…  [Bauvorhaben/Objekt]
- Knoten B: City of Helsinki  [Öffentliche Institution]
- Land: FI
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Melkinlaituri Primary…  [Bauvorhaben/Objekt]
- Knoten B: YIT  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://sustera.com/melkinlaituri-primary-school-and-day-care-centre-pilot-project-for-the-reuse-of-hollow-core-slabs/
- Bisherige Beschreibung (Altdaten, nur Hinweis): YIT als ausfuehrendes Bauunternehmen des Melkinlaituri-Wiederverwendungsprojekts
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "YIT is delivering the Melkinlaituri school and day care centre for the City of Helsinki as a life-cycle project."

### FI:K029
- Kantenart: AKTEUR-AKTEUR
- Knoten A: City of Helsinki  [Öffentliche Institution]
- Knoten B: Kiilto Family  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.kiilto.fi/uutishuone/rakennusmateriaalit-jotka-elavat-useamman-kerran/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Kiilto testet seine Debonding-on-Demand-Technologie (Fliesen-Wiederverwendung) in einem Pilotprojekt mit Business Helsinki / ARKI 135 Kreislaufwirtschafts-Hub, einer Wirtschaftsfoerderungseinheit der Stadt Helsinki, gemeinsam mit Forum Virium Helsinki.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "pilottihanke Forum Virium Helsingin ja Business Helsingin ARKI 135 kiertotaloushubin kanssa tarjoaa mahdollisuuden testata ja demonstroida teknologian toimivuutta"

### FI:K030
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Tampere University  [Forschung/Lehre]
- Knoten B: SÄILÖ: Purusta säilöön ja kiertoon  [Förderträger]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://ekokumppanit.fi/hankkeet/sailo/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Projektpartner (Konsortiumsmitglied) im SÄILÖ-Projekt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "SÄILÖ-hanke toteutetaan yhteistyössä Oriveden kaupungin, Nokian kaupungin ja Tampereen yliopiston kanssa."
...
### FI:K032
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Aalto University (Department of Architecture)  [Forschung/Lehre]
- Knoten B: VTT (Technical Research Centre of Finland)  [Forschung/Lehre]
- Land: FI
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
### FI:K033
- Kantenart: AKTEUR-AKTEUR
- Knoten A: City of Espoo  [Öffentliche Institution]
- Knoten B: Purkupiha  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.espoo.fi/fi/artikkelit/pohjois-tapiolan-vanhan-koulun-purku-toimi-alustana-uudelleenkayton-kokeiluille
- Bisherige Beschreibung (Altdaten, nur Hinweis): Espoon kaupunki (Tilapalvelut) fuehrte ein benanntes Reuse-Pilotprojekt (Pohjois-Tapiolan vanhan koulun purku) durch, in dem Purkupiha Oy als purku-urakoitsija/Partner genannt wird.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "yhteistyökumppaneina toimivat Metropolia ammattikorkeakoulu, rakennustuotteiden uudelleenkäyttöön erikoistunut Spolia Design Oy, uudelleenkäytön edistäjä kierrätysoperaattori Risain Oy sekä purku-urakoitsija Purkupiha Oy."

### FI:K034
- Kantenart: AKTEUR-AKTEUR
- Knoten A: City of Nokia (Nokian kaupunki)  [Öffentliche Institution]
- Knoten B: SÄILÖ: Purusta säilöön ja kiertoon  [Förderträger]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://ekokumppanit.fi/hankkeet/sailo/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Pilotpartner (Nokia, Vihnusasema-Abbruchpilot) im SÄILÖ-Projekt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "SÄILÖ-hanke toteutetaan yhteistyössä Oriveden kaupungin, Nokian kaupungin ja Tampereen yliopiston kanssa."

### FI:K035
- Kantenart: AKTEUR-AKTEUR
- Knoten A: City of Orivesi (Oriveden kaupunki)  [Öffentliche Institution]
- Knoten B: SÄILÖ: Purusta säilöön ja kiertoon  [Förderträger]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://ekokumppanit.fi/hankkeet/sailo/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Pilotpartner (Orivesi, Ziegel-Wiederverwendungspilot) im SÄILÖ-Projekt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "SÄILÖ-hanke toteutetaan yhteistyössä Oriveden kaupungin, Nokian kaupungin ja Tampereen yliopiston kanssa."

### FI:K036
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Ekokumppanit (Kiertotalous Pirkanmaa)  [Förderträger]
- Knoten B: SÄILÖ: Purusta säilöön ja kiertoon  [Förderträger]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://ekokumppanit.fi/hankkeet/sailo/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ekokumppanit/Kiertotalous Pirkanmaa ist Haupttraeger (päätoteuttaja) des SÄILÖ-Projekts
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Hankkeen päätoteuttajana toimii Ekokumppanien operoima Kiertotalous Pirkanmaa"

### FI:K037
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Joensuun Rakennuspurku ja Timanttiurakointi Oy  [Unternehmen]
- Knoten B: Sitowise  [Unternehmen]
- Land: FI
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
### FI:K038
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Kaakkois-Suomen Ammattikorkeakoulu Oy (Xamk)  [Forschung/Lehre]
- Knoten B: Mikkelin Kehitysyhtiö Miksei Oy  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://mikseimikkeli.fi/hankkeet/kielo/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Xamk und Miksei sind gemeinsame Traeger (yhteinen ryhmähanke) des Reuse-Projekts KIELO.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "KIELO – Kiertotalousloikka rakennusmateriaalien uudelleenkäytön parantamiseksi Mikkelissä on Mikkelin kehitysyhtiö Miksei Oy:n ja Kaakkois-Suomen ammattikorkeakoulun yhteinen ryhmähanke."

### FI:K039
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Mikkelin Kehitysyhtiö Miksei Oy  [Unternehmen]
- Knoten B: Purkupiha  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://arkisto.mikseimikkeli.fi/hiilineutraalit-terasportaat-onnistunut-purkumateriaalien-uudelleenkayttokokeilu-mikkelissa/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Purkupiha Oy wurde als Abbruch-/Ausfuehrungsunternehmen fuer ein Reuse-Pilotprojekt (Stahltreppen-Wiederverwendung) im Rahmen des von Miksei getragenen KIELO-Projekts ausgewaehlt.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Purkatyö toteutettiin yhteistyössä paikallisen rakennusliike OW-Yhtiöt Oy:n ja kohteen purku-urakoitsijaksi valikoituneen Purkupiha Oy:n kanssa."

### FI:K040
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Purkutori.fi  [Materialhub/Bauteilbörse]
- Knoten B: Purkupiha  [Unternehmen]
- Land: FI
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.purkutori.fi/tietoja-meista
- Bisherige Beschreibung (Altdaten, nur Hinweis): Purkupiha Oy betreibt/stellt den Marktplatz Purkutori.fi bereit.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Purkutori.fi-palvelun tarjoaa Purkupiha Oy – yksi Suomen suurimmista purkuliikkeistä ja johtava suomalaisomisteinen rakennusten ja teollisuuden purkaja Suomessa."
