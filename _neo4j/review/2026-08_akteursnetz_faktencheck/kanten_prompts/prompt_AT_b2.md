...
- Knoten A: Re-Use Austria  [NGO/Verband/Netzwerk]
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Re-Use Austria (damals RepaNet) als Teil des BauKarussell-Partnerteams beim Ferry-Dusika-Stadion-Rueckbau.
...
- Knoten A: ATP sustain GmbH  [Unternehmen]
- Knoten B: Madaster Austria GmbH  [Software/Tool-Anbieter]
- Land: AT
- Belegstatus: UNGEPRUEFT
...
### AT:K023
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferry-Dusika-Stadion Rückbau  [Bauvorhaben/Objekt]
- Knoten B: Job-TransFair gemeinnützige GmbH  [Unternehmen]
- Land: AT
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.ots.at/presseaussendung/OTS_20211014_OTS0116/ferry-dusika-stadion-erfolg-fuer-kreislaufwirtschaftliches-rueckbauprojekt
- Bisherige Beschreibung (Altdaten, nur Hinweis): Job-TransFair ist die Traegerin der im Ferry-Dusika-Stadion aktiven Kuemmerei.
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.ots.at/presseaussendung/OTS_20211014_OTS0116/ferry-dusika-stadion-erfolg-fuer-kreislaufwirtschaftliches-rueckbauprojekt
- Bisherige Beschreibung (Altdaten, nur Hinweis): pulswerk als Teil des BauKarussell-Teams beim Ferry-Dusika-Stadion-Rueckbau.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Das BauKarussell-Team setzt sich aus Partnern von pulswerk GmbH, Romm ZT und RepaNet"

### AT:K025
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferry-Dusika-Stadion Rückbau  [Bauvorhaben/Objekt]
- Knoten B: Schindel und Holz  [Unternehmen]
- Land: AT
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.ots.at/presseaussendung/OTS_20211014_OTS0116/ferry-dusika-stadion-erfolg-fuer-kreislaufwirtschaftliches-rueckbauprojekt
- Bisherige Beschreibung (Altdaten, nur Hinweis): Schindel und Holz als lokaler Partnerbetrieb beim Ferry-Dusika-Stadion-Rueckbau.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Zu den lokalen Partnerbetrieben zaehlen ... Schindel und Holz"

### AT:K026
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferry-Dusika-Stadion Rückbau  [Bauvorhaben/Objekt]
- Knoten B: TEAWork  [Unternehmen]
- Land: AT
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.ots.at/presseaussendung/OTS_20211014_OTS0116/ferry-dusika-stadion-erfolg-fuer-kreislaufwirtschaftliches-rueckbauprojekt
- Bisherige Beschreibung (Altdaten, nur Hinweis): Als lokaler Partnerbetrieb genannt, jedoch unter der Schreibweise 'TEAMwork' statt 'TEAWork' -- moeglich dieselbe Organisation, Schreibvariante nicht unabhaengig bestaetigt.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Zu den lokalen Partnerbetrieben zaehlen ... TEAMwork"

### AT:K027
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferry-Dusika-Stadion Rückbau  [Bauvorhaben/Objekt]
- Knoten B: Verein ISSBA  [Unternehmen]
- Land: AT
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.ots.at/presseaussendung/OTS_20211014_OTS0116/ferry-dusika-stadion-erfolg-fuer-kreislaufwirtschaftliches-rueckbauprojekt
- Bisherige Beschreibung (Altdaten, nur Hinweis): Verein ISSBA als lokaler Partnerbetrieb beim Ferry-Dusika-Stadion-Rueckbau.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Zu den lokalen Partnerbetrieben zaehlen ... Verein ISSBA"
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.ots.at/presseaussendung/OTS_20211014_OTS0116/ferry-dusika-stadion-erfolg-fuer-kreislaufwirtschaftliches-rueckbauprojekt
- Bisherige Beschreibung (Altdaten, nur Hinweis): Volkshilfe Wien (Jobfabrik) erhielt wiederverwendete Tribuenenstuehle aus dem Ferry-Dusika-Stadion.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "100 Stuehle an das Start-up treecycle ... Jobfabrik der Volkshilfe Wien"

### AT:K029
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Ferry-Dusika-Stadion Rückbau  [Bauvorhaben/Objekt]
- Knoten B: WSE Wiener Standortentwicklung GmbH  [Öffentliche Institution]
- Land: AT
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.ots.at/presseaussendung/OTS_20211014_OTS0116/ferry-dusika-stadion-erfolg-fuer-kreislaufwirtschaftliches-rueckbauprojekt
- Bisherige Beschreibung (Altdaten, nur Hinweis): WSE fuehrt das Bauprojektmanagement fuer den Ferry-Dusika-Stadion-Rueckbau aus.
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Umgesetzt wird das Projekt vom Bauprojektmanagement-Team der WSE."

### AT:K030
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Drees & Sommer (Österreich)  [Unternehmen]
- Knoten B: Madaster Austria GmbH  [Software/Tool-Anbieter]
- Land: AT
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://madaster.at/neuigkeiten/1625/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Partner-Portfolio von Madaster in Österreich
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Die Firmen ATP sustain, Delta, Dietrich Untertrifaller, Drees & Sommer, GF Piping Systems, HNP architects, iC Consulenten, PORR, SIGNA, Value One und WICONA vervollständigen das Partner-Portfolio von Madaster in Österreich."
