...
- Knoten A: Loopfront  [Software/Tool-Anbieter]
- Knoten B: Regionalt ombruksnettverk for byggematerialer (Oslo-Trondheim)  [NGO/Verband/Netzwerk]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.multiconsult.no/etablerer-nettverk-for-mer-ombruk-av-byggematerialer/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Loopfront ist gemeinsam mit Multiconsult Mitbegruender/Betreiber der digitalen Plattform des regionalen Ombruksnettverks
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Loopfront og Multiconsult etablerer nå nettverk for ombruk av byggematerialer."

### NO:K002
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: KA13  [Bauvorhaben/Objekt]
- Knoten B: Entra AS  [Unternehmen]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauherr/Entwickler von KA13
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Developer: Entra"

### NO:K003
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: KA13  [Bauvorhaben/Objekt]
- Knoten B: MAD arkitekter / Mad as  [Unternehmen]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Bisherige Beschreibung (Altdaten, nur Hinweis): Architekt von KA13
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Architect: Mad"

### NO:K004
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: KA13  [Bauvorhaben/Objekt]
- Knoten B: FutureBuilt  [NGO/Verband/Netzwerk]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Bisherige Beschreibung (Altdaten, nur Hinweis): KA13 ist FutureBuilt-Forbildeprosjekt
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Kristian Augusts gate relates to FutureBuilt's criteria for circular buildings."

### NO:K005
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: KA13  [Bauvorhaben/Objekt]
- Knoten B: Asplan Viak  [Unternehmen]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Bisherige Beschreibung (Altdaten, nur Hinweis): Landschaftsarchitekt/Umweltberater von KA13
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Landscape Architect: Asplan Viak / Environmental Consultant: Asplan Viak AS"

### NO:K006
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: KA13  [Bauvorhaben/Objekt]
- Knoten B: Insenti  [Unternehmen]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://insenti.no/prosjekt/kristian-augusts-gate-13-ka13/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Prosjektledelse/Ombrukskoordinering fuer KA13
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Insenti er engasjert av Entra som byggherrens representant med byggeledelse, prosjektledelse, prosjekteringsgruppeledelse, miljørådgiving og ombrukskoordinering."

### NO:K007
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: KA13  [Bauvorhaben/Objekt]
- Knoten B: Scenario Interiørarkitekter  [Unternehmen]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.scenario.no/prosjekter/ka13-tullinlokka
- Bisherige Beschreibung (Altdaten, nur Hinweis): Interiørarkitekt fuer KA13
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Her har Scenario hatt ansvar for interiøret i kontorbyggets åtte etasjer."

### NO:K008
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: KA13  [Bauvorhaben/Objekt]
- Knoten B: IWG Group / Spaces  [Unternehmen]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.futurebuilt.no/forbildeprosjekter/kristian-augusts-gate-13-oslo
- Bisherige Beschreibung (Altdaten, nur Hinweis): Mieter/Kollaborationspartner in KA13
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Entra in close collaboration with IWG Group and their Spaces concept"

### NO:K009
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Asplan Viak  [Unternehmen]
- Knoten B: Ombruk i nord (Remiks)  [NGO/Verband/Netzwerk]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.klimapartnere.no/ombruk-i-nord-samarbeid-om-gjenbruk-av-materialer/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Beide auf derselben Drittseite als Akteure im Projekt Ombruk i Nord genannt, kein einzelner Satz mit explizitem Beziehungswort zwischen beiden
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Prosjekt ombruk har fått til en avtale med Remiks, som har satt av 500 m2 til mellom-lagring"

### NO:K010
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Asker kommune  [Öffentliche Institution]
- Knoten B: CCRI Pilot Asker  [NGO/Verband/Netzwerk]
- Land: NO
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Asker kommune ist die ausgewaehlte Pilotkommune im CCRI-Programm
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "I 2022 ble Asker kommune valgt som én av 12 piloter i EU-kommisjonens program European Circular Cities and Regions Initiative (CCRI)."
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.multiconsult.no/etablerer-nettverk-for-mer-ombruk-av-byggematerialer/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Asker kommune ist teilnehmender Gebaeudeeigentuemer im regionalen Ombruksnettverk
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "deltar med bygg som skal kartlegges, blant annet Oslo Areal, Omsorgsbygg Oslo KF, Asker kommune, Trondheim kommune, TOBB, NTNU og SINTEF"

### NO:K012
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Asker kommune  [Öffentliche Institution]
- Knoten B: Sirken  [Software/Tool-Anbieter]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.asker.kommune.no/klima-og-natur/siste-nytt-om-klima-og-natur/tre-ar-med-sirkulare-fremskritt/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Asker kommune testet Sirken als Selbstbedienungscontainer fuer Baumaterial-Wiederverwendung
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Kommunen tester ut Sirken, en selvbetjent butikk i kontainer, som gjør materialer fra rivingsprosjekter, og overskudd fra byggeprosjekter tilgjengelige."

### NO:K013
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Bodø Kommune  [Öffentliche Institution]
- Knoten B: Nordlandsforskning AS  [Forschung/Lehre]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.an.no/bodo-en-barekraftig-og-samskapende-by/o/5-4-1367256
- Bisherige Beschreibung (Altdaten, nur Hinweis): samarbeid (gemeinsames mehrjaehriges Kooperationsprojekt zu buergerbeteiligter Stadtentwicklung, in dem auch das CityLoops-Ressourcenzirkulations-Vorhaben verortet ist)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Bodø kommune i samarbeid med Nordlandsforskning, Nord universitet, Nordland fylkeskommune, Bodø/Glimt og Bodø Røde Kors utforske hvordan det kan gjøres."

### NO:K014
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Bodø Kommune  [Öffentliche Institution]
- Knoten B: Iris Ombrukssentral / Saltnes ombruk  [Materialhub/Bauteilbörse]
- Land: NO
- Belegstatus: UNGEPRUEFT
...
### NO:K015
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Multiconsult  [Unternehmen]
- Knoten B: Regionalt ombruksnettverk for byggematerialer (Oslo-Trondheim)  [NGO/Verband/Netzwerk]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.multiconsult.no/etablerer-nettverk-for-mer-ombruk-av-byggematerialer/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Multiconsult ist Mitbegruender/Berater des regionalen Ombruksnettverks
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Loopfront og Multiconsult etablerer nå nettverk for ombruk av byggematerialer."

### NO:K016
- Kantenart: AKTEUR-AKTEUR
- Knoten A: NTNU  [Forschung/Lehre]
- Knoten B: Regionalt ombruksnettverk for byggematerialer (Oslo-Trondheim)  [NGO/Verband/Netzwerk]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.multiconsult.no/etablerer-nettverk-for-mer-ombruk-av-byggematerialer/
- Bisherige Beschreibung (Altdaten, nur Hinweis): NTNU ist teilnehmender Gebaeudeeigentuemer/Institution im regionalen Ombruksnettverk
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "deltar med bygg som skal kartlegges, blant annet Oslo Areal, Omsorgsbygg Oslo KF, Asker kommune, Trondheim kommune, TOBB, NTNU og SINTEF"

### NO:K017
- Kantenart: AKTEUR-AKTEUR
- Knoten A: NTNU  [Forschung/Lehre]
- Knoten B: Bevar / Urban Reuse (NG Group)  [Unternehmen]
- Land: NO
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
### NO:K018
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Regionalt ombruksnettverk for byggematerialer (Oslo-Trondheim)  [NGO/Verband/Netzwerk]
- Knoten B: TOBB  [Unternehmen]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.multiconsult.no/etablerer-nettverk-for-mer-ombruk-av-byggematerialer/
- Bisherige Beschreibung (Altdaten, nur Hinweis): TOBB ist teilnehmender Gebaeudeeigentuemer im regionalen Ombruksnettverk
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "deltar med bygg som skal kartlegges, blant annet Oslo Areal, Omsorgsbygg Oslo KF, Asker kommune, Trondheim kommune, TOBB, NTNU og SINTEF"

### NO:K019
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Regionalt ombruksnettverk for byggematerialer (Oslo-Trondheim)  [NGO/Verband/Netzwerk]
- Knoten B: Trondheim kommune  [Öffentliche Institution]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.multiconsult.no/etablerer-nettverk-for-mer-ombruk-av-byggematerialer/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Trondheim kommune ist teilnehmender Gebaeudeeigentuemer im regionalen Ombruksnettverk
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "deltar med bygg som skal kartlegges, blant annet Oslo Areal, Omsorgsbygg Oslo KF, Asker kommune, Trondheim kommune, TOBB, NTNU og SINTEF"

### NO:K020
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Resirkula  [Materialhub/Bauteilbörse]
- Knoten B: Sirkula IKS  [Unternehmen]
- Land: NO
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.resirkula.no/om-resirkula/
- Bisherige Beschreibung (Altdaten, nur Hinweis): BETREIBER (Sirkula IKS betreibt Resirkula als eigene Satsing)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Resirkula er et gjenbrukskjøpesenter i kretsløpsparken ved Hamar og er Sirkula IKS sin satsing på ombruk, avfallsreduksjon og sirkulærøkonomi."
