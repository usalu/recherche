...
- Knoten A: Ressourcerie Lausanne / Matériuum / R-UUL  [Materialhub/Bauteilbörse]
- Knoten B: Matériuum  [Materialhub/Bauteilbörse]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://materiuum.ch/ressourcerie-lausanne-magasin-shop/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Ressourcerie Lausanne (RUUL) ist Zweigbetrieb von Matériuum
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "la Ressourcerie Matériuum Lausanne (RUUL) permet de stocker et de prolonger la durée de vie d'une grande quantité de matières"

### CH:K002
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Bauteilbörse Basel  [Materialhub/Bauteilbörse]
- Knoten B: Gruner ReUse  [Software/Tool-Anbieter]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.gruner.ch/de/news/bauteile-aus-rueckbauten-jetzt-imeshop-von-grunerreuse-live
- Bisherige Beschreibung (Altdaten, nur Hinweis): Gruner ReUse inventarisiert Rueckbauten, Bauteilboerse Basel uebernimmt Lagerung/Weiterverkauf
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Nach dem Ausbau übernimmt die Bauteilbörse Basel die Lagerung und den Weiterverkauf über useagain.ch."

### CH:K003
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Bauteilbörse Basel  [Materialhub/Bauteilbörse]
- Knoten B: useagain / Bauteilclick  [Materialhub/Bauteilbörse]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.gruner.ch/de/news/bauteile-aus-rueckbauten-jetzt-imeshop-von-grunerreuse-live
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauteilboerse Basel verkauft Rueckbau-Bauteile ueber useagain.ch weiter
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Nach dem Ausbau übernimmt die Bauteilbörse Basel die Lagerung und den Weiterverkauf über useagain.ch."

### CH:K004
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Bauteilvermittlung Zürichsee-Oberland  [Materialhub/Bauteilbörse]
- Knoten B: Stiftung Chance BauTeile Zürich / Glattbrugg  [Materialhub/Bauteilbörse]
- Land: CH
- Belegstatus: UNGEPRUEFT
...
### CH:K005
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Gruner ReUse  [Software/Tool-Anbieter]
- Knoten B: Gruner AG  [Unternehmen]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.gruner-reuse.ch
- Bisherige Beschreibung (Altdaten, nur Hinweis): Gruner ReUse ist Abteilung von Gruner Bestandsbauwerke NWCH (Gruner-Konzern)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Gruner ReUse eine Abteilung der Gruner Bestandsbauwerke NWCH"

### CH:K006
- Kantenart: AKTEUR-AKTEUR
- Knoten A: useagain / Bauteilclick  [Materialhub/Bauteilbörse]
- Knoten B: Bauteilladen Winterthur  [Materialhub/Bauteilbörse]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://library-of-reuse.ch/pioneers/useagain
- Bisherige Beschreibung (Altdaten, nur Hinweis): useagain vermittelt Austausch zwischen u.a. Bauteilladen Winterthur
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "promotes direct exchange between various organisations, such as Bauteilbörse Basel, BauTeile Zürich and Bauteilladen Winterthur"

### CH:K007
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: ELYS Kultur- und…  [Bauvorhaben/Objekt]
...
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "They received a lot of attention and were the trigger for the foundation of Zirkular by the involved planners."

### CH:K008
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: baubüro in situ  [Unternehmen]
- Knoten B: Grubenstrasse 29  [Bauvorhaben/Objekt]
- Land: CH
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: baubüro in situ  [Unternehmen]
- Knoten B: K.118 Winterthur  [Bauvorhaben/Objekt]
- Land: CH
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: baubüro in situ  [Unternehmen]
- Knoten B: RE-WIN  [NGO/Verband/Netzwerk]
- Land: CH
- Belegstatus: UNGEPRUEFT
- Keine gespeicherte Quelle -- aktiv recherchieren, gefundene URL in Spalte 'Beleg'
...
- Kantenart: AKTEUR-AKTEUR
- Knoten A: baubüro in situ  [Unternehmen]
- Knoten B: Pascal Flammer Architekten  [Unternehmen]
- Land: CH
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Baubuero in situ und Pascal Flammer Architekten (PFA) gemeinsam Reuse-Fachplanung/Bauteilauswahl Hobelwerk Haus D
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "untersuchten in situ und PFA 60 Elemente, aus denen schlussendlich 21 für Erwerb und Einbau ausgewählt wurden"

### CH:K013
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Grubenstrasse 29  [Bauvorhaben/Objekt]
- Knoten B: Modissa Immobilien AG  [Unternehmen]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://zirkular.net/de/projekt/grubenstrasse-29/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Auftraggeber
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Auftraggeber (Client): Modissa Immobilien AG"
...
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Grubenstrasse 29  [Bauvorhaben/Objekt]
- Knoten B: Tschudin Rückbau und Demontagen GmbH  [Unternehmen]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://zirkular.net/de/projekt/grubenstrasse-29/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Rueckbau/Materiallieferant fuer Wiederverwendung
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Material Suppliers (Wiederverwendete Bauteile): Tschudin Rückbau und Demontagen GmbH"
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://zirkular.net/de/projekt/grubenstrasse-29/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauteiljagd/Projektteam
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Zirkular Projektteam: Marc Angst, Leonard Schönfelder"

### CH:K017
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Juch-Areal Recyclingzent…  [Bauvorhaben/Objekt]
- Knoten B: Entsorgung + Recycling Zürich (ERZ)  [Öffentliche Institution]
- Land: CH
- Belegstatus: GEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Eigentümervertretung / Bauherrschaft (ERZ) für das Pilotprojekt Recyclingzentrum Juch-Areal
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Eigentümervertretung Entsorgung + Recycling Zürich (ERZ)"

### CH:K018
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Juch-Areal Recyclingzent…  [Bauvorhaben/Objekt]
- Knoten B: Weber + Brönnimann AG  [Unternehmen]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.stadt-zuerich.ch/de/planen-und-bauen/projekte-und-ausschreibungen/hochbauvorhaben/planung-ausfuehrung/recyclingzentrum-juch-areal.html
- Bisherige Beschreibung (Altdaten, nur Hinweis): Bauingenieurwesen (Fachplanung) von Weber + Brönnimann AG im Projektteam Juch-Areal
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Bauingenieurwesen Weber + Brönnimann AG, Bern"

### CH:K019
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Juch-Areal Recyclingzent…  [Bauvorhaben/Objekt]
- Knoten B: manoa Landschaftsarchitekten  [Unternehmen]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.stadt-zuerich.ch/de/planen-und-bauen/projekte-und-ausschreibungen/hochbauvorhaben/planung-ausfuehrung/recyclingzentrum-juch-areal.html
- Bisherige Beschreibung (Altdaten, nur Hinweis): Landschaftsarchitektur von manoa Landschaftsarchitekten GmbH im Projektteam Juch-Areal
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Landschaftsarchitektur manoa Landschaftsarchitekten GmbH, Meilen"

### CH:K020
- Kantenart: AKTEUR-BAUVORHABEN
- Knoten A: Juch-Areal Recyclingzent…  [Bauvorhaben/Objekt]
- Knoten B: Graber Pulver  [Unternehmen]
- Land: CH
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://www.stadt-zuerich.ch/de/planen-und-bauen/projekte-und-ausschreibungen/hochbauvorhaben/planung-ausfuehrung/recyclingzentrum-juch-areal.html
- Bisherige Beschreibung (Altdaten, nur Hinweis): Generalplanung und Architektur von Graber Pulver Architekt:innen AG im Projektteam Juch-Areal
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Generalplanung und Architektur Graber Pulver Architekt:innen AG, Zürich"
