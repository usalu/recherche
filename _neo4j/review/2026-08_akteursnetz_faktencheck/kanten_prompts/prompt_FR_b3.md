...
- Knoten A: Lascombes Matériaux Anciens  [Materialhub/Bauteilbörse]
- Knoten B: Lascombes Matériaux Anciens Sud-Ouest  [Materialhub/Bauteilbörse]
- Land: FR
- Belegstatus: UNGEPRUEFT
...
- Bisherige Beschreibung (Altdaten, nur Hinweis): Vilogia sponsert/patronisiert die Arbeitsgruppen des Booster du Réemploi
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Les Groupes de Travail du Booster du Réemploi sont parrainés par Vilogia, avec Aure-Elise MAHIEUX"
...
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://cd2e.com/actualites/un-nouveau-tournant-pour-les-acteurs-du-reemploi-en-hauts-de-france/
- Bisherige Beschreibung (Altdaten, nur Hinweis): Vilogia als Sponsor der von CD2E getragenen regionalen Booster-du-Réemploi-Initiative (Artikel auf cd2e.com)
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "Les Groupes de Travail du Booster du Réemploi sont parrainés par Vilogia, avec Aure-Elise MAHIEUX"

### FR:K044
- Kantenart: AKTEUR-AKTEUR
- Knoten A: Booster du Réemploi (A4MT)  [Organisation]
- Knoten B: CD2E  [NGO/Verband/Netzwerk]
- Land: FR
- Belegstatus: GEPRUEFT
- Beleg-URL (MUSS geoeffnet werden): https://cd2e.com/domaines-dexpertise/economie-circulaire/booster-du-reemploi/
- Bisherige Beschreibung (Altdaten, nur Hinweis): CD2E und A4MT/Booster du Réemploi kooperieren beim lokalen (Hauts-de-France) Booster du Réemploi
- Gespeichertes Belegzitat (Nachweis-Schnipsel): "le CD2E et Action for Market Transformation – A4MT joignent leurs forces pour organiser un nouveau Booster du Réemploi local"
