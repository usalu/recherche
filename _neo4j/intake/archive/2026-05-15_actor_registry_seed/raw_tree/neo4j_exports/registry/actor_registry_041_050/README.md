# Actor registry actors 041–050 — Neo4j JSONL

This folder converts actors 41–50 from `akteursliste_master.md` into the repo/MCP graph format.
...
```text
actors_041_050.registry.kg.jsonl
