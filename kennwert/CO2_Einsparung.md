...
n_files: 26
aliases_korpus: ["ca. 50 t CO₂", "386 kgCO₂e/m² A1-A5", "13,32 t CO₂e / 82 %", "68 % CO₂-Reduktion", "60 t CO₂ Einsparung", "66 t / 99.2 t CO₂e saving", "4.572,702786 kg CO₂ vermieden", "17.000 t Material, 12.000 t Beton, 3.500 t CO₂, 92 % Reuse", "91 t CO₂ durch Wiederverwendung vermieden", "7.000 t CO₂e durch Erhalt der Tragstruktur", "ca. 75 % Wiederverwendungsgrad Rohbau-Substanz", "ca. 25 % Kosteneinsparung", "24–25 t reused steel", "35/45/60 t CO₂-Einsparung je Quelle", "48 t CO₂", "fast 600 t CO₂ / gut 40% Reduktion", "59 % CO₂-Reduktion / 494 t CO₂", "ca. 30 % graue THG-Einsparung", "2,6 → 1,9 kg CO₂e/m²a", "458–792 t CO₂e Einsparung", "175.78 t CO₂ diverted from landfill", "ca. 100 t CO₂ gebunden", "69,22 t CO₂e vermieden", "CO₂-/Materialeinsparungen publiziert, aber hier nicht gesichert", "30 t Stahl / 74 t CO₂e Einsparung"]
verwendet_in_fallstudien: ["[[Gebäude/55_Great_Suffolk_Street_London]]", "[[Gebäude/AWM_Muenster_Circular_Office]]", "[[Gebäude/BlueCity_Offices_Rotterdam]]", "[[Gebäude/Brent_Cross_Town_Primary_Substation_London]]", "[[Gebäude/Chiro_d_Itterbeek_Dilbeek]]", "[[Gebäude/Circular_Centre_Netherlands_Prinsenhof_A_reuse_pilot]]", "[[Gebäude/ELYS_Kultur_Gewerbehaus_Basel]]", "[[Gebäude/Haus_HOS_Mehrfamilienhaus_Muehlhausen]]", "[[Gebäude/Holbein_Gardens_London]]", "[[Gebäude/House_of_Fraser_318_Oxford_Street_TBC_London_reuse_chain]]", "[[Gebäude/Juch_Areal_Recyclingzentrum_Zuerich]]", "[[Gebäude/K118_Kopfbau_Halle_118_Winterthur]]", "[[Gebäude/Kindergarten_Moeoeslistrasse_Manegg_Zuerich]]", "[[Gebäude/Lycee_Michel_Lucius_Conversion_Luxembourg]]", "[[Gebäude/PLP_London_HQ_Circular_Studio_Fitout]]", "[[Gebäude/Recyclinghaus_Hannover]]", "[[Gebäude/Resilience_La_Ferme_des_Possibles_Stains]]", "[[Gebäude/Resource_Rows_Copenhagen]]", "[[Gebäude/Roots_in_the_Sky_Blackfriars_Crown_Court]]", "[[Gebäude/Svanen_Kindergarten_Gladsaxe]]", "[[Gebäude/TRAE_High_Rise_Aarhus]]", "[[Gebäude/Thoravej_29_Copenhagen]]", "[[Gebäude/Timber_Square_London]]", "[[Gebäude/Upcycle_Studios_Copenhagen]]", "[[Gebäude/Villa_Welpeloo_Enschede]]", "[[Gebäude/Woongroep_Boschgaard_Den_Bosch]]"]
---
