...
source_count: 1
legacy_paths:
  - "werkzeug\\Materialdatenbank.md"
raw_targets:
  - "software_digitaltool/Materialdatenbank"
migration_actions:
  - "semantic_move"
risk_flags:
...
- Canonical target: software_digitaltool/Materialdatenbank
...
### Legacy Source: werkzeug\Materialdatenbank.md

- Map action: semantic_move
- Target role in map: primary
- Raw mapped target: software_digitaltool/Materialdatenbank
- Original primary target: software_digitaltool/Materialdatenbank
