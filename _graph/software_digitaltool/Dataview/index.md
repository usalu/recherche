...
source_count: 1
legacy_paths:
  - "werkzeug\\Dataview.md"
raw_targets:
  - "software_digitaltool/Dataview"
migration_actions:
  - "semantic_move"
risk_flags:
...
- Canonical target: software_digitaltool/Dataview
...
### Legacy Source: werkzeug\Dataview.md

- Map action: semantic_move
- Target role in map: primary
- Raw mapped target: software_digitaltool/Dataview
- Original primary target: software_digitaltool/Dataview
