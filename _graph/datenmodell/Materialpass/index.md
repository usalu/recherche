...
target_primary: "datenmodell/Materialpass"
target_roles: "phase2_secondary"
risk_flags: "hybrid_actor_platform_profile;duplicate_with_werkzeug_Madaster_Plattform"
---
# Madaster — vertieftes Forschungsdossier

## Migration

- Target: datenmodell/Materialpass
- Legacy source count: 1
- Legacy types: 
- Migration actions: semantic_split
- Target roles: phase2_secondary
- Risk flags: hybrid_actor_platform_profile;duplicate_with_werkzeug_Madaster_Plattform
