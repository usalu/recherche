---
id: "Beton_Fertigteile_Verbindungen"
entity: "fuegung_verbindung"
node_kind: "knot"
migration_status: "migrated_phase2_semantic_corrections"
migration_action: "split_into_knots"
title: "Verbindungen im Betonbau / Fertigteile"
legacy_type: "Material"
legacy_paths:
  - "material\Beton-Fertigteile_Verbindungen.md"
target_primary: "fuegung_verbindung/Beton_Fertigteile_Verbindungen"
...
- Target: fuegung_verbindung/Beton_Fertigteile_Verbindungen
...
## Legacy Content: material\Beton-Fertigteile_Verbindungen.md
...
BETON / FERTIGTEILE
Extrahiere nur Berichte zu Verbindungen von Beton- und Stahlbetonfertigteilen im Hochbau mit direktem Bezug zu Wiederverwendung, Demontage oder Reversibilität. Nur zulässige Bauelemente: Stütze, Träger, Unterzug, Deckenplatte, Hohlplatte, TT-Platte, Wandtafel, Treppe, Balkonplatte, Fassadenfertigteil, Fundament. Nur zulässige Verbindungen: Hülsenverbindung, Dornverbindung, Dübelverbindung, Trockenverbindung, Nassverbindung, Vergussfuge, Flanschplatte, Schraubverbindung, Bolzenverbindung, Steckverbindung, Einbauteil, Vorspannung. Ausschließen: allgemeiner Betonbau, Recycling, Nachhaltigkeit, CO2, Infrastruktur, Brücken, Tunnel, Materialkunde ohne Anschlussbezug. Ausgabe nur als: Bauelement | Verbindungsart | Reuse-Bezug | Vorteil | Nachteil | Demontagebedingung | Quelle. Keine Zusatzinfos.
...
PROMPT BETON / FERTIGTEILE

Erstelle einen strikt materialgebundenen Bericht nur zu Verbindungen und Fügungen von Beton- und Stahlbetonfertigteilen im Kontext der Wiederverwendung im Hochbau.

Zulässiger Fokus:
- nur Beton / Stahlbeton / Fertigteile
- nur konkrete Bauelemente: Stütze, Träger, Unterzug, Deckenplatte, Hohlplatte, TT-Platte, Wandtafel, Treppe, Balkonplatte, Fassadenfertigteil, Fundament

Strikte Ausschlüsse:
- keine allgemeinen Informationen zu Betonbau
- keine allgemeinen Nachhaltigkeits-, Kreislaufwirtschafts- oder CO2-Texte
- kein Recycling
- keine Materialherstellung
- keine Baustoffkunde ohne Verbindungsbezug
- keine Statik allgemein ohne Anschlussdetail
- keine Infrastruktur, Brücken, Tunnel, Tiefbau
- keine Fassaden- oder Ausbauinformationen, wenn das Bauteil nicht aus Beton/Fertigteil besteht
