...
legacy_path: "prozessphase\\index.md"
migration_action: "merge_into_index"
legacy_type: "Prozessphase"
target_primary: "prozessphase/index"
target_secondary: ""
...
Diese Kategorie bildet den zeitlichen und organisatorischen Ablauf des Wiederverwendungsprozesses ab. Die Phasen sind nicht starr sequenziell, sondern oft parallel oder iterativ: Bestandserfassung und Entwurf überlappen sich, Aufbereitung und Lagerung laufen gleichzeitig. Im Unterschied zur Methoden-Kategorie beschreibt eine Prozessphase, wann und in welchem Kontext gehandelt wird; Methoden beschreiben das systematische Wie.
...
- [Bestandserfassung.md](Bestandserfassung.md) — Systematische Ermittlung, Dokumentation und Bewertung von Gebäuden und Bauteilen vor Umbau oder Rückbau. Entspricht dem Pre-Demolition-Audit; Grundlage für alle Wiederverwendungsentscheidungen. Normativ gestützt durch DIN SPEC 91484.

- [Entwurf.md](Entwurf.md) — Prozessphase, in der verfügbare Bauteile, Unsicherheiten, Toleranzen und Demontagefähigkeit als Entwurfsbedingungen behandelt werden. Zirkulärer ReUse-Entwurf arbeitet bauteilgetrieben – Bestand beeinflusst Raster, Details, Ästhetik und Ausschreibung.

- [Ausschreibung.md](Ausschreibung.md) — Übersetzt ReUse-Ziele in Leistungsbeschreibung, Nachweise, Vertragsklauseln und Zuschlagskriterien. Muss mit variablen Mengen, heterogenen Bauteilen und unvollständigen Leistungsnachweisen umgehen können.

- [Rueckbau.md](Rueckbau.md) — Geordnete, geplante Demontage mit dem Ziel schadensarmer Bauteilgewinnung, nicht bloßer Baufeldfreimachung. Selektiver Rückbau trennt Bauwerksbestandteile nach Wert, Schadstoffstatus und Anschlussnutzung.

- [Aufbereitung.md](Aufbereitung.md) — Prozessphase zwischen Rückbau und erneuter Nutzung: Prüfung, Reinigung, Sortierung, Reparatur, Anpassung und Dokumentation. Kann rechtlich als „Vorbereitung zur Wiederverwendung" nach KrWG eingestuft werden.

- [Lagerung.md](Lagerung.md) — Kontrollierte, dokumentierte und werterhaltende Aufbewahrung zwischen Rückbau und Wiedereinbau. Umfasst Inventarführung, Qualitätssicherung, Eigentumsfragen und Terminsteuerung; kein passives Abstellen.

- [Transport.md](Transport.md) — Bewegung von Bauteilen zwischen Rückbauort, Aufbereitung, Lager und Baustelle. Qualitätskritisch und ökologisch relevant: Falsches Handling und weite Wege können den ökologischen Nutzen der Wiederverwendung schmälern.

- [Wiedereinbau.md](Wiedereinbau.md) — Integration geprüfter Bauteile mit Eingangskontrolle, bautechnischen Nachweisen, Toleranzanpassung, Abnahme und Dokumentation. Nachweis, ob die gesamte ReUse-Kette von der Bestandserfassung bis zum Einbau funktioniert hat.

- [Betrieb_und_Rueckbauplanung.md](Betrieb_und_Rueckbauplanung.md) — Lebenszyklusphase nach Fertigstellung, in der ReUse-Potenzial durch Wartung, Datenpflege, Zugänglichkeit und reversible Umbauten erhalten wird. Rückbauplanung im Betrieb versteht das Gebäude als temporäre Konfiguration von Bauteilen.
