...
- **Bewertung:** ★★☆☆☆  
- **Begründung:** Das Expogebouw ist ein gebautes Demonstrations-/Infogebäude aus dem SUPERLOCAL-Projekt. Es enthält reale wiederverwendete, teils großformatige Bau- und Technikbauteile aus einem Hochhaus an der Ursulastraat, darunter drei herausgesägte Wohnungsteile sowie Fassaden-/Innenausbau-/TGA-Komponenten. Wegen Demonstrator-/Pavillonmaßstab und nicht als reguläres Wohngebäude bleibt der Fall im Anhang.  
- **Vertrauensgrad:** belegt  
- **Warnung Bestandserhalt:** nein  
- **Warnung Möbel/Dekoration:** nein; feste Küche/Installationen zählen nur als feste Einbauten/Technik, nicht als lose Möbel  
- **Projektstatus:** gebaut / Demonstrator, geliefert am 22. Februar 2018
...
|---|---|---|---|---|---:|---|---|---|---|---|---|---|---|---|---|---|---|
| Wohnungsteile / Betonunits | Stahlbeton / Beton | Wohnung aus Hochhausflat Ursulastraat | tragende/raumbildende Wohnungsteile | Grundstruktur des Expogebouw | 3 Teile; je ca. 45 t laut Projektseite; andere Meldung ca. 40 t | ja | ja | teilweise | nein | aus Wohnung gesägt, getrennt, mit 52-m-Kran herausgehoben, per Trailer transportiert | unbekannt | Bauadviesbureau/Volantis, Details unbekannt | Tragfähigkeit, Rissfreiheit, Maßhaltigkeit, Transportfestigkeit | unbekannt | Risse beim Kran-/Trailertransport, Maßhaltigkeit | SUPERLOCAL | exakte Geometrie, Bewehrung |
| Aluminiumrohre | Aluminium | Donorflat | unbekannt / Installations-/Bauteil | wiederverwendetes Bauteil | unbekannt | unbekannt | unbekannt | unbekannt | möglich | möglichst ohne Bearbeitung | unbekannt | unbekannt | unbekannt | unbekannt | unbekannt | SUPERLOCAL | Maße, Funktion |
| Heizkörper / Radiatoren | Metall | Donorflat | Heizung | Heizung / Demonstrator | unbekannt | nein | nein | nein | ja | Ausbau, Wiedereinbau | unbekannt | unbekannt | Betrieb, Dichtheit | unbekannt | Zustand/Kompatibilität | SUPERLOCAL | Anzahl, Leistung |
| Plattenmaterial | unbekannt | Donorflat | Ausbau/Fassade unbekannt | Ausbau | unbekannt | nein | ja | möglich | nein | Wiederverwendung | unbekannt | unbekannt | Gebrauchstauglichkeit | unbekannt | Qualität | SUPERLOCAL | Material, Menge |
| Fenster-/Kozijnen | Holz/Glas? unbekannt | Donorflat | Fensterrahmen | Fenster/Hülle | unbekannt | nein | ja | ja | nein | Ausbau; teils problematische Bearbeitung wegen Asbest | unbekannt | unbekannt | Wind-/Wasserdichtheit, Wärmeschutz | unbekannt | Asbest in Rahmen, Kosten | SUPERLOCAL | Anzahl, U-Wert |
| Haustüren / Voordeuren | unbekannt | Donorflat | Wohnungseingang | Tür | unbekannt | nein | ja | möglich | nein | Ausbau/Wiedereinbau | unbekannt | unbekannt | Sicherheit, Dichtheit | unbekannt | Zustand/Maße | SUPERLOCAL | Anzahl |
| Geländer | Metall | Donorflat | Absturzsicherung | Geländer | unbekannt | nein | ja | nein | nein | Ausbau/Wiedereinbau | unbekannt | unbekannt | Absturzsicherung | unbekannt | Normnachweis | SUPERLOCAL | Anzahl/Höhe |
| Brüstungen / Borstweringen | Beton/Metall unbekannt | Donorflat | Fassade/Brüstung | Brüstung/Hülle | unbekannt | möglicherweise | ja | ja | nein | Ausbau/Wiedereinbau | unbekannt | unbekannt | Absturzsicherung/Witterung | unbekannt | Anschlüsse | SUPERLOCAL | Menge |
| Küche / Küchenunit | unbekannt | Donorflat | feste Küche | fester Einbau im Demonstrator | 1 Einheit genannt | nein | ja | nein | technisch teilweise | Ausbau/Wiedereinbau | unbekannt | unbekannt | Hygiene, Anschlüsse | unbekannt | nicht als loses Möbel werten | SUPERLOCAL | genaue Zusammensetzung |
| Pflaster / Bodenplatten außen | Beton/Stein | Originalpflaster und Wohnungs-Bodenplatten Ursulastraat sowie andere Quellen | Boden/Pflaster | Außenpflaster | vollständig um das Gebäude herum; Menge unbekannt | nein | ja | nein | nein | Ausbau, Wiedereinbau | lose/gebettet unbekannt | unbekannt | Ebenheit, Frost, Belastung | unbekannt | Logistik/Lagerung | SUPERLOCAL | Fläche |
...
|---|---|---|---|---|---|---|---|
| Tragwerkssystem | drei große Beton-Wohnungsteile bilden Basis | Tragfähigkeit, Transport-/Montagefestigkeit | unbekannt | Volantis/Bewehrungsuntersuchung; unabhängige Evaluation | Rissbildung, Maßhaltigkeit | Test im Demonstrator | SUPERLOCAL |
| Lastabtragung | vorhandene Wohnungsteile als Struktur | unbekannt | unbekannt | unbekannt | neue Last-/Auflagerbedingungen | unbekannt | SUPERLOCAL |
| Verbindung | unbekannt | Kraftübertragung, Dichtheit | unbekannt | unbekannt | Schnittkanten/Anschlussdetails | unbekannt | — |
| Brandschutz | unbekannt | Feuerwiderstand / Flucht | unbekannt | unbekannt | Altbauteile + neue Nutzung | unbekannt | — |
| Schallschutz | unbekannt | nicht zentral für Infogebäude | unbekannt | unbekannt | unbekannt | unbekannt | — |
| Feuchte | Gebäude ist wind- und wasserdicht | Wetterdichtheit | unbekannt | unbekannt | Reuse-Fenster/-Anschlüsse | unbekannt | SUPERLOCAL |
| Wärmeschutz | unbekannt | unbekannt | unbekannt | unbekannt | Altfenster/alte Hülle | Marktanfrage für spätere Wohnungen als Lehre | SUPERLOCAL |
| Wärmebrücken | unbekannt | unbekannt | unbekannt | unbekannt | Beton-Altbauteile | unbekannt | — |
| Luftdichtheit | unbekannt | unbekannt | unbekannt | unbekannt | Reuse-Fenster | unbekannt | — |
| TGA-Integration | Toilette, Heizungsanlage, Küche vorhanden | Betrieb von Heizung/Sanitär | unbekannt | unbekannt | Kompatibilität alter Komponenten | Baukette früher einbinden | SUPERLOCAL |
| Barrierefreiheit | unbekannt | unbekannt | unbekannt | unbekannt | unbekannt | unbekannt | — |
| Dauerhaftigkeit | Demonstrator als Grundlage für Wohnungen | Gebrauchstauglichkeit | unbekannt | Evaluation | Qualität und Repair/Remanufacturing | Lehren für bewohnbare Wohnungen | SUPERLOCAL |
| Wartung | unbekannt | unbekannt | unbekannt | unbekannt | unbekannt | unbekannt | — |
| Zulassung | experimentelles Gebäude bringt rechtliche Herausforderungen | baurechtliche Zustimmung | unbekannt | unabhängiges Bauadviesbureau | Gesetzgebung | Evaluation/Koordination | SUPERLOCAL |
| Haftung | unbekannt | Verantwortlichkeiten | unbekannt | unbekannt | veränderte Rollen im Bau-Team | frühe Zusammenarbeit | SUPERLOCAL |
...
|---|---|---|---|---|---|---|---|
| Veränderte Rollen im Bau-Team | prozessual | Architekt muss mit verfügbaren Bauteilen entwerfen | Ablauf weicht von Regelprozess ab | People, Methode, Prozessphase | frühe Integration aller Beteiligten | Reuse braucht Material-first-Prozess | SUPERLOCAL |
| Logistik/Timing | logistisch | Bauteile fallen beim Rückbau zu anderen Zeiten an als im Neubau benötigt | Verzögerungs-/Lagerproblem | Logistik, Lagerung, Planung | Kette früher einbinden | Rückbau und Neubau müssen gemeinsam getaktet werden | SUPERLOCAL |
| schwere Großbauteile | technisch/logistisch | 40–45-t-Wohnungsteile | Kran-/Transport-/Rissrisiko | Bauteil, Werkzeug, Prüfung | 52-m-Kran, Trailer, Test | Großteil-Reuse reduziert Schnittabfall, erhöht Hebeaufwand | SUPERLOCAL |
| Asbest in Rahmen | Schadstoff/rechtlich | Altbauteile aus 50 Jahre alter Flat | kostspielige Bearbeitung; Reuse erschwert | Schadstoff, Bauteil, Wirtschaft | gutes Holz separieren / remanufacturing | Schadstoffscreening früh starten | SUPERLOCAL |
| Qualität/Repair | technisch/wirtschaftlich | 1:1-Reuse nicht immer ausreichend | Repair/Remanufacturing nötig | Aufbereitungsmethode, Leistungsanforderung | Qualitätssicherung ausbauen | Reuse ist nicht nur Demontage, sondern auch Aufbereitung | SUPERLOCAL |
| Gesetzgebung | rechtlich | experimentelles Gebäude mit Reuse-Bauteilen | Genehmigungs-/Nachweisaufwand | Recht, Norm, Prüfung | unabhängige Evaluation | Reuse braucht passende Nachweiswege | SUPERLOCAL |
...
- **Sichtbarkeit der Wiederverwendung:** hoch; das Gebäude sollte zeigen, ob 1:1-Wiederverwendung von Flat-Materialien möglich ist.  
- **räumliche Transformation:** Wohnungsteile werden vom Hochhaus in ein kleines Info-/Testgebäude überführt.  
- **Atmosphäre / Ausdruck:** experimenteller Pavillon/Infobau; Details unbekannt.  
- **Umgang mit Spuren:** Reuse-Elemente, besonders Fenster, sollten möglichst erkennbar wiederverwendet werden.  
- **sozialer Wert:** Das Projekt knüpft an die soziale Geschichte der Hochhausflats in Bleijerheide an und übersetzt Abriss in Quartiersentwicklung.  
- **Denkmal- oder Bestandswert:** kein Denkmalstatus belegt; sozialer Bestandswert des Quartiers relevant.  
- **Kritik / Grenzen:** Demonstrator statt Regelwohngebäude; einige Kennwerte/Qualitätsdetails nicht öffentlich.
...
- **5 wichtigste Fakten:**  
  1. geliefert/eröffnet am 22. Februar 2018  
  2. offizieller Reuse-Anteil: 95 %  
  3. drei große Wohnungsteile aus einer Flat bilden die Basis  
  4. jedes Großelement wiegt ca. 40–45 t  
  5. der Fall diente als Lernschritt für spätere zirkuläre Wohnungen  
- **5 wichtigste Bauteile:**  
  1. drei Beton-Wohnungsteile  
  2. Fenster-/Kozijnen  
  3. Heizkörper  
  4. Türen/Geländer/Brüstungen  
  5. wiederverwendetes Pflaster/Bodenplatten  
- **5 wichtigste Hürden:**  
  1. Logistik und Timing  
  2. Schwerlast-Heben/Transport  
  3. Asbest in Fensterrahmen  
  4. Qualitäts-/Repair-Fragen  
  5. Genehmigungs-/Gesetzgebungshürden  
- **5 wichtigste übertragbare Erkenntnisse:**  
  1. Rückbauunternehmen werden zu Materiallieferanten.  
  2. Großteile können Abfall reduzieren, brauchen aber Kran-/Transportstrategie.  
  3. Entwurf muss von verfügbaren Bauteilen ausgehen.  
  4. Schadstofftrennung entscheidet über Reusefähigkeit.  
  5. Demonstratoren können Wissen für echte Wohnbauten liefern.  
- **5 offene Fragen:**  
  1. Wie lauten die detaillierten Kosten der ersten Phase?  
  2. Welche Norm-/Prüfnachweise wurden eingereicht?  
  3. Welche CO₂-Einsparung hatte das Expogebouw selbst?  
  4. Wie dauerhaft ist das Gebäude heute im Betrieb?  
  5. Wie wurden die Großbauteile konstruktiv verbunden?
