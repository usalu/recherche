...
target_primary: "datenmodell/Taxonomie"
target_secondary: ""
risk_flags: ""
---
# Taxonomie
...
- Target: datenmodell/Taxonomie
- Legacy source count: 1
- Legacy types: Datenmodell
- Migration actions: move_as_knot
- Secondary targets: 
- Risk flags: 

## Legacy Content: datenmodell\Taxonomie.md

---
type: Datenmodell
verwandt: ["[[datenmodell/Bauteil_ID]]", "[[datenmodell/IFC]]", "[[datenmodell/Klassifikation]]", "[[datenmodell/Materialpass_Schema]]", "[[datenmodell/Ontologie]]"]
