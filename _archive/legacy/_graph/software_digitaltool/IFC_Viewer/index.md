...
source_count: 1
legacy_paths:
  - "werkzeug\\IFC_Viewer.md"
raw_targets:
  - "software_digitaltool/IFC_Viewer"
migration_actions:
  - "semantic_move"
risk_flags:
...
- Canonical target: software_digitaltool/IFC_Viewer
...
### Legacy Source: werkzeug\IFC_Viewer.md

- Map action: semantic_move
- Target role in map: primary
- Raw mapped target: software_digitaltool/IFC_Viewer
- Original primary target: software_digitaltool/IFC_Viewer
