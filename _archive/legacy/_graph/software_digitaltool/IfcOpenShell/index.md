...
source_count: 1
legacy_paths:
  - "werkzeug\\IfcOpenShell.md"
raw_targets:
  - "software_digitaltool/IfcOpenShell"
migration_actions:
  - "semantic_move"
risk_flags:
...
- Canonical target: software_digitaltool/IfcOpenShell
...
### Legacy Source: werkzeug\IfcOpenShell.md

- Map action: semantic_move
- Target role in map: primary
- Raw mapped target: software_digitaltool/IfcOpenShell
- Original primary target: software_digitaltool/IfcOpenShell
