...
- Canonical target: software_digitaltool/BIM
...
### Legacy Source: werkzeug\BIM.md

- Map action: semantic_move
- Target role in map: primary
- Raw mapped target: software_digitaltool/BIM
- Original primary target: software_digitaltool/BIM
