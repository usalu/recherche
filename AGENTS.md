...
**Kanonisches Arbeitsverzeichnis:** `_database/` — nicht die Archivkopien unter `_archive/`. Vokabular und Kantenregeln: `_database/_system/SCHEMA.md`, Neo4j-Faltung: `_scripts/neo4j_relation_fold.py`.

Ordnerstruktur (unter `_database/`):
