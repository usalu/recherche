# Anhang: Interview-Auswertung Raoul Bunschoten  
## Relevanz für die Entwicklung eines digitalen Reuse-Werkzeugs

## Zweck dieses Anhangs

Dieser Anhang fasst zentrale Erkenntnisse aus dem Gespräch mit Raoul Bunschoten zusammen und ordnet sie im Hinblick auf die Entwicklung eines digitalen Werkzeugs für das Entwerfen mit wiederverwendeten Materialien ein.  

Die Auswertung ist nicht als eigenständiger Forschungsbericht gedacht, sondern als ergänzende qualitative Grundlage für den Hauptbericht. Sie dient dazu, ausgewählte Aussagen aus dem Interview in konkrete konzeptionelle Anforderungen und Reflexionspunkte für die Tool-Entwicklung zu übersetzen.

Im Mittelpunkt stehen dabei nicht technische Einzelfunktionen, sondern übergeordnete Fragen: Wie können fragmentierte Prozesse verbunden werden? Welche Rolle spielen unterschiedliche Akteure? Wie lassen sich unvollständige Daten, Szenarien und dynamische Planungssituationen in einem digitalen Werkzeug abbilden?

---

## 1. Fehlende Kontinuität als zentrales Problem
...
## 2. Ein Tool als Teil eines größeren Ökosystems
...
## 3. Wiederverwendung als Verhandlungsprozess
...
## 4. Szenarien statt automatischer Lösungen
...
## 5. Arbeiten mit unvollständigem Wissen
...
## 6. Planung als dynamischer Prozess
...
## 7. Anpassungsfähigkeit als zentrale Anforderung
...
## Ableitungen für die Tool-Entwicklung

Aus dem Gespräch lassen sich folgende Anforderungen für die Entwicklung eines digitalen Reuse-Werkzeugs ableiten:

- Das Tool sollte fragmentierte Informationen entlang der Wertschöpfungskette verbinden.
- Es sollte als Teil eines größeren digitalen Ökosystems gedacht werden, nicht als isolierte Anwendung.
- Es sollte verschiedene Akteursgruppen und deren unterschiedliche Informationsbedürfnisse berücksichtigen.
- Es sollte Szenarien vergleichbar machen, anstatt eine einzelne Lösung vorzuschlagen.
- Es sollte Unsicherheit, Annahmen und fehlende Informationen sichtbar machen.
- Es sollte dynamisch aktualisierbar sein und auf veränderte Rahmenbedingungen reagieren können.
- Es sollte Entscheidungsprozesse unterstützen, ohne die Verantwortung menschlicher Akteure zu ersetzen.
